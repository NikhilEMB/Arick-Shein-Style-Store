...
var LanguageCurrentPageModule = /** @class */ (function () {
    function LanguageCurrentPageModule() {
    }
    ...
    return LanguageCurrentPageModule;
}());
...
var LanguageCurrentPage = /** @class */ (function () {
    function LanguageCurrentPage(labelService, router, events, loadingController, languageService, alertController) {
    ...
    LanguageCurrentPage.prototype.onReorderLang = function (event) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        id = this.languages[start].id;
                        end = event.detail.to;
                        if (start < end && end !== this.languages.length - 1) {
                            firstDate = this.languages[end].sortedAt.toDate().getTime();
                            secondDate = this.languages[end + 1].sortedAt.toDate().getTime();
                        ...
                        // tslint:disable-next-line: one-line
                            ...
                            changedDate = this.languages[end].sortedAt.toDate().getTime() - 5 * 60000;
                            this.languageService.updateLangPosition(id, new Date(changedDate));
                        }
                        // tslint:disable-next-line: one-line
                        ...
                        draggedItem = this.languages.splice(event.detail.from, 1)[0];
    ...
    LanguageCurrentPage.prototype.ngOnInit = function () {
    ...
    LanguageCurrentPage.prototype.ngOnDestroy = function () {
        this.removeSubscriptions();
    };
    LanguageCurrentPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('language:publishAddedLanguages', function (langs) {
            _this.languages = langs;
            _this.showLoader = false;
        });
        this.events.subscribe('language:updateLangPostionSucess', function () {
            if (_this.loading) {
                _this.loading.dismiss();
            }
        });
        this.events.subscribe('language:makeDefaultSuccess', function (id) {
            if (_this.loading) {
                _this.loading.dismiss();
            }
            _this.presentAlert(_this.languages[_this.currentIndex].langName + ' ' + _this.ALL_LANGUAGES_LABELS['make_default_success_msg']);
        });
        this.events.subscribe('language:deleteLangSuccess', function (id) {
            if (_this.loading) {
                _this.loading.dismiss();
            }
            _this.presentAlert(_this.languages[_this.currentIndex].langName + ' ' + _this.ALL_LANGUAGES_LABELS['delete_lang_success_msg']);
        });
    };
    LanguageCurrentPage.prototype.makeDefault = function (id, i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    LanguageCurrentPage.prototype.deleteLang = function (id, i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading('Please wait', 5000)];
    ...
    LanguageCurrentPage.prototype.gotoLanguageAdd = function () {
        this.router.navigate(['language-add']);
    };
    LanguageCurrentPage.prototype.presentLoading = function (msg, duration) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    LanguageCurrentPage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    LanguageCurrentPage.prototype.removeSubscriptions = function () {
    ...
    LanguageCurrentPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-language-settings-language-current-language-current-module-es5.js.map