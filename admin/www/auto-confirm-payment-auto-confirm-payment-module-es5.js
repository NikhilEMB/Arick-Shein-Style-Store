...
var AutoConfirmPaymentPageModule = /** @class */ (function () {
    function AutoConfirmPaymentPageModule() {
    }
    ...
    return AutoConfirmPaymentPageModule;
}());
...
var AutoConfirmPaymentPage = /** @class */ (function () {
    function AutoConfirmPaymentPage(events, router, alertController, loadingController, route, navCtrl) {
        var _this = this;
        this.events = events;
        this.router = router;
        ...
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.orderData = _this.router.getCurrentNavigation().extras.state.orderData;
    ...
    AutoConfirmPaymentPage.prototype.ionViewWillLeave = function () {
    ...
    AutoConfirmPaymentPage.prototype.initializeSubscriptions = function () {
        ...
        this.events.subscribe('order:ac_modeSetToCashSuccess', function () {
            _this.loading.dismiss();
            _this.presentAlert('Order has been placed successfully!');
        });
    };
    ...
    AutoConfirmPaymentPage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    AutoConfirmPaymentPage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    AutoConfirmPaymentPage.ctorParameters = function () { return [
...
//# sourceMappingURL=auto-confirm-payment-auto-confirm-payment-module-es5.js.map