...
let SubscriptionsPage = class SubscriptionsPage {
    constructor(labelService, events, loadingController, alertController, toastController, modalController, configService, sharedService, router) {
    ...
    saveSettings() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.isNoData(this.dailyDeliveries) || this.isNoData(this.weeklyDeliveries) || this.isNoData(this.monthlyDeliveries)) {
                ...
                yield this.presentLoading(this.SHARED_LABELS['please_wait'], 5000);
                const data = {
    ...
    getNextDate(subData) {
        const futureDates = [];
        const today = moment__WEBPACK_IMPORTED_MODULE_4__().format('YYYY-MM-DD');
        subData.ordersAt.forEach(date => {
            const diff = moment__WEBPACK_IMPORTED_MODULE_4__(date).diff(moment__WEBPACK_IMPORTED_MODULE_4__(today), 'days');
            if (diff > 0) {
                futureDates.push(date);
            }
        });
        let nextDeliverableDate;
    ...
    openSubscriptionCalendar(sub) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const subscriptionCalendar = yield this.modalController.create({
                component: _subscription_calendar_subscription_calendar_page__WEBPACK_IMPORTED_MODULE_8__["SubscriptionCalendarPage"],
                componentProps: {
                    options: calendarOptions
                }
            });
            yield subscriptionCalendar.present();
        });
    }
    getDaysConfig(orderDateSpan, sub) {
...
//# sourceMappingURL=admin-subscriptions-subscriptions-module-es2015.js.map