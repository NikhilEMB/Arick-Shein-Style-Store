...
var BookingPage = /** @class */ (function () {
    function BookingPage(modalController, events, router, loadingController, alertController, filtersService, bookingService, platform, storage, toastController, brandService, vendorService) {
    ...
    BookingPage.prototype.saveProduct = function (itemData, itemID) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(!itemData.prodPrice && itemData.prodPrice !== 0)) return [3 /*break*/, 1];
    ...
    BookingPage.prototype.getDateTimeFormat = function (date) {
    ...
    BookingPage.prototype.initializeSubscriptions = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, _b, _c;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        _d.label = 4;
                    case 4:
                        this.events.subscribe('booking:publishProductsForAdminProducts', function (products) {
                        ...
                        this.events.subscribe('booking:publishAllProductsForAdminProducts', function (products) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var _a, _b, _c;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_d) {
                                switch (_d.label) {
                                    case 0:
                                        ...
                                        _a = this;
                                        return [4 /*yield*/, this.bookingService.getAllCategoriesForSideMenu()];
                                    case 1:
                                    ...
                                    case 4:
                                        ...
                                        _c = this;
                                        return [4 /*yield*/, this.bookingService.getAllSubcategoriesForSideMenu()];
                                    case 5:
                        ...
                        this.events.subscribe('booking:noProductsAvailable', function () {
                            if (_this.loading) {
                                _this.loading.dismiss();
                            }
                        ...
                        this.events.subscribe('booking:productsForAdminProductsLimitReached', function () {
                            if (_this.loading) {
                                _this.loading.dismiss();
                            }
                        ...
                        this.events.subscribe('booking:previousProductsForAdminProductsLimitReached', function () {
                            if (_this.loading) {
                                _this.loading.dismiss();
                            }
                        ...
                        // });
                        this.events.subscribe('booking:makeProductCopiesSuccess', function () {
                            if (_this.loading) {
                                _this.loading.dismiss();
                            }
                            _this.presentAlert('', 'Options of the product has been added successfully.');
                        });
                        this.events.subscribe('booking:makeProductCopiesFailure', function () {
                            if (_this.loading) {
                                _this.loading.dismiss();
                            }
                        ...
                        this.events.subscribe('booking:publishSubcategories', function (data) {
                            if (_this.loading) {
                                _this.loading.dismiss();
                            }
    ...
    BookingPage.prototype.loadMoreProducts = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    BookingPage.prototype.loadMoreCategoryProducts = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var products;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.bookingService.loadMoreCategoryProducts(this.selectedSubcatId)];
                    case 2:
                        products = _a.sent();
    ...
    BookingPage.prototype.loadPreviousProducts = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    BookingPage.prototype.editProduct = function (item) {
    ...
    BookingPage.prototype.fireSearchQuery = function () {
        var _this = this;
        ...
        if (this.searchProduct.length > 2) {
            this.typingTimer = setTimeout(function () {
                ...
                _this.events.publish('search-engine:alogoliaSearchProductsForAdmin', _this.searchProduct, 0, 'new_search', 'booking');
    ...
    BookingPage.prototype.searchMoreProducts = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                // console.log('loading more data...');
    ...
    BookingPage.prototype.deleteProduct = function (itemId, index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    BookingPage.prototype.deleteAlertConfirm = function (itemId, index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    BookingPage.prototype.checkForProdLimit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var allProds;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.bookingService.getAllProductsForVendor()];
                    case 1:
                        allProds = _a.sent();
    ...
    BookingPage.prototype.goToAddNew = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var navigationExtras;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    BookingPage.prototype.clearSearchProduct = function () {
        this.searchProduct = '';
        this.events.publish('booking:getProductsForAdminProducts');
    };
    BookingPage.prototype.addOptions = function (copies, item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    BookingPage.prototype.checkPdtOutOfDelivery = function (pdt) {
    ...
    BookingPage.prototype.removeSubscriptions = function () {
    ...
    //   return fields;
    // }
    BookingPage.prototype.exportConfirm = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading()];
    ...
    BookingPage.prototype.exportProducts = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    BookingPage.prototype.importProducts = function () {
        this.router.navigate(['import-products']);
    };
    BookingPage.prototype.setAllProductsInactive = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var success;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    BookingPage.prototype.getCategories = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    BookingPage.prototype.getBrands = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var prevMsgDiv, msgDiv, _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    BookingPage.prototype.showSubList = function (i) {
        this.dataList[i].active = !this.dataList[i].active;
        this.selectListItem(i);
    };
    BookingPage.prototype.showAllProducts = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    BookingPage.prototype.selectListItem = function (i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.noMoreCategoryProducts = false;
                        return [4 /*yield*/, this.bookingService.getCategoryProducts(this.dataList[i].id)];
                    case 2:
                        data = _a.sent();
                        if (data) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.bookingService.getBrandProducts(this.dataList[i].id)];
                    case 4:
                        data = _a.sent();
                        if (data) {
                            this.productsData = data;
    ...
    BookingPage.prototype.selectSubCat = function (i, j) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.noMoreCategoryProducts = false;
                        return [4 /*yield*/, this.bookingService.getCategoryProducts(this.dataList[i].sublist[j].id)];
                    case 1:
                        data = _a.sent();
                        if (data) {
                            this.productsData = data;
    ...
    BookingPage.prototype.showSubOfSubList = function (i, j) {
    ...
    BookingPage.prototype.selectSubOfSubCat = function (i, j, k) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var prevMsgDiv, msgDiv, data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.noMoreCategoryProducts = false;
                        return [4 /*yield*/, this.bookingService.getCategoryProducts(this.dataList[i].sublist[j].subOfSubCatList[k].id)];
                    case 1:
                        data = _a.sent();
                        if (data) {
                            this.productsData = data;
    ...
    BookingPage.prototype.presentToast = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    BookingPage.prototype.presentAlert = function (heading, desc) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    BookingPage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
...
//# sourceMappingURL=admin-booking-booking-module-es5.js.map