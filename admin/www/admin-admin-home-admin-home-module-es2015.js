...
let AdminHomePage = class AdminHomePage {
    constructor(events, router, toastController, chatService, guideService, configService, labelService, storage, route, actionSheetController, camera, imagePicker, loadingController, userService, userGroupsService, modalController, sharedService, managerService, whatsappService) {
        this.events = events;
        this.router = router;
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let groups = yield this.userGroupsService.getAllGroups();
            ...
            if (userRole == 'manager') {
                ...
                if (managerDetails && managerDetails.groups && managerDetails.groups.length) {
                    this.groups = yield groups.filter(group => managerDetails.groups.includes(group.id));
                }
                else {
                    this.groups = [];
                }
            ...
            let account = yield this.whatsappService.getWhatsappCredentials();
    ...
    initializeSubscriptions() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const uid = yield this.storage.get('uid');
            this.events.subscribe('chat:publishLastMsgs', (msgs) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.events.subscribe('chat:publishMoreLastMsgs', (msgs) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                const uid = yield this.storage.get('uid');
                const index = msgs.findIndex(msg => msg.id === uid);
                if (index !== -1) {
                    msgs.splice(index, 1);
            ...
            this.events.subscribe('chat:publishMsgs', (msgs) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                this.allMsgs = msgs;
                console.log('msgs:', msgs);
                this.showMsgLoader = false;
                this.showLoader = false;
                yield this.checkLastWhatsappMsg(this.userid);
                if (this.allMsgs) {
                    this.makeImageUrls();
                }
    ...
    onClickLastMsg(id, i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.checkLastWhatsappMsg(id);
        });
    }
    checkLastWhatsappMsg(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.sendToWhatsapp = false;
            const lastWhatsappMsg = yield this.chatService.getLastWhatsappMsg(id);
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.adminMsgText !== '') {
                ...
                if (this.whatsapp && this.sendToWhatsapp) {
                    ...
                    yield this.chatService.sendMsgOnWhatsapp(data);
                }
                else {
                    const msg = {
                        type: 'txt',
            ...
            reader.onload = (event) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                ...
                if (this.whatsapp && this.sendToWhatsapp) {
                    if (this.insights && this.insights.creditsUsed >= this.insights.chatLimit) {
                        ...
                        yield this.chatService.sendImgOnWhatsapp(this.userid, this.msg, imageResponse, this.phoneNo);
                    }
                }
                else {
    ...
    getGroupUsers(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.selectedGroups = yield event.target.value;
    ...
    sendWATemplate() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const success = yield this.chatService.sendMsgOnWhatsapp(data);
...
//# sourceMappingURL=admin-admin-home-admin-home-module-es2015.js.map