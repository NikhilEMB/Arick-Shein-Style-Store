...
let WhatsappBroadcastPageModule = class WhatsappBroadcastPageModule {
};
...
let WhatsappBroadcastPage = class WhatsappBroadcastPage {
    constructor(sharedService, whatsappService, userGroupsService, router) {
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.getAllGroups();
            this.accountDetails = yield this.whatsappService.getWhatsappCredentials();
        });
    }
    getLastBroadcastDetails() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const lastBroadcast = yield this.whatsappService.getLastBroadcastDetails();
    ...
    getAllTemplates() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const templatesWithId = yield this.whatsappService.getAllTemplates();
            if (templatesWithId) {
    ...
    getTemplateDetails(templateIndex) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.logs = [];
            this.logs = yield this.whatsappService.getBroadcastLogs(this.selectedTemplate.id);
    ...
    broadcast() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const success = yield this.whatsappService.doBroadcast({ userType: this.userType, groups: this.selectedGroups, templateName: this.selectedTemplate.id });
...
WhatsappBroadcastPage.ctorParameters = () => [
...
//# sourceMappingURL=admin-whatsapp-whatsapp-broadcast-whatsapp-broadcast-module-es2015.js.map