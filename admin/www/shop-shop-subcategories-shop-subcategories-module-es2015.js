...
let ShopSubcategoriesPageModule = class ShopSubcategoriesPageModule {
};
...
let ShopSubcategoriesPage = class ShopSubcategoriesPage {
    constructor(events, router, route) {
        this.events = events;
        this.router = router;
        this.route = route;
        this.subcategories = [];
...
ShopSubcategoriesPage.ctorParameters = () => [
...
//# sourceMappingURL=shop-shop-subcategories-shop-subcategories-module-es2015.js.map