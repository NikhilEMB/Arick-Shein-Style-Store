...
var PriceRequestsPageModule = /** @class */ (function () {
    function PriceRequestsPageModule() {
    }
    ...
    return PriceRequestsPageModule;
}());
...
var PriceRequestsPage = /** @class */ (function () {
    function PriceRequestsPage(events, loadingController, alertController, router, configService) {
        this.events = events;
    ...
    PriceRequestsPage.prototype.ngOnInit = function () {
    };
    PriceRequestsPage.prototype.ionViewWillEnter = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.isPriceReqFeature == false)) return [3 /*break*/, 3];
    ...
    PriceRequestsPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('price-req:publishAllPriceRequests', function (requests) {
            //console.log('requests', requests);
            _this.allRequests = requests;
            _this.showLoader = false;
        });
        this.events.subscribe('price-req:rejectPriceRequestSuccess', function () {
            _this.loading.dismiss();
            _this.presentAlert('Prices are now inactive for this user.');
        });
        this.events.subscribe('price-req:acceptPriceRequestSuccess', function (msg) {
            _this.loading.dismiss();
            _this.presentAlert(msg);
        });
    };
    PriceRequestsPage.prototype.changePriceReqActive = function (status, uid) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!status) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.presentLoading('Please wait...', 10000)];
                    case 1:
                        _a.sent();
                        this.events.publish('price-req:rejectPriceRequest', uid);
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.presentLoading('Please wait...', 10000)];
                    case 3:
                        _a.sent();
    ...
    PriceRequestsPage.prototype.presentLoading = function (msg, duration) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    PriceRequestsPage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    PriceRequestsPage.prototype.ionViewWillLeave = function () {
        this.showSearch = false;
        this.removeSubscriptions();
    };
    PriceRequestsPage.prototype.removeSubscriptions = function () {
    ...
    PriceRequestsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-price-requests-price-requests-module-es5.js.map