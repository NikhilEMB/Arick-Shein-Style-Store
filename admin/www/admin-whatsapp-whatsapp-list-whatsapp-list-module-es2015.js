...
let WhatsappListPageModule = class WhatsappListPageModule {
};
...
let WhatsappListPage = class WhatsappListPage {
    constructor(whatsappService, sharedService, modalController, alertController, configService) {
    ...
    deleteList(index, type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (type == 'cat') {
                ...
                success = yield this.whatsappService.deleteList(this.menuItems, this.menuButton3, index);
            }
            else {
                title = this.selectedCatSubcategories.list[index].title;
                success = yield this.whatsappService.deleteSubcat(this.menuButton3.list[this.selectedCatIndex].id, this.selectedCatSubcategories, index);
            }
    ...
    saveProducts(mode, type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.sharedService.presentLoading();
            let success = false;
            if (type == 'cat') {
                if (this.selectedCatProducts.list.length == 0) {
                    (yield this.sharedService.loading) ? this.sharedService.loading.dismiss() : {};
                ...
                success = yield this.whatsappService.setListProducts(this.menuButton3, this.selectedCatProducts);
            }
            else {
                ...
                success = yield this.whatsappService.setListWithSubcat(this.selectedCatSubcategories, this.selectedCatProducts);
            }
            this.sharedService.loading ? this.sharedService.loading.dismiss() : {};
            if (success) {
                if (mode == 'edit') {
    ...
    updateSubcategoryStatus(status) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.sharedService.presentLoading();
            console.log('status:', status);
            this.menuButton3.list[this.selectedCatIndex].isSubcategories = status;
            const success = yield this.whatsappService.changeSubcategoryStatus(this.menuButton3, this.selectedCatIndex);
            this.sharedService.loading ? this.sharedService.loading.dismiss() : {};
...
WhatsappListPage.ctorParameters = () => [
...
//# sourceMappingURL=admin-whatsapp-whatsapp-list-whatsapp-list-module-es2015.js.map