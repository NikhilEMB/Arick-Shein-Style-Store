...
var OfferCreatePageModule = /** @class */ (function () {
    function OfferCreatePageModule() {
    }
...
var OfferCreatePage = /** @class */ (function () {
    function OfferCreatePage(events, loadingController, alertController, toastController, router, camera, modalController, actionSheetController, imagePicker, labelService, route) {
        var _this = this;
        this.events = events;
        ...
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.offerData = _this.router.getCurrentNavigation().extras.state.offerData;
                _this.name = _this.offerData.name;
                _this.description = _this.offerData.description;
                _this.sortedAt = _this.offerData.sortedAt;
                _this.images = _this.offerData.images;
                _this.offerId = _this.offerData.id;
                _this.bannerData = _this.offerData.link;
                //console.log('offerData', this.offerData);
            }
        });
    }
    OfferCreatePage.prototype.ngOnInit = function () {
        this.ckeConfig = {
            allowedContent: true,
            toolbar: [
    ...
    OfferCreatePage.prototype.prepareData = function (data) {
        if (!data) {
            data = {
                active: true,
                org: '',
    ...
    OfferCreatePage.prototype.ionViewWillEnter = function () {
        this.initializeSubscriptions();
    };
    OfferCreatePage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    OfferCreatePage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('offer:saveOfferSuccess', function () {
            _this.loading.dismiss();
            _this.presentAlert('Offer data saved successfully. Any images added will be uploaded after couple of minutes.');
        });
    ...
    OfferCreatePage.prototype.saveOffer = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.presentLoading('Saving offer data...', 20000)];
                    case 2:
                        _a.sent();
                        offerData = {
                            name: this.name,
    ...
    OfferCreatePage.prototype.deleteAlertConfirm = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    OfferCreatePage.prototype.deleteOffer = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    OfferCreatePage.prototype.openImageActionSheet = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.actionSheetController.create({
                            ...
                            buttons: [{
                                    ...
                                    icon: 'camera',
                                    handler: function () {
                                        _this.uploadSingleImage('camera');
                                    }
                                }, {
                                    text: 'Crop and upload from gallery',
                                    icon: 'image',
                                    handler: function () {
                                        _this.uploadSingleImage('gallery');
                                    }
                                }, {
                                    text: 'Multiple images from gallery',
                                    icon: 'images',
                                    handler: function () {
                                        _this.uploadMultipleImages();
                                    }
                                },
                                {
                                    text: 'Cancel',
    ...
    OfferCreatePage.prototype.uploadSingleImage = function (type) {
        var _this = this;
        var options = {
            quality: 50,
        ...
        this.camera.getPicture(options).then(function (imageData) {
            ...
            _this.images.push({ url: base64Image });
        }, function (err) {
            //console.log(err);
        });
    };
    OfferCreatePage.prototype.uploadMultipleImages = function () {
        var _this = this;
            ...
            if (results.length !== 0 && results !== 'OK') {
                if (results.length <= 3) {
                    for (var i = 0; i < results.length; i++) {
                        ...
                        _this.images.push({ url: base64Img });
                    }
                }
                else {
                    _this.presentAlert('Please select maximum <strong>3</strong> images from gallery');
                }
            }
        }, function (err) {
            alert(err);
    ...
    OfferCreatePage.prototype.uploadImage = function (files) {
        var _this = this;
    ...
    OfferCreatePage.prototype.removeImage = function (index) {
        this.images.splice(index, 1);
    };
    OfferCreatePage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    OfferCreatePage.prototype.presentLoading = function (msg, duration) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    OfferCreatePage.prototype.presentToast = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    OfferCreatePage.prototype.removeSubscriptions = function () {
        this.events.unsubscribe('offer:saveOfferSuccess');
        this.events.unsubscribe('offer:deleteOfferSucess');
    };
    OfferCreatePage.prototype.selectLinkType = function (i) {
    ...
    OfferCreatePage.prototype.presentModal = function (type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    OfferCreatePage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-offer-create-offer-create-module-es5.js.map