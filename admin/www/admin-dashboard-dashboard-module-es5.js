...
var DashboardPage = /** @class */ (function () {
    function DashboardPage(events, router, labelService, loadingController, alertController, productService, brandService, sharedService) {
        this.events = events;
        this.router = router;
    ...
    DashboardPage.prototype.initializeSubscriptions = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_d) {
                switch (_d.label) {
                    case 0:
                        this.events.subscribe('product:publishOutOfStockProducts', function (products) {
    ...
    DashboardPage.prototype.editProduct = function (itemId) {
    ...
    DashboardPage.prototype.saveProduct = function (itemData, itemID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    DashboardPage.prototype.presentAlert = function (heading, desc) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    DashboardPage.prototype.getPriceListFields = function (priceList) {
        var fields = {
            type: [],
            price: [],
            discountedPrice: [],
    ...
    DashboardPage.prototype.getDateTimeFormat = function (date) {
        return moment__WEBPACK_IMPORTED_MODULE_6__(date).format('MMM D, YYYY hh:mm a');
    };
    DashboardPage.prototype.exportOutOfStockProducts = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var products, count, csvExporter;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DashboardPage.prototype.removeSubscriptions = function () {
    ...
    DashboardPage.prototype.selectAllProducts = function () {
    ...
    DashboardPage.prototype.onClickCheckBox = function (id) {
    ...
    DashboardPage.prototype.editCheckBoxValue = function (id) {
        if (this.selectedProducts.indexOf(id) !== -1) {
            return true;
        }
        else {
    ...
    DashboardPage.prototype.askDeleteProduct = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.selectedProducts.length > 0)) return [3 /*break*/, 3];
                                ...
                                buttons: [
                                    {
                                        ...
                                        handler: function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4 /*yield*/, this.deleteProducts()];
                                                    case 1:
                                                        _a.sent();
                                                        return [2 /*return*/];
                                                }
                    ...
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.sharedService.presentAlert("Please select a product to delete")];
                    case 4:
                        _a.sent();
                        _a.label = 5;
    ...
    DashboardPage.prototype.deleteProducts = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var response;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        if (!(this.selectedProducts.length > 0)) return [3 /*break*/, 8];
                        console.log("product selected to delete: ", this.selectedProducts);
                        return [4 /*yield*/, this.productService.deleteOutOfStockProducts(this.selectedProducts)];
                    case 2:
                        response = _a.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.sharedService.presentAlert("Products deleted successfully")];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 7];
                    ...
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, this.sharedService.presentAlert("Please select a product to delete")];
                    case 10:
                        _a.sent();
                        _a.label = 11;
