...
var MultiVendorAddPageModule = /** @class */ (function () {
    function MultiVendorAddPageModule() {
    }
    ...
    return MultiVendorAddPageModule;
}());
...
var MultiVendorAddPage = /** @class */ (function () {
    function MultiVendorAddPage(events, labelService, router, route, modalController, productService, vendorService, brandService, orderService, sharedService, configService, alertController, categoryService) {
        var _this = this;
        this.events = events;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.router.getCurrentNavigation().extras.state.data];
                    case 1:
                        recieveData = _a.sent();
                        if (recieveData) {
    ...
    MultiVendorAddPage.prototype.ngOnInit = function () {
    ...
    MultiVendorAddPage.prototype.ionViewWillEnter = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.activeTab == 'products')) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.loadProducts()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/];
    ...
    MultiVendorAddPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    MultiVendorAddPage.prototype.initializeSubscriptions = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var multiVendorSettings, brands;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.events.subscribe('vendor:vendorSaved', function () {
                            if (_this.sharedService.loading) {
                                _this.sharedService.loading.dismiss();
                            }
                            _this.sharedService.presentAlert("Vendor saved !");
                        });
                        this.events.subscribe('multi-region:publishAllActiveRegions', function (regions) {
                            if (regions.length) {
                                _this.regions = regions;
                                _this.regionsAvailable = regions;
                                console.log('this.regionsAvailable:', _this.regionsAvailable);
                                for (var i = 0; i < regions.length; i++) {
                                    // if (!regions[i]['vendorId']) {
                                    //   this.regionsAvailable.push(regions[i])
                                    // }
                                    if (regions[i]['id'] == _this.receivedVendorData.regionId) {
                                        _this.currentRegion = regions[i]['name'];
                                    }
                                }
                            }
                        });
                        this.events.subscribe('vendor:changeRegionSuccess', function () {
                            _this.sharedService.presentAlert("Region saved successfully !");
                            _this.events.publish('multi-region:getAllActiveRegions');
                        });
                        this.events.subscribe('vendor:getVendorDataSuccess', function (receivedData) {
                            _this.receivedVendorData = receivedData;
                            _this.vendorDetails.appointmentSlotLimit = receivedData.appointmentSlotLimit ? receivedData.appointmentSlotLimit : 0;
                            _this.vendorDetails.minOrderAmount = receivedData.minOrderAmount ? receivedData.minOrderAmount : 0;
                            _this.vendorDetails.displayName = receivedData.displayName ? receivedData.displayName : '';
                            _this.vendorDetails.description = receivedData.description ? receivedData.description : '';
                            _this.vendorDetails.address = receivedData.address ? receivedData.address : '';
                            _this.vendorDetails.productLimit = 'productLimit' in receivedData ? receivedData.productLimit : null;
                            if (receivedData.vendorAddress) {
                                _this.vendorDetails.vendorAddress = receivedData.vendorAddress;
                            }
                            _this.vendorDetails.approveAllProducts = receivedData.approveAllProducts ? receivedData.approveAllProducts : false;
                            console.log('revievedData:', receivedData);
                            _this.vendorDetails.qrCode = receivedData.qrCode ? receivedData.qrCode : '';
                            if (receivedData.image) {
                                _this.vendorDetails.image = receivedData.image;
                            }
                            if (receivedData.deliveryIntegration) {
                                _this.vendorDetails.deliveryIntegration = receivedData.deliveryIntegration;
                            }
                            if (receivedData.isExclusive) {
                                _this.vendorDetails.isExclusive = receivedData.isExclusive;
                            }
                            if (receivedData.showUserDetails) {
                                _this.vendorDetails.showUserDetails = receivedData.showUserDetails;
                            }
                            if (_this.isUniversal) {
                                _this.slug = "slug" in receivedData ? receivedData.slug : _this.slug;
                            }
                            _this.selectedCategories = receivedData.categories ? receivedData.categories : [];
                            _this.selectedBrands = receivedData.brands ? receivedData.brands : [];
                            _this.invoiceSettings = 'invoiceSettings' in receivedData ? receivedData.invoiceSettings : _this.invoiceSettings;
                            console.log(_this.vendorDetails);
                            _this.events.publish('multi-region:getAllActiveRegions');
                        });
                        this.events.subscribe('vendor:changeActiveStatusVendorSuccess', function () {
                            _this.sharedService.presentAlert("Status changed successfully !");
                        });
                        this.events.subscribe('vendor:removeRegionSuccess', function () {
                            _this.sharedService.presentAlert("Region removed successfully !");
                            _this.currentRegion = '';
                        });
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.brandService.getAllBrands()];
                    case 2:
                        brands = _a.sent();
                        ...
                        // Orders Tab
                        this.events.subscribe('vendor:NoOrders', function () {
                            _this.noMoreOrders = true;
                        });
                        this.events.subscribe('vendor:OrdersLimitReached', function () {
                            _this.noMoreOrders = true;
                        });
                        this.events.subscribe('vendor:getMoreVendorOrdersSuccess', function (orders) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var _i, orders_1, order, _a, _b, productAmt, _c, _d, product;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_e) {
                                switch (_e.label) {
                                    ...
                                    case 1:
                                        ...
                                        _a = order;
                                        _b = 'details';
                                        return [4 /*yield*/, this.orderService.getOrderDetails(order.order.id)];
                                    case 2:
                                        _a[_b] = _e.sent();
                                        productAmt = 0;
                                        for (_c = 0, _d = order.details['products']; _c < _d.length; _c++) {
                                            product = _d[_c];
                        ...
                        // Bookings
                        this.events.subscribe('booking:editSuccess', function (heading, desc) {
                            _this.sharedService.loading.dismiss();
                            _this.events.unsubscribe('booking:editSuccess');
                            _this.presentAlert(desc);
                        });
                        this.events.subscribe('booking:editFailure', function (heading, desc) {
                            _this.sharedService.loading.dismiss();
                            _this.events.unsubscribe('booking:editFailure');
                            _this.presentAlert(desc);
                        });
                        // Food
    ...
    // Products Tab
    MultiVendorAddPage.prototype.loadProducts = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var products, _i, products_1, product;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productService.getVendorProducts(this.vendor)];
                    case 1:
                        products = _a.sent();
    ...
    // Orders Tab
    MultiVendorAddPage.prototype.loadOrders = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var orders;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.totalOrderAmt = 0;
                        return [4 /*yield*/, this.vendorService.getVendorOrders(this.vendor, new Date(this.startOrders.getTime() + 24 * 60 * 60 * 1000), this.endOrders)];
                    case 1:
                        orders = _a.sent();
                        return [4 /*yield*/, this.processVendorOrders(orders)];
                    case 2:
                        _a.sent();
                        this.vendorOrdersLoading = false;
                        return [2 /*return*/];
    ...
    MultiVendorAddPage.prototype.processVendorOrders = function (orders) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _i, orders_2, order, _a, _b, productAmt, _c, _d, product;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _e.label = 1;
                    case 1:
                        if (!(_i < orders_2.length)) return [3 /*break*/, 4];
                        order = orders_2[_i];
                        _a = order;
                        _b = 'details';
                        return [4 /*yield*/, this.orderService.getOrderDetails(order.order.id)];
    ...
    MultiVendorAddPage.prototype.loadMoreOrders = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.vendorService.loadMoreVendorOrders(this.vendor, new Date(this.startOrders.getTime() + 24 * 60 * 60 * 1000), this.endOrders)];
                    case 1:
                        _a.sent();
                        setTimeout(function () {
    ...
    MultiVendorAddPage.prototype.filterOrder = function () {
    ...
    MultiVendorAddPage.prototype.clearFilter = function () {
    ...
    // Reports Tab
    MultiVendorAddPage.prototype.loadReports = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.events.subscribe('reports:getReportSuccess', function (reports) {
                    ...
                    _this.reports = reports.filter(function (report) { return report.id === _this.vendor; });
                    for (var _i = 0, _a = _this.reports; _i < _a.length; _i++) {
                        var report = _a[_i];
                        for (var _b = 0, _c = report.products; _b < _c.length; _b++) {
                            var product = _c[_b];
                            _this.totalCommission += product.commission;
                            _this.totalPrice += product.sales;
                        }
                    }
                    if (_this.sharedService.loading) {
                        _this.sharedService.loading.dismiss();
    ...
    MultiVendorAddPage.prototype.addRegion = function (e) {
        this.events.publish('vendor:changeRegion', e.target.value, this.vendor);
    };
    MultiVendorAddPage.prototype.removeRegion = function () {
        this.events.publish('vendor:removeRegion', this.vendor);
    };
    MultiVendorAddPage.prototype.toggleActive = function () {
    ...
    MultiVendorAddPage.prototype.saveVendor = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var slugName, sameSlugExists, obj;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.isUniversal) return [3 /*break*/, 2];
                        slugName = this.sharedService.createSlugName(this.slug.name);
                        return [4 /*yield*/, this.sharedService.sameSlugExists('vendors', this.vendor, slugName)];
                    case 1:
                    ...
                    case 3:
                        _a.sent();
                        obj = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.vendorDetails);
    ...
    MultiVendorAddPage.prototype.copyProducts = function () {
    ...
    MultiVendorAddPage.prototype.removeSubscriptions = function () {
    ...
    // Details Tab
    MultiVendorAddPage.prototype.getSubcategories = function (cid) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var subcategories;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    MultiVendorAddPage.prototype.getSubOfSubCategories = function (catId, subCatId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    MultiVendorAddPage.prototype.onClickCategoryCheckBox = function (cid) {
    ...
    MultiVendorAddPage.prototype.onClickBrandCheckBox = function (bid) {
    ...
    MultiVendorAddPage.prototype.editCheckBoxValue = function (id) {
    ...
    MultiVendorAddPage.prototype.editBrandCheckBoxValue = function (id) {
    ...
    // Products Tab
    MultiVendorAddPage.prototype.selectCommissionType = function (commissionType) {
        this.commissionType = commissionType;
    };
    MultiVendorAddPage.prototype.setCommission = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _i, _a, product;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        _i = 0, _a = this.productsData;
                        _b.label = 2;
                    case 2:
                        if (!(_i < _a.length)) return [3 /*break*/, 5];
                        product = _a[_i];
                        product.commission = this.singleCommission;
                        return [4 /*yield*/, this.vendorService.setCommissionForProduct(product.id, this.singleCommission)];
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [4 /*yield*/, this.sharedService.loading.dismiss()];
                    case 6:
                        _b.sent();
                        return [4 /*yield*/, this.sharedService.presentAlert('Commission set for all products!')];
                    case 7:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    MultiVendorAddPage.prototype.saveProduct = function (productData, itemID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sharedService.presentLoading()];
    ...
    // Reports Tab
    MultiVendorAddPage.prototype.getReport = function () {
    ...
    MultiVendorAddPage.prototype.exportReport = function () {
        var data = [];
    ...
    MultiVendorAddPage.prototype.onClickViewOrder = function (orderId) {
        this.modalController.create({
    ...
    MultiVendorAddPage.prototype.uploadImage = function (files) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var i, reader;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                for (i = 0; i < files.length; i++) {
                    ...
                    reader.onload = function (event) {
                        ...
                        _this.vendorDetails.image.url = base64Image;
                    };
                }
                return [2 /*return*/];
            });
    ...
    MultiVendorAddPage.prototype.removeImage = function () {
        this.vendorDetails.image.url = '';
        this.vendorDetails.image.mob = '';
        this.vendorDetails.image.thumb = '';
    };
    MultiVendorAddPage.prototype.openAreaModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            ...
                            if (res.data && res.data.lat != 0 && res.data.lng != 0) {
                                _this.vendorDetails.vendorAddress['lat'] = res.data.lat;
                                _this.vendorDetails.vendorAddress['lng'] = res.data.lng;
                                _this.vendorDetails.vendorAddress['address'] = res.data.address;
                            }
                        });
    ...
    MultiVendorAddPage.prototype.selectDate = function (dateSelected) {
        this.startDate = undefined;
        this.endDate = undefined;
    ...
    MultiVendorAddPage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    MultiVendorAddPage.prototype.showUserDetailsToVendor = function () {
        this.vendorDetails.showUserDetails = !this.vendorDetails.showUserDetails;
    };
    MultiVendorAddPage.prototype.checkProductToDeliver = function () {
    ...
    MultiVendorAddPage.prototype.showAdminLogoToggle = function () {
        this.invoiceSettings.logo.adminLogo = !this.invoiceSettings.logo.adminLogo;
    };
    MultiVendorAddPage.prototype.uploadInvoiceImg = function (files, imgType) {
        var _this = this;
        for (var i = 0; i < files.length; i++) {
            ...
            reader.onload = function (event) {
                var base64Image = event.target.result;
                if (imgType === 'sign') {
                    _this.invoiceSettings.signature = base64Image;
                }
                else {
                    _this.invoiceSettings.logo.url = base64Image;
                }
            };
        }
    };
    MultiVendorAddPage.prototype.removeImg = function (imgType) {
        if (imgType === 'sign') {
    ...
    MultiVendorAddPage.prototype.onClickStatustItem = function (index, name) {
        this.activeProjectIndex = index;
        console.log(name);
        this.buttonActive = name;
    };
    MultiVendorAddPage.prototype.openImg = function (url) {
        window.open(url, "_blank");
    };
    MultiVendorAddPage.prototype.editProduct = function (item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    MultiVendorAddPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-multi-vendor-multi-vendor-add-multi-vendor-add-module-es5.js.map