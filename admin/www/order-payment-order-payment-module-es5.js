...
var OrderPaymentPageModule = /** @class */ (function () {
    function OrderPaymentPageModule() {
    }
...
var OrderPaymentPage = /** @class */ (function () {
    function OrderPaymentPage(events, router, alertController, loadingController, route, storage, navCtrl) {
        var _this = this;
        this.events = events;
        this.router = router;
    ...
    OrderPaymentPage.prototype.ngOnInit = function () {
    };
    OrderPaymentPage.prototype.ionViewDidEnter = function () {
    ...
    OrderPaymentPage.prototype.ionViewWillLeave = function () {
        this.removeSubscription();
    };
    OrderPaymentPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        ...
        this.events.subscribe('user:setPaymentModeOfOrderByUserSuccessfully', function () {
            ...
            _this.presentAlert('Payment Mode has been set successfully');
        });
        ...
        this.events.subscribe('order:modeSetToCashSuccess', function () {
            _this.loading.dismiss();
            _this.presentAlert('Payment Mode has been set to cash successfully');
        });
    };
    OrderPaymentPage.prototype.getTotalItems = function () {
        return this.orderData[0].products.length;
    };
    OrderPaymentPage.prototype.onClickPaymentMode = function (mode) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(mode === 'cash')) return [3 /*break*/, 2];
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(mode === 'card' || mode === 'wallet' || mode === 'upi' || mode === 'netbanking')) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.presentLoading()];
                    case 3:
                        _a.sent();
                        ...
                        _a.label = 4;
                    case 4:
                        if (!(mode === 'paytm')) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.presentLoading()];
                    case 5:
                        _a.sent();
    ...
    OrderPaymentPage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alertController.create({
                            ...
                            buttons: [{
                                    text: 'Ok',
                                    handler: function () {
                                        _this.navCtrl.navigateRoot(['shop-categories']);
                                    }
                                }]
                        })];
                    case 1:
    ...
    OrderPaymentPage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    OrderPaymentPage.prototype.presentFailureAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    OrderPaymentPage.prototype.removeSubscription = function () {
    ...
    OrderPaymentPage.ctorParameters = function () { return [
...
//# sourceMappingURL=order-payment-order-payment-module-es5.js.map