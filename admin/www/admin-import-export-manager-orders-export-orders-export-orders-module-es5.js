...
var ExportOrdersPageModule = /** @class */ (function () {
    function ExportOrdersPageModule() {
    }
...
var ExportOrdersPage = /** @class */ (function () {
    function ExportOrdersPage(importExportManagerService, sharedService, userService, pickup, toastController, loadingController) {
    ...
    ExportOrdersPage.prototype.ngOnInit = function () { };
    ExportOrdersPage.prototype.animation = function () {
    ...
    ExportOrdersPage.prototype.ionViewWillEnter = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.sent();
                        _a = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllOrdersLength()];
                    case 2:
                        _a.totalOrders = _c.sent();
                        _b = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllConfirmedOrders()
                            // this.filteredOrders = this.allOrders
                        ];
                    case 3:
                        _b.allOrders = _c.sent();
                        // this.filteredOrders = this.allOrders
    ...
    ExportOrdersPage.prototype.presentToastWithOptions = function (header, message, errorCode) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
    ...
    ExportOrdersPage.prototype.saveDisable = function () {
    ...
    ExportOrdersPage.prototype.disableArchiveState = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.setOrderStatus(this.currentOrderStatus)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ExportOrdersPage.prototype.disableDatePicker = function () {
        var _this = this;
        if (this.isDisableDatePicker) {
            ...
            this.animation();
            setTimeout(function () {
                _this.isDisableDatePicker = !_this.isDisableDatePicker;
            }, 400);
        }
        else {
    ...
    ExportOrdersPage.prototype.filterDate = function (state) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, _b;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!(state === 'start')) return [3 /*break*/, 4];
                        if (!this.dateObj.startDate) return [3 /*break*/, 3];
                        this.receivedStart = true;
                        if (!this.dateObj.endDate) return [3 /*break*/, 2];
                        _a = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllOrdersPreset(this.currentOrderStatus, new Date(this.dateObj.endDate), new Date(this.dateObj.startDate))
                            // console.log('111 this.startDate = ' + this.startOrders)
                            // this.startOrders = new Date(new Date().getTime() + 24 * 60 * 60 * 1000)
                            // this.endOrders = new Date(new Date().getTime() - (7 * 24 * 60 * 60 * 1000))
                        ];
                    case 1:
                        _a.allOrders = _c.sent();
                        _c.label = 2;
                    ...
                    case 3:
                        ...
                        _c.label = 4;
                    case 4:
                        if (!(state === 'end')) return [3 /*break*/, 9];
                        if (!this.receivedStart) return [3 /*break*/, 7];
                        if (!this.dateObj.endDate) return [3 /*break*/, 6];
                        _b = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllOrdersPreset(this.currentOrderStatus, new Date(this.dateObj.endDate), new Date(this.dateObj.startDate))
                    ...
                    case 7: return [4 /*yield*/, this.presentToastWithOptions('Date Range Warning!', "Please select both end & start date!", 'WAR-127')];
                    case 8:
                        _c.sent();
                        _c.label = 9;
                    case 9:
    ...
    ExportOrdersPage.prototype.alertDatePicker = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.isDisableDatePicker) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.presentToastWithOptions('Date Picker Warning!', "Enable the date range module via the toggle to proceed!", 'WAR-124')];
                    case 1:
                        _a.sent();
                        _a.label = 2;
    ...
    ExportOrdersPage.prototype.filterArchiveOrders = function () {
        var filteredOrders = [];
    ...
    ExportOrdersPage.prototype.setOrderStatus = function (status) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                ...
                switch (_t.label) {
                    ...
                    case 1:
                        ...
                        switch (_a) {
                            ...
                            case 'Dispatched': return [3 /*break*/, 12];
                            case 'Delivered': return [3 /*break*/, 17];
                            case 'Cancelled': return [3 /*break*/, 22];
                            case 'Rejected': return [3 /*break*/, 27];
                            case 'Returned': return [3 /*break*/, 32];
                            case 'Payment Pending': return [3 /*break*/, 37];
                        }
                        return [3 /*break*/, 42];
                    case 2:
                        if (!this.datePreset) return [3 /*break*/, 4];
                        _b = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllOrdersPreset(this.currentOrderStatus, new Date(this.startOrders.getTime() + 24 * 60 * 60 * 1000), this.endOrders)];
                    case 3:
                        _b.allOrders = _t.sent();
                        return [3 /*break*/, 6];
                    case 4:
                        _c = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllConfirmedOrders()];
                    case 5:
                        _c.allOrders = _t.sent();
                        _t.label = 6;
                    case 6: return [3 /*break*/, 42];
                    case 7:
                        if (!this.datePreset) return [3 /*break*/, 9];
                        _d = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllOrdersPreset(this.currentOrderStatus, new Date(this.startOrders.getTime() + 24 * 60 * 60 * 1000), this.endOrders)];
                    case 8:
                        _d.allOrders = _t.sent();
                        return [3 /*break*/, 11];
                    case 9:
                        _e = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllPendingOrders()];
                    case 10:
                        _e.allOrders = _t.sent();
                        _t.label = 11;
                    case 11: return [3 /*break*/, 42];
                    case 12:
                        if (!this.datePreset) return [3 /*break*/, 14];
                        _f = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllOrdersPreset(this.currentOrderStatus, new Date(this.startOrders.getTime() + 24 * 60 * 60 * 1000), this.endOrders)];
                    case 13:
                        _f.allOrders = _t.sent();
                        return [3 /*break*/, 16];
                    case 14:
                        _g = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllDispatchedOrders()];
                    case 15:
                        _g.allOrders = _t.sent();
                        _t.label = 16;
                    case 16: return [3 /*break*/, 42];
                    case 17:
                        if (!this.datePreset) return [3 /*break*/, 19];
                        _h = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllOrdersPreset(this.currentOrderStatus, new Date(this.startOrders.getTime() + 24 * 60 * 60 * 1000), this.endOrders)];
                    case 18:
                        _h.allOrders = _t.sent();
                        return [3 /*break*/, 21];
                    case 19:
                        _j = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllDeliveredOrders()];
                    case 20:
                        _j.allOrders = _t.sent();
                        _t.label = 21;
                    case 21: return [3 /*break*/, 42];
                    case 22:
                        if (!this.datePreset) return [3 /*break*/, 24];
                        _k = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllOrdersPreset(this.currentOrderStatus, new Date(this.startOrders.getTime() + 24 * 60 * 60 * 1000), this.endOrders)];
                    case 23:
                        _k.allOrders = _t.sent();
                        return [3 /*break*/, 26];
                    case 24:
                        _l = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllCancelledOrders()];
                    case 25:
                        _l.allOrders = _t.sent();
                        _t.label = 26;
                    case 26: return [3 /*break*/, 42];
                    case 27:
                        if (!this.datePreset) return [3 /*break*/, 29];
                        _m = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllOrdersPreset(this.currentOrderStatus, new Date(this.startOrders.getTime() + 24 * 60 * 60 * 1000), this.endOrders)];
                    case 28:
                        _m.allOrders = _t.sent();
                        return [3 /*break*/, 31];
                    case 29:
                        _o = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllRejectedOrders()];
                    case 30:
                        _o.allOrders = _t.sent();
                        _t.label = 31;
                    case 31: return [3 /*break*/, 42];
                    case 32:
                        if (!this.datePreset) return [3 /*break*/, 34];
                        _p = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllOrdersPreset(this.currentOrderStatus, new Date(this.startOrders.getTime() + 24 * 60 * 60 * 1000), this.endOrders)];
                    case 33:
                        _p.allOrders = _t.sent();
                        return [3 /*break*/, 36];
                    case 34:
                        _q = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllReturnedOrders()];
                    case 35:
                        _q.allOrders = _t.sent();
                        _t.label = 36;
                    case 36: return [3 /*break*/, 42];
                    case 37:
                        if (!this.datePreset) return [3 /*break*/, 39];
                        _r = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllOrdersPreset(this.currentOrderStatus, new Date(this.startOrders.getTime() + 24 * 60 * 60 * 1000), this.endOrders)];
                    case 38:
                        _r.allOrders = _t.sent();
                        return [3 /*break*/, 41];
                    case 39:
                        _s = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllPaymentPendingOrders()];
                    case 40:
                        _s.allOrders = _t.sent();
                        _t.label = 41;
    ...
    ExportOrdersPage.prototype.customCaller = function (status) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_k) {
                switch (_k.label) {
                    case 0:
                        ...
                        _a = status;
                        switch (_a) {
                            case 'Confirmed': return [3 /*break*/, 1];
                            case 'Pending': return [3 /*break*/, 3];
                            case 'Dispatched': return [3 /*break*/, 5];
                            case 'Delivered': return [3 /*break*/, 7];
                            case 'Cancelled': return [3 /*break*/, 9];
                            case 'Rejected': return [3 /*break*/, 11];
                            case 'Returned': return [3 /*break*/, 13];
                            case 'Payment Pending': return [3 /*break*/, 15];
                        }
                        return [3 /*break*/, 17];
                    case 1:
                        _b = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllConfirmedOrders()];
                    case 2:
                        _b.allOrders = _k.sent();
                        return [3 /*break*/, 17];
                    case 3:
                        _c = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllPendingOrders()];
                    case 4:
                        _c.allOrders = _k.sent();
                        return [3 /*break*/, 17];
                    case 5:
                        _d = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllDispatchedOrders()];
                    case 6:
                        _d.allOrders = _k.sent();
                        return [3 /*break*/, 17];
                    case 7:
                        _e = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllDeliveredOrders()];
                    case 8:
                        _e.allOrders = _k.sent();
                        return [3 /*break*/, 17];
                    case 9:
                        _f = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllCancelledOrders()];
                    case 10:
                        _f.allOrders = _k.sent();
                        return [3 /*break*/, 17];
                    case 11:
                        _g = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllRejectedOrders()];
                    case 12:
                        _g.allOrders = _k.sent();
                        return [3 /*break*/, 17];
                    case 13:
                        _h = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllReturnedOrders()];
                    case 14:
                        _h.allOrders = _k.sent();
                        return [3 /*break*/, 17];
                    case 15:
                        _j = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllPaymentPendingOrders()];
                    case 16:
                        _j.allOrders = _k.sent();
                        return [3 /*break*/, 17];
    ...
    ExportOrdersPage.prototype.setDateRange = function (type, date) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        if (!(type === 'preset')) return [3 /*break*/, 6];
                        this.datePreset = date;
                        if (!(this.datePreset == 0)) return [3 /*break*/, 3];
                        this.disableDatePickerRange = false;
                        return [4 /*yield*/, this.customCaller(this.currentOrderStatus)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 5];
                    case 3:
    ...
    ExportOrdersPage.prototype.getProducts = function (products) {
        var prods = [];
    ...
    ExportOrdersPage.prototype.getVendorNameForCSV = function (vendorId, order) {
    ...
    ExportOrdersPage.prototype.getDateTimeFormat = function (date) {
        return moment__WEBPACK_IMPORTED_MODULE_3__(date).format('MMM D, YYYY hh:mm a');
    };
    ExportOrdersPage.prototype.presentLoading = function (msg, duration) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    ExportOrdersPage.prototype.exportAllOrders = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllOrders()
                            // console.log('this.allOrders : ', this.allOrders)
                        ];
                    case 1:
                        _a.allOrders = _b.sent();
                        // console.log('this.allOrders : ', this.allOrders)
                        return [4 /*yield*/, this.exportOrdersHandler()];
                    case 2:
                        // console.log('this.allOrders : ', this.allOrders)
                        _b.sent();
                        return [2 /*return*/];
    ...
    ExportOrdersPage.prototype.exportOrdersHandler = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, _b, data, count, _loop_1, this_1, _i, _c, order, csvExporter;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.sent();
                        if (!(!this.isDisableDatePicker)) return [3 /*break*/, 7];
                        console.log('execute with datePreset');
                        console.log('Date Preset : ', this.datePreset);
                        console.log('Date Object : ', this.dateObj);
                        if (!(((this.datePreset === undefined) || (this.datePreset == 0)) && ((this.dateObj['startDate'] === '') && (this.dateObj['endDate'] === '')))) return [3 /*break*/, 3];
                        console.log('none selected');
                        return [4 /*yield*/, this.presentToastWithOptions('Date Picker Error!', "Select either the date preset or the date range for filtering the orders!", 'ERR-164')];
                    case 2:
                        _d.sent();
                        return [2 /*return*/];
                    case 3:
                        console.log('selected');
                        if (!((this.datePreset) && (this.datePreset != 0))) return [3 /*break*/, 5];
                        ...
                        return [4 /*yield*/, this.importExportManagerService.getAllOrdersPreset(this.currentOrderStatus, new Date(this.startOrders.getTime() + 24 * 60 * 60 * 1000), this.endOrders)];
                    case 4:
                        _a.allOrders = _d.sent();
                        console.log('allOrders : ', this.allOrders);
                        _d.label = 5;
                    case 5:
                        if (!(this.dateObj['startDate'] && this.dateObj['endDate'])) return [3 /*break*/, 7];
                        ...
                        _b = this;
                        return [4 /*yield*/, this.importExportManagerService.getAllOrdersPreset(this.currentOrderStatus, this.startOrders, this.endOrders)];
                    case 6:
                        _b.allOrders = _d.sent();
                        console.log('allOrders : ', this.allOrders);
                        _d.label = 7;
                    case 7:
                        ...
                        _loop_1 = function (order) {
                            var data_1, products, delivery_date, quantityAll, orderIgst, orderSgst, orderCgst, totalAmount2Decimal, obj, index, product, productIgst, productCgst, productSgst, productGst, vendorName;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        count++;
                                    ...
                                    case 1:
                                        ...
                                        order['deliveryPhoneNo'] = (data_1 && data_1['phoneNo']) ? "[ " + data_1['phoneNo'] + " ]" : '';
                                        return [3 /*break*/, 3];
                                    case 2:
                                        order['deliveryName'] = '';
                                    ...
                                    case 3:
                                        ...
                                        order.products.forEach(function (product, index) {
                                            quantityAll = quantityAll + _this.getProductQty(index, order);
                                        ...
                                        for (index = 0; index < order.products.length; index++) {
                                            ...
                                            data.push({
                                                ...
                                                productQuantity: this_1.getProductQty(index, order),
    ...
    ExportOrdersPage.prototype.getProductQty = function (index, order) {
    ...
    ExportOrdersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-import-export-manager-orders-export-orders-export-orders-module-es5.js.map