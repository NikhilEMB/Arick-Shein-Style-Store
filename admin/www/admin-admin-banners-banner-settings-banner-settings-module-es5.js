...
var BannerSettingsPageModule = /** @class */ (function () {
    function BannerSettingsPageModule() {
    }
    ...
    return BannerSettingsPageModule;
}());
...
var BannerSettingsPage = /** @class */ (function () {
    function BannerSettingsPage(events, router, camera, alertController, loadingController, toastController, labelService, logglyService, route, modalController, configService) {
        var _this = this;
        this.events = events;
        this.router = router;
        this.camera = camera;
        ...
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.bannerData = _this.router.getCurrentNavigation().extras.state.bannerData;
                _this.bannerType = _this.router.getCurrentNavigation().extras.state.bannerType;
                _this.index = _this.router.getCurrentNavigation().extras.state.index;
                console.log('this.bannerData', _this.bannerData, _this.index);
            }
        });
    }
    BannerSettingsPage.prototype.ngOnInit = function () {
    ...
    BannerSettingsPage.prototype.prepareData = function (data) {
        if (!data) {
            data = {
                active: true,
                org: '',
    ...
    BannerSettingsPage.prototype.ionViewWillEnter = function () {
        this.initializeSubscriptions();
    };
    BannerSettingsPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    BannerSettingsPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('banners:saveBannerSuccess', function () {
            if (_this.loading) {
                _this.loading.dismiss();
            }
            _this.presentAlert(_this.BANNER_SETTINGS_LABELS['data_saved_msg']);
        });
    };
    BannerSettingsPage.prototype.toggleActive = function () {
        this.bannerData.active = !this.bannerData.active;
    };
    BannerSettingsPage.prototype.removeImage = function () {
        this.bannerData.org = '';
        this.bannerData.thumb = '';
        this.bannerData.mob = '';
    };
    BannerSettingsPage.prototype.imgZoom = function (img) {
    ...
    BannerSettingsPage.prototype.uploadImage = function (files) {
        var _this = this;
        //console.log(type);
        for (var i = 0; i < files.length; i++) {
            ...
            reader.onload = function (event) {
                ...
                _this.bannerData.org = base64Image;
                console.log(_this.bannerData.org);
            };
        }
    };
    BannerSettingsPage.prototype.presentLoading = function () {
    ...
    BannerSettingsPage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
    ...
    BannerSettingsPage.prototype.presentToast = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    BannerSettingsPage.prototype.selectLinkType = function (i) {
    ...
    BannerSettingsPage.prototype.presentModal = function (type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            ...
                            if (res.data) {
                                _this.bannerData.link.id = res.data.id;
    ...
    BannerSettingsPage.prototype.searchTextAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    BannerSettingsPage.prototype.defaultLinkType = function () {
        this.bannerData.link.id = '';
        this.bannerData.link.name = '';
        this.bannerData.link.type = this.BANNER_SETTINGS_LABELS['none'];
    };
    BannerSettingsPage.prototype.saveBannerData = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.bannerData.active && !this.bannerData.org)) return [3 /*break*/, 1];
    ...
    BannerSettingsPage.prototype.addBanner = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    BannerSettingsPage.prototype.filterData = function () {
    ...
    BannerSettingsPage.prototype.removeSubscriptions = function () {
        this.events.unsubscribe('banners:saveBannerSuccess');
    };
    BannerSettingsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-admin-banners-banner-settings-banner-settings-module-es5.js.map