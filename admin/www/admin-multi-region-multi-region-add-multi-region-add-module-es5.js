...
var MultiRegionAddPageModule = /** @class */ (function () {
    function MultiRegionAddPageModule() {
    }
    ...
    return MultiRegionAddPageModule;
}());
...
var MultiRegionAddPage = /** @class */ (function () {
    function MultiRegionAddPage(events, labelService, alertController, loadingController, router, route, ngZone) {
        var _this = this;
        this.events = events;
        ...
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                var dataCurrent = _this.router.getCurrentNavigation().extras.state.data;
                if (dataCurrent && dataCurrent.regionType) {
                    _this.type = dataCurrent.regionType;
                }
                if (dataCurrent && dataCurrent.regionData) {
                    _this.region = dataCurrent.regionData;
                }
                if (dataCurrent) {
                    if (_this.region['center']) {
                        _this.center = _this.region['center'];
                        _this.latitude = _this.center.lat;
                        _this.longitude = _this.center.lng;
                    }
                    else {
                    ...
                    if (_this.region['radius']) {
                        _this.radius = _this.region['radius'];
                    }
                }
            }
        });
    }
    MultiRegionAddPage.prototype.ngOnInit = function () {
        this.SHARED_LABELS = this.labelService.labels['SHARED'];
        this.ADD_REGION_LABELS = this.labelService.labels['ADD_REGION'];
        this.headerText = this.ADD_REGION_LABELS['header_text'];
    };
    MultiRegionAddPage.prototype.ionViewWillEnter = function () {
    ...
    MultiRegionAddPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    MultiRegionAddPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('multi-region:regionSaved', function () {
            if (_this.loading) {
                _this.loading.dismiss();
            }
            _this.presentAlert("Region saved");
        });
    };
    MultiRegionAddPage.prototype.toggleActive = function () {
        this.region.active = !this.region.active;
    };
    MultiRegionAddPage.prototype.addPincode = function () {
        this.region.pincodes.push(this.pincode);
        this.pincode = null;
    };
    MultiRegionAddPage.prototype.removePin = function (i) {
        this.region.pincodes.splice(i, 1);
    };
    MultiRegionAddPage.prototype.presentLoading = function (duration, msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    MultiRegionAddPage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    MultiRegionAddPage.prototype.saveRegion = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.region.name) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.presentAlert("Please add region name")];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.presentLoading(5000, "Please wait ...")];
                    case 3:
                        _a.sent();
    ...
    MultiRegionAddPage.prototype.changeCenter = function () {
        this.center = {
            lat: this.latitude,
            lng: this.longitude,
        };
    };
    MultiRegionAddPage.prototype.centerChanged = function () {
        var currentCenter = JSON.parse(JSON.stringify(this.gmap.getCenter()));
        this.latitude = currentCenter.lat;
        this.longitude = currentCenter.lng;
    };
    MultiRegionAddPage.prototype.removeSubscriptions = function () {
        this.events.unsubscribe('multi-region:regionSaved');
    };
    MultiRegionAddPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-multi-region-multi-region-add-multi-region-add-module-es5.js.map