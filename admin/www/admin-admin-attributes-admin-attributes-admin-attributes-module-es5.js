...
var AdminAttributesPageModule = /** @class */ (function () {
    function AdminAttributesPageModule() {
    }
    ...
    return AdminAttributesPageModule;
}());
...
var AdminAttributesPage = /** @class */ (function () {
    function AdminAttributesPage(attributeService, alertController, sharedService) {
    ...
    AdminAttributesPage.prototype.ngOnInit = function () {
    };
    AdminAttributesPage.prototype.ionViewWillEnter = function () {
    ...
    AdminAttributesPage.prototype.showProductAttributes = function () {
        this.dataType = 'productAttr';
    };
    AdminAttributesPage.prototype.showUserAttributes = function () {
        this.dataType = 'userAttr';
    };
    AdminAttributesPage.prototype.addField = function () {
    ...
    AdminAttributesPage.prototype.addValueAlert = function (attribute) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        if (_this.subValues[attribute] && _this.subValues[attribute].length) {
                                            _this.subValues[attribute].push(data.value);
                                        }
                                        else {
                                            var arr = [data.value];
                                            _this.subValues[attribute] = arr;
                                        }
                                        console.log('subValues', _this.subValues);
                                    }
                                }
                            ]
                        })];
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.attributeService.setProductAttributes({
                    ...
                    case 3:
                        _a.sent();
                        if (!setData) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.sharedService.presentAlert("Attribute saved successfully")];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.sharedService.presentAlert("Something went wrong. Please try again later")];
                    case 6:
                        _a.sent();
                        _a.label = 7;
    ...
    AdminAttributesPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-admin-attributes-admin-attributes-admin-attributes-module-es5.js.map