...
/* harmony import */ var _ionic_super_tabs_angular__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ionic-super-tabs/angular */ "./node_modules/@ionic-super-tabs/angular/fesm2015/ionic-super-tabs-angular.js");
...
let AdminOrdersPageModule = class AdminOrdersPageModule {
};
...
let AdminOrdersPage = class AdminOrdersPage {
    constructor(modalController, events, afs, router, loadingController, alertController, navCtrl, productService, userService, platform, storage, configService, inAppBrowser, sharedService, popoverController, orderService, pickup, adminSettingsService, managerService, _renderer2, whatsappService, searchEngineService) {
    ...
    ionViewDidEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let labelsData = yield this.userService.getOrderLabels();
            if (labelsData && labelsData['labels']) {
                this.labels = labelsData['labels'];
            }
            const userRole = yield this.storage.get('userRole');
            if (userRole == 'manager') {
                this.user.role = 'manager';
                const uid = yield this.storage.get('uid');
                this.user.id = uid;
                const managerDetails = yield this.managerService.getManagerData(uid, 'service');
            ...
            const accountDetails = yield this.whatsappService.getWhatsappCredentials();
            if (accountDetails) {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.productSetting = yield this.productService.getProductSetting();
    ...
    initializeSubscriptions() {
        ...
        this.events.subscribe('user:publishOrderDetailsWithOrderId', (orderData) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.logData = yield this.userService.getOrderLogs(orderData[0].id);
        ...
        this.events.subscribe('order:updateOrderArchiveSuccess', () => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.ordersList.splice(this.archiveIndex, 1);
    ...
    getOrderWithLables(label, i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let orders = yield this.userService.getOrdersByLabel(label, this.startOrders, this.endOrders);
            this.ordersList = orders;
            this.noMoreOrders = false;
            if (this.loading) {
                this.loading.dismiss();
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.currentOrders == 'pending') {
                if (this.dateFiltered) {
                    this.allPendingOrders = yield this.userService.getAllPendingOrdersForAdmin(dateObj);
                }
                else {
                    this.allPendingOrders = yield this.userService.getAllPendingOrdersForAdmin();
                }
                this.allTypeOrders = this.allPendingOrders;
            }
            else if (this.currentOrders == 'failed') {
                if (this.dateFiltered) {
                    this.allPaymentFailedOrders = yield this.userService.getAllPaymentFailedOrders(dateObj);
                }
                else {
                    this.allPaymentFailedOrders = yield this.userService.getAllPaymentFailedOrders();
                }
                this.allTypeOrders = this.allPaymentFailedOrders;
            }
            else if (this.currentOrders == 'paymentPending') {
                if (this.dateFiltered) {
                    this.allPaymentPendingOrders = yield this.userService.getAllPaymentPendingOrders(dateObj);
                }
                else {
                    this.allPaymentPendingOrders = yield this.userService.getAllPaymentPendingOrders();
                }
                this.allTypeOrders = this.allPaymentPendingOrders;
            }
            else if (this.currentOrders == 'cancelled') {
                if (this.dateFiltered) {
                    this.allCancelledOrders = yield this.userService.getAllCancelledOrders(dateObj);
                }
                else {
                    this.allCancelledOrders = yield this.userService.getAllCancelledOrders();
                }
                this.allTypeOrders = this.allCancelledOrders;
            }
            else if (this.currentOrders == 'rejected') {
                if (this.dateFiltered) {
                    this.allRejectedOrders = yield this.userService.getAllRejectedOrders(dateObj);
                }
                else {
                    this.allRejectedOrders = yield this.userService.getAllRejectedOrders();
                }
                this.allTypeOrders = this.allRejectedOrders;
            }
            else if (this.currentOrders == 'returned') {
                if (this.dateFiltered) {
                    this.allReturnedOrders = yield this.userService.getAllReturnedOrders(dateObj);
                }
                else {
                    this.allReturnedOrders = yield this.userService.getAllReturnedOrders();
                }
                this.allTypeOrders = this.allReturnedOrders;
            }
            else if (this.currentOrders == 'completed') {
                if (this.dateFiltered) {
                    this.allCompletedOrders = yield this.userService.getAllCompletedOrdersForAdmin(dateObj);
                }
                else {
                    this.allCompletedOrders = yield this.userService.getAllCompletedOrdersForAdmin();
                }
                this.allTypeOrders = this.allCompletedOrders;
            }
            else {
                if (this.dateFiltered) {
                    this.allDispatchedOrders = yield this.userService.getAllDispatchedOrdersForAdmin(dateObj);
                }
                else {
                    this.allDispatchedOrders = yield this.userService.getAllDispatchedOrdersForAdmin();
                }
    ...
    downloadOrders(name, orders) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (orders && orders.length > 0) {
                ...
                const csvExporter = new export_to_csv__WEBPACK_IMPORTED_MODULE_9__["ExportToCsv"](this.options);
    ...
    confirmOrder() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.presentLoading();
            let data = yield this.userService.checkProductAvailability(this.orderData[0]);
            // console.log(data);
    ...
    onChangeBranch(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const res = yield this.orderService.updateOrderData(this.orderData[0].id, updateObj);
            yield this.sharedService.loading.dismiss();
            if (res) {
                yield this.sharedService.presentAlert('Branch assigned successfully');
            }
            else {
    ...
    proceedInvoiceGeneration(customInvoiceNo) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log('inisde generation');
            yield this.presentLoading("Generating invoice, please wait...");
            const invoiceRes = yield this.orderService.generateInvoice(this.orderData[0].id, { active: true, invoiceNo: customInvoiceNo });
            this.loading.dismiss();
    ...
    generateInvoice() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const invoiceData = yield this.adminSettingsService.getInvoiceData('getInvoiceData');
            console.log('invoiceData:', invoiceData);
            if (invoiceData && invoiceData.isCustomInvoiceNo) {
                let customInvoiceNo = yield this.showCustomAlert();
    ...
    typeSenseSearchQuery() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.searchOrder != '') {
                this.page = 1;
                yield this.sharedService.presentLoading();
                const typeSenseResponse = yield this.searchEngineService.getSearchOrdersFromTypeSenseUsingSingleSearch(this.searchOrder, this.page, 'new_search', []);
                ...
                if (typeSenseResponse && typeSenseResponse.status === 'available' && typeSenseResponse.orders.length) {
                    ...
                    yield this.sharedService.presentAlert("Search item not available!");
                    this.resetSearch();
                }
            }
            else {
    ...
    loadMoreUsersTypeSense(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.page += 1;
            const typeSenseResponse = yield this.searchEngineService.getSearchOrdersFromTypeSenseUsingSingleSearch(this.searchOrder, this.page, 'existing_search', this.ordersList);
            if (typeSenseResponse && typeSenseResponse.status === 'available' && typeSenseResponse.orders.length) {
                this.ordersList = typeSenseResponse.orders;
                this.onClickViewDetails(this.ordersList[0].orderId);
                this.showLoadMoreBtn = true;
    ...
    searchOrderById() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!isNaN(parseInt(this.searchOrder))) {
                this.ordersList = yield this.userService.returnOrderDetailsWithOrderId(parseInt(this.searchOrder));
    ...
    isStatusTimelinePresent(status) {
    ...
    addLabel() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.presentLoading();
            let updated = yield this.userService.updateOrderLabels(this.labels);
            yield this.loading.dismiss();
            if (updated) {
                yield this.presentAlert('Label Added Successfully!');
            }
        });
    }
    deleteLabel(index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.presentLoading();
            let deleted = yield this.userService.deleteLabels(this.labels);
            yield this.loading.dismiss();
            if (deleted) {
                yield this.presentAlert('Label Deleted Successfully!');
            }
        });
    }
    onChangeLabel(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.presentLoading();
            let assignLabel = yield this.userService.assignLabelToOrder(selectedLabel, this.orderData[0].id);
            yield this.loading.dismiss();
            if (assignLabel) {
                yield this.presentAlert('Label Assigned Successfully!');
            }
        });
    }
    removeLabel() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.presentLoading();
            let removeLabel = yield this.userService.removeLabel(this.orderData[0].id);
            yield delete this.orderData[0].label;
            yield this.loading.dismiss();
            if (removeLabel) {
                yield this.presentAlert('Label Removed Successfully!');
    ...
    addComment() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let commentAdded = yield this.userService.addComment(this.orderData[0].id, commentData);
            yield this.loading.dismiss();
            if (commentAdded) {
                yield this.presentAlert('Added Comment Successfully!');
            }
        });
    }
    showInvoiceModal() {
    ...
    generatePrintingInvoice() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.sharedService.presentLoading();
            const invoiceRes = yield this.orderService.generatePrintingInvoice(this.orderData[0].id);
            yield this.sharedService.loading.dismiss();
            console.log("invoiceRes", invoiceRes);
            if (invoiceRes && invoiceRes.status === 'generated') {
                yield this.sharedService.presentAlert("Printing Invoice generated successfully!");
                window.open(invoiceRes.url, '_blank');
            }
            else {
                yield this.sharedService.presentAlert("Invoice generation failed, please try again later.");
            }
        });
    }
    imgZoom(img) {
...
AdminOrdersPage.ctorParameters = () => [
...
//# sourceMappingURL=admin-admin-orders-admin-orders-module-es2015.js.map