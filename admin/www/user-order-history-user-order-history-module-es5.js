...
var UserOrderHistoryPageModule = /** @class */ (function () {
    function UserOrderHistoryPageModule() {
    }
    ...
    return UserOrderHistoryPageModule;
}());
...
var UserOrderHistoryPage = /** @class */ (function () {
    function UserOrderHistoryPage(events, router, storage, userService) {
        this.events = events;
        this.router = router;
    ...
    UserOrderHistoryPage.prototype.ngOnInit = function () {
    };
    UserOrderHistoryPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    UserOrderHistoryPage.prototype.ionViewWillLeave = function () {
        this.removeSubscription();
    };
    UserOrderHistoryPage.prototype.initializeSubscription = function () {
        var _this = this;
    ...
    UserOrderHistoryPage.prototype.onClickViewDetails = function (id) {
    ...
    UserOrderHistoryPage.prototype.goToChat = function (fromfab) {
        var _this = this;
    ...
    UserOrderHistoryPage.prototype.onClickTrackOrder = function (agentId, deliveryLatLng) {
        var navigationExtras = {
            state: {
                agentId: agentId,
    ...
    UserOrderHistoryPage.prototype.removeSubscription = function () {
    ...
    UserOrderHistoryPage.ctorParameters = function () { return [
...
//# sourceMappingURL=user-order-history-user-order-history-module-es5.js.map