...
let ProductReviewsPage = class ProductReviewsPage {
    constructor(productService, modalController, sharedService) {
    ...
    initializeSubscriptions() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let products = yield this.productService.getProductsWithRating();
            for (const product of products) {
                let ratings = yield this.productService.getRatings(product.id);
    ...
    //   await modal.present();
    // }
    approve(prodIndex, ratingIndex, i, j) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let approved = yield this.productService.updateRating(prodIndex, ratingIndex, { status: 'approved' });
            if (approved) {
