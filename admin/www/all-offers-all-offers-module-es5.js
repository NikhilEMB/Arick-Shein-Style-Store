...
var AllOffersPageModule = /** @class */ (function () {
    function AllOffersPageModule() {
    }
...
var AllOffersPage = /** @class */ (function () {
    function AllOffersPage(events) {
        this.events = events;
    ...
    AllOffersPage.prototype.ngOnInit = function () {
        this.initializeSubscriptions();
        this.events.publish('offer:getOffers');
    };
    AllOffersPage.prototype.ngOnDestroy = function () {
        this.removeSubscriptions();
    };
    AllOffersPage.prototype.initializeSubscriptions = function () {
        var _this = this;
    ...
    AllOffersPage.prototype.removeSubscriptions = function () {
        this.events.unsubscribe('offer:publishOffers');
    };
    AllOffersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=all-offers-all-offers-module-es5.js.map