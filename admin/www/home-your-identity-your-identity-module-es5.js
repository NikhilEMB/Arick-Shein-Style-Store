...
var YourIdentityPageModule = /** @class */ (function () {
    function YourIdentityPageModule() {
    }
...
var YourIdentityPage = /** @class */ (function () {
    function YourIdentityPage(router, events, alertController, userService, route) {
        var _this = this;
        this.router = router;
        this.events = events;
    ...
    YourIdentityPage.prototype.ngOnInit = function () {
    };
    YourIdentityPage.prototype.ionViewWillEnter = function () {
        this.initializeSubscriptions();
    };
    YourIdentityPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    YourIdentityPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('user:updateNameOfNewUserSuccess', function () {
            _this.showLoader = false;
            _this.router.navigate(['shop-categories']);
        });
    };
    YourIdentityPage.prototype.updateUserName = function () {
    ...
    YourIdentityPage.prototype.presentAlert = function (desc) {
    ...
    YourIdentityPage.prototype.removeSubscriptions = function () {
        this.events.unsubscribe('user:updateNameOfNewUserSuccess');
    };
    YourIdentityPage.ctorParameters = function () { return [
...
//# sourceMappingURL=home-your-identity-your-identity-module-es5.js.map