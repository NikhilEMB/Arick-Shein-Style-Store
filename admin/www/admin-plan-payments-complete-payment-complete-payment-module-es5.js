...
var CompletePaymentPage = /** @class */ (function () {
    function CompletePaymentPage(router) {
        this.router = router;
        this.inputAmount = 0;
    }
    CompletePaymentPage.prototype.ngOnInit = function () {
    };
    CompletePaymentPage.prototype.razorpayCheckout = function (e) {
        this.router.navigate(['/razorpay']);
        e.preventDefault();
    };
    CompletePaymentPage.prototype.gotoPrevious = function () {
        this.router.navigate(['/options']);
    };
    CompletePaymentPage.prototype.newAmount = function () {
        // this.inputAmount=this.firebaseService.amountSelected
    };
    CompletePaymentPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-plan-payments-complete-payment-complete-payment-module-es5.js.map