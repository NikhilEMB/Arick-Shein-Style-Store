...
var AllBrandsPageModule = /** @class */ (function () {
    function AllBrandsPageModule() {
    }
...
var AllBrandsPage = /** @class */ (function () {
    function AllBrandsPage(modalController, events, router, loadingController, alertController, brandsService, platform) {
    ...
    AllBrandsPage.prototype.onRenderBrands = function (event) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (start < end && end !== this.brands.length - 1) {
                            ...
                            firstDate = this.brands[end].sortedAt.toDate().getTime();
                            secondDate = this.brands[end + 1].sortedAt.toDate().getTime();
                        ...
                        // tslint:disable-next-line: one-line
                            ...
                            changedDate = this.brands[end].sortedAt.toDate().getTime() - 5 * 60000;
                            this.brandsService.updateBrandsPosition(id, new Date(changedDate));
                        }
                        // tslint:disable-next-line: one-line
                        ...
                        draggedItem = this.brands.splice(event.detail.from, 1)[0];
    ...
    AllBrandsPage.prototype.ionViewWillEnter = function () {
        this.devHeight = this.platform.height();
        this.events.publish('brands:getAllBrandsForAdmin');
        this.initializeSubscriptions();
    };
    AllBrandsPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
        this.showSearch = false;
    };
    AllBrandsPage.prototype.ngOnInit = function () { };
    AllBrandsPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        ...
        this.events.subscribe('brands:updateBrandsPostionSucess', function () {
            if (_this.loading) {
        ...
        this.events.subscribe('brands:deleteBrandSuccess', function () {
            ...
            _this.presentAlert('Brand deleted successfully!');
        });
    };
    AllBrandsPage.prototype.editBrand = function (brand) {
    ...
    AllBrandsPage.prototype.goToAddNew = function (page) {
        this.router.navigate([page]);
    };
    AllBrandsPage.prototype.deleteBrandConfirm = function (bid, index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    AllBrandsPage.prototype.deleteBrand = function (bid, index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    AllBrandsPage.prototype.clearsearchBrand = function () {
        this.searchBrand = null;
    };
    AllBrandsPage.prototype.presentAlert = function (desc) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    AllBrandsPage.prototype.presentLoading = function (msg, drn) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    AllBrandsPage.prototype.removeSubscriptions = function () {
    ...
    AllBrandsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-admin-brands-all-brands-all-brands-module-es5.js.map