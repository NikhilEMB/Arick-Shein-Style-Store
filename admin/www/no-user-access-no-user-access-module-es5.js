...
var NoUserAccessPageModule = /** @class */ (function () {
    function NoUserAccessPageModule() {
    }
...
var NoUserAccessPage = /** @class */ (function () {
    function NoUserAccessPage(events) {
        this.events = events;
    }
    NoUserAccessPage.prototype.ngOnInit = function () {
    };
    NoUserAccessPage.prototype.logout = function () {
        this.events.publish('auth:logout');
    };
    NoUserAccessPage.ctorParameters = function () { return [
...
//# sourceMappingURL=no-user-access-no-user-access-module-es5.js.map