...
var NewAddressPage = /** @class */ (function () {
    function NewAddressPage(events, router, alertController, loadingController, route, userService, androidPermissions, geolocation, locationAccuracy, platform, modalController) {
        var _this = this;
        this.events = events;
        this.router = router;
        ...
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.editAddressData = _this.router.getCurrentNavigation().extras.state.addressData;
                _this.addressLength = _this.router.getCurrentNavigation().extras.state.addressLength;
                _this.routeFromCheckoutPage = _this.router.getCurrentNavigation().extras.state.routeFromCheckoutPage;
                _this.routeFromSelectAddress = _this.router.getCurrentNavigation().extras.state.routeFromSelectAddress;
                _this.addressType = _this.router.getCurrentNavigation().extras.state.type;
    ...
    NewAddressPage.prototype.ionViewWillLeave = function () {
    ...
    NewAddressPage.prototype.initializeSubscriptions = function () {
        ...
        this.events.subscribe('user:newAddressSaved', function () {
            ...
            if (_this.routeFromCheckoutPage === true || _this.routeFromSelectAddress === true) {
                ...
                _this.presentAlert('Address saved successfully', true);
            }
        });
        this.events.subscribe('user:addressEditSuccess', function () {
            ...
            if (_this.routeFromSelectAddress === true) {
                ...
                _this.presentAlert('Address edited successfully', true);
            }
        });
        this.events.subscribe('user:errorInGettingAddress', function () {
            _this.loading.dismiss();
            _this.presentAlert('Error in getting address!');
        });
    ...
    NewAddressPage.prototype.useCurrentLocation = function () {
    ...
    NewAddressPage.prototype.checkGPSPermission = function () {
        var _this = this;
    ...
    NewAddressPage.prototype.requestGPSPermission = function () {
        var _this = this;
    ...
    NewAddressPage.prototype.askToTurnOnGPS = function () {
        var _this = this;
        this.locationAccuracy.request(this.locationAccuracy.REQUEST_PRIORITY_HIGH_ACCURACY).then(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
    ...
    NewAddressPage.prototype.getLocationCoordinates = function () {
    ...
    NewAddressPage.prototype.getAddressFromCoords = function (latitude, longitude) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 8];
                    case 5:
                        if (!(this.addressObj.phoneNo === '')) return [3 /*break*/, 6];
                        this.presentAlert('Please enter phoneNo');
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this.presentLoading()];
                    case 7:
                        _a.sent();
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 8];
                    case 5:
                        if (!(this.editAddressData.phoneNo === '')) return [3 /*break*/, 6];
                        this.presentAlert('Please enter phoneNo');
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this.presentLoading()];
                    case 7:
    ...
    NewAddressPage.ctorParameters = function () { return [
