...
var UserGroupsPage = /** @class */ (function () {
    function UserGroupsPage(modalController, userGroupsService, sharedService, alertController) {
    ...
    UserGroupsPage.prototype.ngOnInit = function () { };
    UserGroupsPage.prototype.ionViewWillEnter = function () {
    ...
    UserGroupsPage.prototype.getAllGroups = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var groupsWithId;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    UserGroupsPage.prototype.openCreateGroupModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    UserGroupsPage.prototype.openUsersModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    UserGroupsPage.prototype.getGroupManagers = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var managers;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userGroupsService.getGroupManagers(this.selectedGroup.id)];
                    case 1:
                        managers = _a.sent();
    ...
    UserGroupsPage.prototype.getGroupUsers = function (groupIndex) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var users;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.userGroupsService.getGroupUsers(this.selectedGroup.id)];
                    case 1:
                        users = _a.sent();
    ...
    UserGroupsPage.prototype.askConfirmDelete = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    UserGroupsPage.prototype.deleteGroup = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var success, deletedGrpName;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.sharedService.presentLoading();
                        return [4 /*yield*/, this.userGroupsService.deleteGroup({ groupId: this.selectedGroup.id, users: this.users, managers: this.managers })];
                    case 1:
                        success = _a.sent();
                        if (success) {
                            ...
                            deletedGrpName = this.selectedGroup.name;
    ...
    UserGroupsPage.prototype.removeUser = function (index, userId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.users.splice(index, 1);
                        return [4 /*yield*/, this.userGroupsService.removeUserFromGroup({ userId: userId, groupId: this.selectedGroup.id })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    UserGroupsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-user-groups-user-groups-module-es5.js.map