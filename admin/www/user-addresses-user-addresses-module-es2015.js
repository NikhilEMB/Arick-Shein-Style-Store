...
let UserAddressesPageModule = class UserAddressesPageModule {
};
...
let UserAddressesPage = class UserAddressesPage {
    constructor(events, router, alertController, loadingController, storage, userService) {
        this.events = events;
        this.router = router;
...
UserAddressesPage.ctorParameters = () => [
...
//# sourceMappingURL=user-addresses-user-addresses-module-es2015.js.map