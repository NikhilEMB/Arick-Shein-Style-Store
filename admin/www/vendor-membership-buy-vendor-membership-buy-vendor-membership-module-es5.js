...
var BuyVendorMembershipPageModule = /** @class */ (function () {
    function BuyVendorMembershipPageModule() {
    }
    ...
    return BuyVendorMembershipPageModule;
}());
...
var BuyVendorMembershipPage = /** @class */ (function () {
    function BuyVendorMembershipPage(configService, alertController, sharedService, vendorService, storage) {
    ...
    BuyVendorMembershipPage.prototype.ngOnInit = function () {
        this.currencyCode = this.configService.environment.currencyCode;
    };
    BuyVendorMembershipPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, vendor, response;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this.sharedService.presentAlert('Something went wrong ! please try again.')];
                    case 7:
                        _b.sent();
                        _b.label = 8;
    ...
    BuyVendorMembershipPage.prototype.getMonths = function (months) {
        return months === 1 ? '1 Month' : months + " Months";
    };
    BuyVendorMembershipPage.prototype.getDiscount = function (price, disPrice) {
        return parseInt((((price - disPrice) / price) * 100).toFixed(0));
    };
    BuyVendorMembershipPage.prototype.totalDaysLeft = function () {
        var today = moment__WEBPACK_IMPORTED_MODULE_3__().format('YYYY-MM-DD');
    ...
    BuyVendorMembershipPage.prototype.buyPlan = function (index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var selectedPlan, settings, orderObject, membership, response;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        selectedPlan = this.membershipSettings.plans[index];
                        settings = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.membershipSettings);
                        ...
                        return [4 /*yield*/, this.vendorService.updateVendorInfo(this.userId, { membership: membership })];
                    case 2:
                        response = _a.sent();
                        return [4 /*yield*/, this.sharedService.loading.dismiss()];
                    case 3:
                        ...
                        return [4 /*yield*/, this.sharedService.presentAlert('Membership Purchased Successfully')];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.sharedService.presentAlert("Membership Purchase Failed")];
                    case 6:
                        _a.sent();
                        _a.label = 7;
    ...
    BuyVendorMembershipPage.ctorParameters = function () { return [
    ...
    return BuyVendorMembershipPage;
}());
...
//# sourceMappingURL=vendor-membership-buy-vendor-membership-buy-vendor-membership-module-es5.js.map