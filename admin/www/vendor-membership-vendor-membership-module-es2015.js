...
let VendorMembershipPageModule = class VendorMembershipPageModule {
};
...
let VendorMembershipPage = class VendorMembershipPage {
    constructor(configService, alertController, sharedService, vendorService) {
                ...
                buttons: [
                    {
                        ...
                        text: 'Add',
                        handler: (plan) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                            if (!plan.name || !parseInt(plan.months) || !parseInt(plan.price) || !parseInt(plan.discountedPrice)) {
                                yield this.sharedService.presentAlert('Please fill all the details');
                                return false;
                            }
                            else if (parseInt(plan.discountedPrice) > parseInt(plan.price)) {
                                yield this.sharedService.presentAlert('Discounted price greater');
                                return false;
                            }
                            else {
    ...
    saveSettings() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (!this.membershipSettings.name) {
                yield this.sharedService.loading.dismiss();
                yield this.sharedService.presentAlert('Please enter a name');
            }
            else {
                let response = yield this.vendorService.saveVendorMembership(this.membershipSettings);
                yield this.sharedService.loading.dismiss();
                if (response) {
                    yield this.sharedService.presentAlert('Successfully Saved');
                }
                else {
                    yield this.sharedService.presentAlert("Save failed");
                }
            }
        });
    }
};
VendorMembershipPage.ctorParameters = () => [
...
//# sourceMappingURL=vendor-membership-vendor-membership-module-es2015.js.map