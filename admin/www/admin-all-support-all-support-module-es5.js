...
var AllSupportPageModule = /** @class */ (function () {
    function AllSupportPageModule() {
    }
...
var AllSupportPage = /** @class */ (function () {
    function AllSupportPage(modalController, supportService) {
    ...
    AllSupportPage.prototype.ngOnInit = function () {
        this.supportList = [
            'Pending', 'In Progress', 'Resolved', 'Rejected'
        ];
    };
    AllSupportPage.prototype.ionViewWillEnter = function () {
        this.getAllIssue();
        this.getAllQueries();
        this.getAllRequirements();
    };
    AllSupportPage.prototype.onClickStatustItem = function (index, status) {
        this.activeProjectIndex = index;
        console.log(status);
        this.activeButton = status;
    };
    AllSupportPage.prototype.getAllIssue = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.supportService.getSupportTypeData('issues')];
                    case 1:
                        _a.issues = _b.sent();
    ...
    AllSupportPage.prototype.getAllQueries = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.supportService.getSupportTypeData('queries')];
                    case 1:
                        _a.queries = _b.sent();
    ...
    AllSupportPage.prototype.getAllRequirements = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.supportService.getSupportTypeData('requirements')];
                    case 1:
                        _a.requirements = _b.sent();
    ...
    AllSupportPage.prototype.createNewIssue = function (type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (res) {
                            ...
                            if (_this.currentTabIndex == 0) {
                                _this.getAllIssue();
                            }
                            else if (_this.currentTabIndex == 1) {
                                _this.getAllQueries();
                            }
                            else if (_this.currentTabIndex == 2) {
                                _this.getAllRequirements();
                            }
                        });
    ...
    AllSupportPage.prototype.viewDetails = function (i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal, modal, modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.currentTabIndex == 0)) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 9];
                    case 3:
                        if (!(this.currentTabIndex == 1)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.modalController.create({
                                component: _view_issues_modal_view_issues_modal_page__WEBPACK_IMPORTED_MODULE_5__["ViewIssuesModalPage"],
                                // cssClass: 'my-custom-class',
                                cssClass: 'custom-modal',
                    ...
                    case 5:
                        ...
                        return [3 /*break*/, 9];
                    case 6:
                        if (!(this.currentTabIndex == 2)) return [3 /*break*/, 9];
                        return [4 /*yield*/, this.modalController.create({
                                component: _view_issues_modal_view_issues_modal_page__WEBPACK_IMPORTED_MODULE_5__["ViewIssuesModalPage"],
                                // cssClass: 'my-custom-class',
                                cssClass: 'custom-modal',
    ...
    AllSupportPage.prototype.onTabSelect = function (ev) {
        this.currentTabIndex = ev.detail.index;
        console.log('this---', this.currentTabIndex);
    };
    AllSupportPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-all-support-all-support-module-es5.js.map