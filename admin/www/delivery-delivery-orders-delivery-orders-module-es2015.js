...
let DeliveryOrdersPageModule = class DeliveryOrdersPageModule {
};
...
let DeliveryOrdersPage = class DeliveryOrdersPage {
    constructor(storage, events, router, loadingController, alertController) {
    ...
    onClickStartNavigation(orderId, deliveryAddress) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.presentLoading();
            this.events.publish('delivery:startDelivery', orderId, deliveryAddress);
        });
    }
    onClickContinueNavigation(orderId, deliveryLatLng) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const navigationextras = {
                state: {
...
DeliveryOrdersPage.ctorParameters = () => [
...
//# sourceMappingURL=delivery-delivery-orders-delivery-orders-module-es2015.js.map