...
var UserOrderDetailsPageModule = /** @class */ (function () {
    function UserOrderDetailsPageModule() {
    }
    ...
    return UserOrderDetailsPageModule;
}());
...
var UserOrderDetailsPage = /** @class */ (function () {
    function UserOrderDetailsPage(events, router, alertController, loadingController, navCtrl, route, storage, userService, inAppBrowser) {
        var _this = this;
        this.events = events;
        this.router = router;
    ...
    UserOrderDetailsPage.prototype.ngOnInit = function () {
    };
    UserOrderDetailsPage.prototype.ionViewWillEnter = function () {
        var _this = this;
    ...
    UserOrderDetailsPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    UserOrderDetailsPage.prototype.initializeSubscriptions = function () {
        var _this = this;
    ...
    UserOrderDetailsPage.prototype.cancelOrder = function () {
    ...
    UserOrderDetailsPage.prototype.getTotalItems = function () {
        return this.orderData[0].products.length;
    };
    UserOrderDetailsPage.prototype.scrollToBottom = function () {
        this.content.scrollToBottom(500);
    };
    UserOrderDetailsPage.prototype.goToPrdouctDetails = function (id) {
    ...
    UserOrderDetailsPage.prototype.onClickCancelOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
    ...
    UserOrderDetailsPage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    UserOrderDetailsPage.prototype.goToChat = function (fromfab) {
        var _this = this;
    ...
    UserOrderDetailsPage.prototype.onClickDoPayment = function () {
        var navigationExtras = {
            state: {
    ...
    UserOrderDetailsPage.prototype.onClickTrackOrder = function (agentId, deliveryLatLng) {
        var navigationExtras = {
            state: {
                agentId: agentId,
    ...
    UserOrderDetailsPage.prototype.openOrderInvoice = function (url) {
        var browser = this.inAppBrowser.create(url, '_system');
    };
    UserOrderDetailsPage.prototype.removeSubscriptions = function () {
        this.events.unsubscribe('user:publishOrderDetailsWithOrderId');
        this.events.unsubscribe('user:cancelledOrderByUserSuccessfully');
    };
    UserOrderDetailsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=user-order-details-user-order-details-module-es5.js.map