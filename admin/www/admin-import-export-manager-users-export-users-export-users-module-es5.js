...
var ExportUsersPageModule = /** @class */ (function () {
    function ExportUsersPageModule() {
    }
...
var ExportUsersPage = /** @class */ (function () {
    function ExportUsersPage(importExportManagerService, toastController, loadingController) {
    ...
    ExportUsersPage.prototype.ngOnInit = function () {
    ...
    ExportUsersPage.prototype.presentLoading = function (msg, duration) {
    ...
    ExportUsersPage.prototype.presentToastWithOptions = function (header, message, errorCode) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
    ...
    ExportUsersPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        _a = this;
                        return [4 /*yield*/, this.importExportManagerService.getUserByRole(this.currentSelection)];
                    case 2:
    ...
    ExportUsersPage.prototype.setUserStatus = function (selection) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    ExportUsersPage.prototype.saveDisable = function () {
    ...
    ExportUsersPage.prototype.exportUsersHandler = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var exportData, count, erroneousUsers, _i, _a, user, csvExporter, error_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 9, , 11]);
                        if (!(this.totalUsers && this.totalUsers.length)) return [3 /*break*/, 6];
                        exportData = [], count = 0, erroneousUsers = [];
                        for (_i = 0, _a = this.totalUsers; _i < _a.length; _i++) {
                            user = _a[_i];
                        ...
                        if (!(count !== (this.totalUsers.length))) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.presentToastWithOptions('Warning In Export', "Found " + ((this.totalUsers.length) - count) + " User(s) with details mismatch!", 'ERR-103')];
                    case 1:
                        _b.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.presentToastWithOptions('Export Success!', count + " user(s) found for current selection!", 'LOG-200')];
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4:
                        csvExporter = new export_to_csv__WEBPACK_IMPORTED_MODULE_3__["ExportToCsv"](this.options);
                        csvExporter.generateCsv(exportData);
                        return [4 /*yield*/, this.loading.dismiss()];
                    case 5:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this.presentToastWithOptions('User(s) Not Found!', "No user(s) found for current selection!", 'ERR-101')];
                    case 7:
                        _b.sent();
                        this.reset();
                        _b.label = 8;
                    ...
                    case 9:
                        error_1 = _b.sent();
                        console.log('Error in exportUsersHandler : ', error_1);
                        return [4 /*yield*/, this.presentToastWithOptions('Something Went Wrong', "User Export Error!, Pls try again later.", 'ERR-100')];
                    case 10:
                        _b.sent();
                        this.reset();
                        return [3 /*break*/, 11];
    ...
    ExportUsersPage.prototype.reset = function () {
        this.totalUsers = [];
    };
    ExportUsersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-import-export-manager-users-export-users-export-users-module-es5.js.map