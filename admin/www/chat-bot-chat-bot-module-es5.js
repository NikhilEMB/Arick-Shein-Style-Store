...
var ChatBotPage = /** @class */ (function () {
    function ChatBotPage(events, userService, actionSheetController, camera, imagePicker, loadingController, router, modalController, ngZone, alertController, platform, chatService, toastController, keyboard, route, storage) {
        var _this = this;
        this.events = events;
    ...
    ChatBotPage.prototype.ngOnInit = function () {
        ...
        this.storage.get('uid').then(function (val) {
            ...
            _this.events.publish('user:getUserDetails', _this.uid);
        });
    ...
    ChatBotPage.prototype.imageActionSheet = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.userMsgTxt === '')) return [3 /*break*/, 3];
                        this.enableScroll = false;
    ...
    ChatBotPage.prototype.addCameraImage = function () {
        var _this = this;
    ...
    ChatBotPage.prototype.addGalleryImages = function () {
        var _this = this;
    ...
    ChatBotPage.prototype.callAdmin = function () {
    ...
    ChatBotPage.prototype.onClickTrackOrder = function (agentId, deliveryLatLng) {
        var navigationExtras = {
            state: {
                agentId: agentId,
    ...
    ChatBotPage.ctorParameters = function () { return [
...
//# sourceMappingURL=chat-bot-chat-bot-module-es5.js.map