...
let CreateOrderPageModule = class CreateOrderPageModule {
};
...
let CreateOrderPage = class CreateOrderPage {
    // isInventoryManaged = false;
    constructor(events, modalController, toastController, configService, loadingController, router, productSubscriptionsService, alertController, sharedService, userService, storage, searchEngineService) {
        this.events = events;
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.orderBy.role = yield this.storage.get('userRole');
            this.orderBy.id = yield this.storage.get('uid');
            this.orderBy.name = yield this.storage.get('userName');
    ...
    filterProductsByVendor(productList) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    initializeSubscriptions() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.events.subscribe('search-engine:publishProductsToCreateOrder', (productList) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                console.log('productList:', productList);
                // let fetchedProducts = productList;
                let fetchedProducts = yield this.filterProductsByVendor(productList);
                ...
                fetchedProducts.forEach((product) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    product = yield this.prepareProductData(product);
                }));
                this.productList = fetchedProducts;
            }));
            this.events.subscribe('user:publishUserDetails', (userData) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                ...
                if (userData.defaultAddress && userData.defaultAddress.defaultAddress) {
                    ...
                    const address = yield this.userService.getAllUserAddresses(this.selectedUser.id);
                    if (address && address.length) {
                        ...
                        yield this.userService.saveToDefaultAddress(this.selectedUser.id, this.userAddress);
                        this.statusIndex = 3;
                        this.userAddressExists = true;
    ...
    saveAddress() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.userAddress.address && this.userAddress.city && this.userAddress.state && this.userAddress.pincode) {
                ...
                const userDetails = yield this.userService.updateUserInfo(this.selectedUser.id, { customerGstNo: this.customerGstNo });
            }
            else {
    ...
    presentProductVariantModal(product, index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const modal = yield this.modalController.create({
    ...
    subscribeProduct(productData) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let subsData = yield this.productSubscriptionsService.getSettings('return');
            const productObj = {
                id: productData.id,
                data: productData,
            };
    ...
    checkLimitedTimeDeal(data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (data.hasOwnProperty('deal') && data.deal.isAllowed) {
                ...
                const currentTime = moment__WEBPACK_IMPORTED_MODULE_10__();
                const startDate = moment__WEBPACK_IMPORTED_MODULE_10__(data.deal.start.date).format('YYYY-MM-DD');
                const startTime = moment__WEBPACK_IMPORTED_MODULE_10__(data.deal.start.time).format('HH:mm');
                const endDate = moment__WEBPACK_IMPORTED_MODULE_10__(data.deal.end.date).format('YYYY-MM-DD');
                const endTime = moment__WEBPACK_IMPORTED_MODULE_10__(data.deal.end.time).format('HH:mm');
                const startDateTime = moment__WEBPACK_IMPORTED_MODULE_10__(`${startDate} ${startTime}`);
                const endDateTime = moment__WEBPACK_IMPORTED_MODULE_10__(`${endDate} ${endTime}`);
                if (moment__WEBPACK_IMPORTED_MODULE_10__(currentTime).isBetween(startDateTime, endDateTime)) {
                    //console.log('in between');
                    const diff = moment__WEBPACK_IMPORTED_MODULE_10__(endDateTime, 'YYYY-MM-DD HH:mm:ss').diff(moment__WEBPACK_IMPORTED_MODULE_10__(currentTime, 'DD/MM/YYYY HH:mm:ss'));
                    const duration = moment__WEBPACK_IMPORTED_MODULE_10__["duration"](diff);
                    // console.log('duration', duration);
                    // console.log('moment.utc(diff).format(":mm:ss")', moment.utc(diff).format(":mm:ss"));
                    const dealTime = Math.floor(duration.asHours()) + moment__WEBPACK_IMPORTED_MODULE_10__["utc"](diff).format(":mm:ss");
    ...
    typeSenseSearchQuery() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.searchValue != '') {
                ...
                let page = 1;
                const typeSenseResponse = yield this.searchEngineService.getSearchUsersFromTypesenseUsingSingleSearch(this.searchValue, page, 'new_search', []);
    ...
    applyCouponCode() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.presentLoading('verifying coupon code');
            const data = {
...
CreateOrderPage.ctorParameters = () => [
...
//# sourceMappingURL=admin-admin-orders-create-order-create-order-module-es2015.js.map