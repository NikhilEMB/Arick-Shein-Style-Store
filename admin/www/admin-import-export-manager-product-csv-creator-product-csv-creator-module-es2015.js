...
let ProductCsvCreatorPageModule = class ProductCsvCreatorPageModule {
};
...
let ProductCsvCreatorPage = class ProductCsvCreatorPage {
    constructor(router, route, sharedService, importExportManagerService, productService, brandService) {
        this.router = router;
        this.route = route;
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.route.queryParams.subscribe((param) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                ...
                if (param) {
                    ...
                    if (this.currentType === 'export products') {
                        ...
                        this.allCategories = yield this.productService.getAllCategoriesForSideMenu();
                        ...
                        this.allBrands = yield this.brandService.getAllBrandsForSideMenu();
                        this.allVendors = yield this.importExportManagerService.getAllVendors();
                        this.allProducts = yield this.importExportManagerService.getAllProducts();
                        ...
                        yield this.importProductsHandler();
                    }
                }
            }));
        });
    ...
    productObjSetter(selectedFields, product, fields, categoryList, brandList, vendorPhoneNo) {
        let csvObj = {};
    ...
    exportProductsHandler() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let products = [];
            let csvProductIds = [];
            this.allProducts.forEach((item) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                let product = item;
                ...
                if (filter.length) {
                    for (const sub of filter) {
                        if (((categoryList.some(cat => cat === sub.value)) || (brandList.some(brand => brand === sub.value))) && (!csvProductIds.includes(product.id))) {
                            let csvObject = this.productObjSetter(this.selectedFields, product, fields, categoryList, brandList, vendorPhoneNo);
    ...
    handleSelections(type, field, index, mainField) {
...
ProductCsvCreatorPage.ctorParameters = () => [
...
//# sourceMappingURL=admin-import-export-manager-product-csv-creator-product-csv-creator-module-es2015.js.map