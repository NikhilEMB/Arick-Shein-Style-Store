...
let IntegrationsPageModule = class IntegrationsPageModule {
};
...
let IntegrationsPage = class IntegrationsPage {
    constructor(sharedService, modalController, integrationService) {
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            // temp fix
            const choiceDetailsDelivery = yield this.integrationService.getChoiceSettings('delivery');
            const choiceDetailsEmail = yield this.integrationService.getChoiceSettings('email');
            const choiceDetailsSMS = yield this.integrationService.getChoiceSettings('sms');
            const choiceDetailsWhatsapp_promotion = yield this.integrationService.getChoiceSettings('whatsapp_promotion');
            const choiceDetailsWhatsapp_order_notification = yield this.integrationService.getChoiceSettings('whatsapp_order_notification');
            const choiceDetailsCRM = yield this.integrationService.getChoiceSettings('crm');
    ...
    saveChoiceSettings(sidemenuChoice) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let settings;
            ...
            const success = yield this.integrationService.saveChoiceSettings(sidemenuChoice, settings);
            if (success) {
    ...
    openSettings(sidemenuChoice, integrationChoice) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
...
IntegrationsPage.ctorParameters = () => [
...
//# sourceMappingURL=integrations-integrations-module-es2015.js.map