...
let ContactSettingsPageModule = class ContactSettingsPageModule {
};
...
let ContactSettingsPage = class ContactSettingsPage {
    constructor(sharedService, contactUsService, modalController) {
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let queries = yield this.contactUsService.getAllQueries();
            if (queries) {
                this.queries = queries || this.queries;
            }
            console.log('queries:', queries);
            let details = yield this.contactUsService.getContactPgDetails();
            if (details) {
    ...
    saveDetails() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (valid) {
                let saved = yield this.contactUsService.saveContactPgDetails({
...
ContactSettingsPage.ctorParameters = () => [
...
//# sourceMappingURL=contact-settings-contact-settings-module-es2015.js.map