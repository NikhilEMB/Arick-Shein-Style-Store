...
let EditImageBlockPageModule = class EditImageBlockPageModule {
};
...
let EditImageBlockPage = class EditImageBlockPage {
    constructor(sharedService, events, activatedRoute, modalController, angularFirestore, router, _location) {
    ...
    initializeSubscriptions() {
        ...
        this.events.subscribe('widgets:updateVideoBlockSuccess', () => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.sharedService.loading) {
                this.sharedService.loading.dismiss();
            }
            //this.widgetID = id;
    ...
    getSections() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.pageId) {
                ...
                res = yield this.angularFirestore.collection('pages').doc(this.pageId).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["first"])()).toPromise();
            }
            if (this.productId && this.pageId == '') {
                console.log("productId", this.productId);
                res = yield this.angularFirestore.collection('products').doc(this.productId).collection('sections').doc('productWidgets').valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["first"])()).toPromise();
            }
...
EditImageBlockPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-widgets-image-block-edit-image-block-edit-image-block-module-es2015.js.map