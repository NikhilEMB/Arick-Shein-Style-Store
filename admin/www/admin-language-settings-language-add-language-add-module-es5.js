...
var LanguageAddPageModule = /** @class */ (function () {
    function LanguageAddPageModule() {
    }
...
var LanguageAddPage = /** @class */ (function () {
    function LanguageAddPage(events, labelService, alertController, loadingController, router) {
        this.events = events;
    ...
    LanguageAddPage.prototype.ngOnInit = function () {
    ...
    LanguageAddPage.prototype.ionViewWillEnter = function () {
    ...
    LanguageAddPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    LanguageAddPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('language:publishAvailableLanguages', function (languages) {
            _this.languages = languages;
            _this.showLoader = false;
        });
        this.events.subscribe('language:addLanguagesSuccess', function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.presentAlert(this.ADD_LANGUAGES_LABELS['languages_saved_success_msg'])];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    LanguageAddPage.prototype.presentLoading = function (duration, msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    LanguageAddPage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    LanguageAddPage.prototype.toggleLangAdd = function (i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.languages[i].isAdded = !this.languages[i].isAdded;
                        return [4 /*yield*/, this.presentLoading(10000, this.SHARED_LABELS['please_wait'])];
                    case 1:
                        _a.sent();
    ...
    LanguageAddPage.prototype.onClickSave = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading(5000, this.SHARED_LABELS['please_wait'])];
                    case 1:
                        _a.sent();
                        this.events.publish('language:addLanguages', this.languages);
                        return [2 /*return*/];
...
//# sourceMappingURL=admin-language-settings-language-add-language-add-module-es5.js.map