...
let AddSubSubcategoriesPageModule = class AddSubSubcategoriesPageModule {
};
...
let AddSubSubcategoriesPage = class AddSubSubcategoriesPage {
    constructor(router, events, loadingController, alertController, camera, actionSheetController, route, modalController, productService, brandService, categoryService) {
        this.router = router;
        this.events = events;
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.subcategoryData) {
                ...
                const productData = yield this.categoryService.getProductsForSubOfSubCategory(this.subcategoryData.id);
                if (productData) {
    ...
    addSubOfSubCategory() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.categoryValue === '') {
                ...
                let res = yield this.categoryService.addSubOfSubCategory(subcategory, this.imageResponse, this.categoryId, this.banner, this.subCatId);
                this.loading.dismiss();
                if (res) {
    ...
    updateEditSubcategoryStatus(status) {
        if (status === true) {
            this.categoryStatus = false;
        }
        else {
    ...
    editSubOfSubCategory() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!this.subcategoryData.name) {
                ...
                let updateRes = yield this.categoryService.editSubOfSubCategory(subcategory, this.imageResponse, this.banner, this.categoryId, this.subCatId, this.subcategoryData.id);
                this.loading.dismiss();
                if (updateRes) {
...
AddSubSubcategoriesPage.ctorParameters = () => [
...
//# sourceMappingURL=admin-add-sub-subcategories-add-sub-subcategories-module-es2015.js.map