...
let AddBrandPage = class AddBrandPage {
    constructor(router, events, loadingController, alertController, camera, actionSheetController, route, modalController, labelService, logglyService, configService, sharedService) {
        this.router = router;
        this.events = events;
        ...
        this.route.queryParams.subscribe(params => {
            if (this.router.getCurrentNavigation().extras.state) {
                ...
                if (this.brandData) {
                    ...
                    this.image = this.brandData.image.hasOwnProperty('url') ? [Object.assign({}, this.brandData.image)] : [];
                    this.banner = this.brandData.banner.hasOwnProperty('url') ? [Object.assign({}, this.brandData.banner)] : [];
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!this.name) {
                ...
                if (this.isUniversal && this.brandId) {
                    ...
                    const sameSlugExists = yield this.sharedService.sameSlugExists('brands', this.brandId, slugName);
                    if (sameSlugExists) {
                ...
                yield this.presentLoading('Saving brand details...', 10000);
...
//# sourceMappingURL=admin-admin-brands-add-brand-add-brand-module-es2015.js.map