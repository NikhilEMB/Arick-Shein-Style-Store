...
var ImageBlockListPageModule = /** @class */ (function () {
    function ImageBlockListPageModule() {
    }
    ...
    return ImageBlockListPageModule;
}());
...
var ImageBlockListPage = /** @class */ (function () {
    function ImageBlockListPage(events, sharedService, alertController, router) {
        this.events = events;
    ...
    ImageBlockListPage.prototype.ngOnInit = function () {
    };
    ImageBlockListPage.prototype.ionViewWillEnter = function () {
        this.initializeSubscriptions();
    };
    ImageBlockListPage.prototype.ionViewWillLeave = function () {
    };
    ImageBlockListPage.prototype.removeSubscriptions = function () {
    ...
    ImageBlockListPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        ...
        this.events.subscribe('widgets:deleteWidgetSuccess', function () {
            ...
            _this.sharedService.presentAlert('Deleted');
        });
    ...
    ImageBlockListPage.prototype.addNewImageBlock = function () {
        this.router.navigate(['edit-image-block']);
    };
    ImageBlockListPage.prototype.editWidget = function (ID) {
    ...
    ImageBlockListPage.prototype.deleteWidgetConfirm = function (id) {
    ...
    ImageBlockListPage.prototype.deleteWidget = function (ID) {
        this.events.publish('widgets:deleteWidget', ID);
        //this.seletedIndex = index ;
        this.sharedService.presentLoading();
    };
    ImageBlockListPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-widgets-image-block-image-block-list-image-block-list-module-es5.js.map