...
var ArchivedOrdersPageModule = /** @class */ (function () {
    function ArchivedOrdersPageModule() {
    }
    ...
    return ArchivedOrdersPageModule;
}());
...
var ArchivedOrdersPage = /** @class */ (function () {
    function ArchivedOrdersPage(events, loadingController, 
    ...
    ArchivedOrdersPage.prototype.ngOnInit = function () {
    };
    ArchivedOrdersPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.orderService.getArchiveOrders()];
                    case 1:
                        _a.pendingOrders = _b.sent();
    ...
    ArchivedOrdersPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    ArchivedOrdersPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('order:removeOrderArchiveSuccess', function () {
            _this.sharedService.presentAlert('Order has been removed from archive!');
        });
        this.events.subscribe('order:removeOrderArchiveFailure', function () {
            _this.sharedService.presentAlert('Please try again later.');
        });
    };
    ArchivedOrdersPage.prototype.removeSubscriptions = function () {
        this.events.unsubscribe('order:removeOrderArchiveSuccess');
        this.events.unsubscribe('order:removeOrderArchiveFailure');
    };
    ArchivedOrdersPage.prototype.clearSearchOrder = function () {
        this.searchOrder = null;
    };
    ArchivedOrdersPage.prototype.getDateTimeFormat = function (date) {
        return moment__WEBPACK_IMPORTED_MODULE_3__(date).format('MMM D, YYYY hh:mm a');
    };
    ArchivedOrdersPage.prototype.remove = function (orderId, order, index) {
        var obj = {
            subStatus: {
                isArchive: false
            }
    ...
    ArchivedOrdersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-archived-orders-archived-orders-module-es5.js.map