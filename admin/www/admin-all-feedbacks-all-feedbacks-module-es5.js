...
var AllFeedbacksPageModule = /** @class */ (function () {
    function AllFeedbacksPageModule() {
    }
...
var AllFeedbacksPage = /** @class */ (function () {
    function AllFeedbacksPage(events, modalController) {
        this.events = events;
        this.modalController = modalController;
        this.feedbacks = [];
        this.showLoader = true;
    }
    AllFeedbacksPage.prototype.ngOnInit = function () {
        this.initializeSubscriptions();
        this.events.publish('feedback:getFeedbacks');
    };
    AllFeedbacksPage.prototype.ngOnDestroy = function () {
        this.removeSubscriptions();
    };
    AllFeedbacksPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('feedback:publishFeedbacks', function (feedbacks) {
            _this.showLoader = false;
            _this.feedbacks = feedbacks;
        });
    };
    AllFeedbacksPage.prototype.viewDetails = function (feed) {
    ...
    AllFeedbacksPage.prototype.removeSubscriptions = function () {
        this.events.unsubscribe('feedback:publishFeedbacks');
    };
    AllFeedbacksPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-all-feedbacks-all-feedbacks-module-es5.js.map