...
let AdminSettingsPage = class AdminSettingsPage {
    constructor(events, loadingController, alertController, actionSheetController, camera, modalController, configService, settingService) {
        this.events = events;
    ...
    initializeSubscriptions() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const notificationSettingsData = yield this.settingService.getNotificationData();
    ...
    removeLimit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let removeResult = yield this.settingService.removeTimeLimit();
            if (removeResult) {
...
//# sourceMappingURL=admin-admin-settings-admin-settings-module-es2015.js.map