...
var ManagersPage = /** @class */ (function () {
    function ManagersPage(events, labelService, router, sharedService, alertController, configService) {
        this.events = events;
    ...
    ManagersPage.prototype.ionViewWillEnter = function () {
    ...
    ManagersPage.prototype.ngOnInit = function () {
        this.SHARED_LABELS = this.labelService.labels['SHARED'];
    };
    ManagersPage.prototype.ngOnDestroy = function () {
        this.removeSubscriptions();
    };
    ManagersPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('manager:publishAllManagers', function (managerData) {
            if (managerData.length) {
                _this.managers = managerData;
        ...
        this.events.subscribe('manager:managerDeleted', function () {
            if (_this.sharedService.loading) {
                _this.sharedService.loading.dismiss();
            }
            _this.sharedService.presentAlert("Manager Deleted");
            _this.events.publish('manager:getAllManagers');
        });
    };
    ManagersPage.prototype.editManager = function (id) {
    ...
    ManagersPage.prototype.deleteManager = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
...
//# sourceMappingURL=admin-managers-managers-module-es5.js.map