...
/* harmony import */ var _ionic_super_tabs_angular__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic-super-tabs/angular */ "./node_modules/@ionic-super-tabs/angular/fesm5/ionic-super-tabs-angular.js");
...
var CreateVoucherPageModule = /** @class */ (function () {
    function CreateVoucherPageModule() {
    }
    ...
    return CreateVoucherPageModule;
}());
...
var CreateVoucherPage = /** @class */ (function () {
    function CreateVoucherPage(route, events, alertController, router, loadingController, platform, modalController, storage, voucherService, configService, angularFirestore, _location, vendorService, sharedService, categoryService) {
        var _this = this;
        this.route = route;
        this.events = events;
    ...
    CreateVoucherPage.prototype.ngOnInit = function () {
    ...
    CreateVoucherPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, _b, _c, vendorRes;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_d) {
                switch (_d.label) {
                    ...
                    case 5:
                        ...
                        if (!this.multiVendor) return [3 /*break*/, 7];
    ...
    CreateVoucherPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    CreateVoucherPage.prototype.initializeSubscriptions = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.events.subscribe('voucher:publishgetProductWithId', function (data) {
                    data = _this.getUpdatedFields(data);
                    _this.voucher = data;
                    _this.events.publish('vendor:getVendorName', _this.voucher.vendorId);
                });
                this.events.subscribe('voucher:addSuccess', function (heading, desc) {
                    _this.loader.dismiss();
                    _this.presentAlert(heading, desc, true);
                    _this.voucher.prodName = null;
                    _this.voucher.prodDesc = null;
                    _this.voucher.prodPrice = null;
                    _this.listOfBase64Image = [];
                    _this.selectedCategories = [];
                    _this.selectedBrands = [];
                });
                this.events.subscribe('voucher:addFailure', function (heading, desc) {
                    if (_this.loader) {
                        _this.loader.dismiss();
                    }
                    _this.presentAlert(heading, desc);
                });
                this.events.subscribe('voucher:editSuccess', function (heading, desc) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (this.loader) {
                ...
                this.events.subscribe('voucher:publishAllCategoriesForAdmin', function (categories) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    var allCategories;
                    var _this = this;
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.events.subscribe('voucher:noCategoryAvailable', function () {
    ...
    CreateVoucherPage.prototype.editShowDisable = function () {
    ...
    CreateVoucherPage.prototype.removeImage = function (index) {
        this.listOfBase64Image.splice(index, 1);
    };
    CreateVoucherPage.prototype.calculateImageSize = function (base64String) {
    ...
    CreateVoucherPage.prototype.saveVoucher = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(this.voucher.productCode != '')) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.voucherService.checkProductSKU(this.voucher.productCode, this.editProductId)];
                    case 1:
                        prodCode = _b.sent();
                        ...
                        _b.label = 2;
                    case 2:
                        if (!(this.voucher.prodName === null || this.voucher.prodName === '')) return [3 /*break*/, 3];
                        this.presentAlert('', 'Please enter voucher name');
                        return [3 /*break*/, 15];
                    case 3:
                        if (!!this.voucher.prodPrice) return [3 /*break*/, 4];
                        this.presentAlert('', 'Please enter voucher price');
                        return [3 /*break*/, 15];
                    case 4:
                        if (!(this.voucher.productCode === null || this.voucher.productCode === '')) return [3 /*break*/, 5];
                        this.presentAlert('', 'Please enter voucher Code');
                        return [3 /*break*/, 15];
                    case 5:
                        if (!(this.voucher.prodDesc === null || this.voucher.prodDesc === '')) return [3 /*break*/, 6];
                        this.presentAlert('', 'Please enter voucher description');
                        return [3 /*break*/, 15];
                    case 6:
                        if (!(!(this.voucher.categories && this.voucher.categories.length) && !(this.voucher.brands && this.voucher.brands.length))) return [3 /*break*/, 7];
                        this.presentAlert('', 'Please select any category or brand');
                        return [3 /*break*/, 15];
                    case 7:
                        if (!(this.listOfBase64Image.length !== 0 && this.coverValue === false)) return [3 /*break*/, 8];
                        this.presentAlert('', 'Please make any one image as cover picture');
                        return [3 /*break*/, 15];
                    case 8:
                        if (!(this.voucher.gst && this.voucher.gst > 100)) return [3 /*break*/, 9];
                    ...
                    case 10:
                        ...
                        if (!(this.userRole === 'vendor')) return [3 /*break*/, 12];
                        _a = this.voucher;
                        return [4 /*yield*/, this.storage.get('uid')];
                    case 11:
                        _a.vendorId = _b.sent();
                        _b.label = 12;
                    case 12:
                        if (!(this.isUniversal && this.editProductId)) return [3 /*break*/, 14];
                        slugName = this.sharedService.createSlugName(this.voucher.slug.name);
                        return [4 /*yield*/, this.sharedService.sameSlugExists('products', this.voucher, slugName)];
                    case 13:
    ...
    CreateVoucherPage.prototype.updateNewProductStatus = function (status) {
    ...
    CreateVoucherPage.prototype.newProductCoverPic = function (index) {
    ...
    CreateVoucherPage.prototype.editProductCoverPicInData = function (index) {
        var editImgData = this.voucher.images[index];
        this.voucher.coverPic = editImgData;
        for (var i = 0; this.listOfBase64Image.length; i++) {
            this.listOfBase64Image[i].cover = false;
        }
    };
    CreateVoucherPage.prototype.editProductCoverPicInList = function (index) {
    ...
    CreateVoucherPage.prototype.imagesReorder = function (event) {
        var b = this.voucher.images[event.detail.from];
    ...
    CreateVoucherPage.prototype.removeEditImageInData = function (index, url) {
    ...
    CreateVoucherPage.prototype.cancel = function () {
        this.router.navigate(['voucher']);
    };
    CreateVoucherPage.prototype.onClickImage = function (img) {
        var imgZoomUrls = [];
    ...
    CreateVoucherPage.prototype.onClickEditImage = function (img) {
        var imgZoomUrls = [];
        var imgurl = { url: img };
        for (var _i = 0, _a = this.listOfBase64Image; _i < _a.length; _i++) {
            var img_2 = _a[_i];
        ...
        for (var _b = 0, _c = this.voucher.images; _b < _c.length; _b++) {
            var img_3 = _c[_b];
    ...
    CreateVoucherPage.prototype.deleteAlertConfirm = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CreateVoucherPage.prototype.deleteProduct = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    CreateVoucherPage.prototype.presentAlert = function (heading, desc, action) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CreateVoucherPage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    CreateVoucherPage.prototype.onClickCategoryCheckBox = function (cid) {
        if (this.voucher.categories) {
            if (this.voucher.categories.indexOf(cid) === -1) {
                this.voucher.categories.push(cid);
            }
            else {
                var cidIndex = this.voucher.categories.indexOf(cid);
    ...
    CreateVoucherPage.prototype.onClickBrandCheckBox = function (bid) {
        if (this.voucher.brands) {
            if (this.voucher.brands.indexOf(bid) === -1) {
                this.voucher.brands.push(bid);
            }
            else {
                var bidIndex = this.voucher.brands.indexOf(bid);
    ...
    CreateVoucherPage.prototype.editCheckBoxValue = function (id) {
        if (this.voucher.categories) {
    ...
    CreateVoucherPage.prototype.editBrandCheckBoxValue = function (id) {
    ...
    CreateVoucherPage.prototype.clearSearchCategory = function () {
        this.searchCategory = null;
    };
    CreateVoucherPage.prototype.clearSearchBrand = function () {
        this.searchBrand = null;
    };
    CreateVoucherPage.prototype.allowPaymentToggle = function () {
        this.voucher.allowPayment = !this.voucher.allowPayment;
    };
    CreateVoucherPage.prototype.addSearchKeywords = function () {
        this.voucher.searchKeywords.push(this.keyword);
        this.keyword = '';
    };
    CreateVoucherPage.prototype.removeKeyword = function (i) {
        this.voucher.searchKeywords.splice(i, 1);
    };
    CreateVoucherPage.prototype.editProductAddSearchKeywords = function () {
        this.voucher.searchKeywords.push(this.keyword);
        this.keyword = '';
    };
    CreateVoucherPage.prototype.editProductRemoveKeyword = function (i) {
        this.voucher.searchKeywords.splice(i, 1);
    };
    CreateVoucherPage.prototype.stopOrderWhenNoQtyToggle = function () {
        this.voucher.stopWhenNoQty = !this.voucher.stopWhenNoQty;
    };
    CreateVoucherPage.prototype.editProductStopOrderWhenNoQtyToggle = function (status) {
        if (status) {
    ...
    CreateVoucherPage.prototype.getSubcategories = function (cid) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var subcategories;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        subcategories = [];
                        return [4 /*yield*/, this.voucherService.getSubcategoriesInNewProduct(cid)];
                    case 1:
    ...
    CreateVoucherPage.prototype.getSubOfSubCategories = function (catId, subCatId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    CreateVoucherPage.prototype.changeInPrice = function () {
        if (this.voucher.discountedPrice === this.voucher.prodPrice) {
            this.voucher.discountedPrice = null;
        }
    };
    CreateVoucherPage.prototype.onDrop = function (files) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var message, modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.listOfBase64Image && !this.voucher && (this.listOfBase64Image.length == this.imagesLimit))) return [3 /*break*/, 1];
                        // console.log('here1', this.listOfBase64Image.length)
                        this.presentAlert('Upload failed', message);
                        return [3 /*break*/, 6];
                    case 1:
                        if (!(this.voucher && this.voucher.images && (this.voucher.images.length == this.imagesLimit))) return [3 /*break*/, 2];
                        // console.log('here2')
                        this.presentAlert('Upload failed', message);
                        return [3 /*break*/, 6];
                    case 2:
                        if (!(this.listOfBase64Image.length && this.voucher && this.voucher.images && (this.listOfBase64Image.length + this.voucher.images.length == this.imagesLimit))) return [3 /*break*/, 3];
                        // console.log('here3')
                        this.presentAlert('Upload failed', message);
                        return [3 /*break*/, 6];
    ...
    CreateVoucherPage.prototype.addNewSection = function () {
    ...
    CreateVoucherPage.prototype.openProductSectionModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CreateVoucherPage.prototype.openWidgetEdit = function (type, id, index) {
    ...
    CreateVoucherPage.prototype.getSections = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    CreateVoucherPage.prototype.SectionReorder = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var draggedItem;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    CreateVoucherPage.prototype.deleteSectionConfirm = function (widgetID, index, type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CreateVoucherPage.prototype.deleteSection = function (index, type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var error_2;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    CreateVoucherPage.prototype.changeLocationStatus = function (index, type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var error_3;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    CreateVoucherPage.prototype.toggleGstExclusive = function () {
        this.voucher.gstExclusive = !this.voucher.gstExclusive;
    };
    CreateVoucherPage.prototype.toggleGstExclusiveEdit = function () {
        this.voucher.gstExclusive = !this.voucher.gstExclusive;
    };
    CreateVoucherPage.prototype.getEditSlabInputs = function (slab) {
        var adminInput;
        adminInput = [
            {
                name: 'mrp',
    ...
    CreateVoucherPage.prototype.changeComponent = function (index) {
    ...
    CreateVoucherPage.prototype.getUpdatedFields = function (data) {
        if (!data.hasOwnProperty('gstExclusive')) {
            data['gstExclusive'] = this.voucher.gstExclusive;
        }
        return data;
    };
    CreateVoucherPage.prototype.addVendor = function (e) {
        //console.log('vendorId', e.target.value);
        this.voucher.vendorId = e.target.value;
    };
    CreateVoucherPage.prototype.removeSubscriptions = function () {
    ...
    CreateVoucherPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-vouchers-create-voucher-create-voucher-module-es5.js.map