...
let VendorSettingsPageModule = class VendorSettingsPageModule {
};
...
let VendorSettingsPage = class VendorSettingsPage {
    constructor(vendorService, storage, sharedService) {
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.vendorId = uid;
            let details = yield this.vendorService.getVendorData(uid, 'details');
            if (details) {
    ...
    saveSettings() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let success = yield this.vendorService.updateVendorInfo(this.vendorId, this.settings);
            if (success) {
...
VendorSettingsPage.ctorParameters = () => [
...
//# sourceMappingURL=vendor-settings-vendor-settings-module-es2015.js.map