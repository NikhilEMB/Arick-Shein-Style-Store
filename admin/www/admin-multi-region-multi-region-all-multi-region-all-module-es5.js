...
var MultiRegionAllPageModule = /** @class */ (function () {
    function MultiRegionAllPageModule() {
    }
    ...
    return MultiRegionAllPageModule;
}());
...
var MultiRegionAllPage = /** @class */ (function () {
    function MultiRegionAllPage(events, labelService, alertController, loadingController, router, toastController, configService) {
        this.events = events;
    ...
    MultiRegionAllPage.prototype.ionViewWillEnter = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.multiRegion == false)) return [3 /*break*/, 3];
    ...
    MultiRegionAllPage.prototype.ngOnInit = function () {
    ...
    MultiRegionAllPage.prototype.ngOnDestroy = function () {
        this.removeSubscriptions();
    };
    MultiRegionAllPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('multi-region:multiRegionActiveChanged', function () {
            if (_this.loading) {
        ...
        this.events.subscribe('multi-region:publishActiveStatus', function (data) {
            if (data) {
                _this.isMultiRegionActive = data.active;
                if (data.regionType) {
                    _this.type = data.regionType;
                }
                else {
                    _this.type = 'pincodes';
                }
        ...
        this.events.subscribe('multi-region:publishAllRegions', function (regions) {
            if (regions.length) {
        ...
        this.events.subscribe('multi-region:regionActiveChanged', function () {
            if (_this.loading) {
                _this.loading.dismiss();
            }
            _this.presentToast("Status changed successfully");
        });
        this.events.subscribe('multi-region:multiRegionTypeChanged', function () {
            if (_this.loading) {
                _this.loading.dismiss();
            }
            _this.presentToast("Region type changed successfully");
        });
        this.events.subscribe('multi-region:regionDeleted', function () {
            if (_this.loading) {
                _this.loading.dismiss();
            }
            _this.presentAlert("Region deleted successfully");
            _this.events.publish('multi-region:getAllRegions');
        });
    };
    MultiRegionAllPage.prototype.subscriptionsActiveToggle = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    MultiRegionAllPage.prototype.toggleRegionActive = function (i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    MultiRegionAllPage.prototype.editRegion = function (i) {
    ...
    MultiRegionAllPage.prototype.deleteRegion = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    MultiRegionAllPage.prototype.gotoMultiRegionAdd = function () {
        var navigationExtras = {
            state: {
                data: {
                    regionType: this.type
    ...
    MultiRegionAllPage.prototype.changeType = function (e) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    MultiRegionAllPage.prototype.presentLoading = function (duration, msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    MultiRegionAllPage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    MultiRegionAllPage.prototype.presentToast = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    MultiRegionAllPage.prototype.removeSubscriptions = function () {
    ...
    MultiRegionAllPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-multi-region-multi-region-all-multi-region-all-module-es5.js.map