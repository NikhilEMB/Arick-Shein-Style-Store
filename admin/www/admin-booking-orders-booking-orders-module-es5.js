...
var BookingOrdersPageModule = /** @class */ (function () {
    function BookingOrdersPageModule() {
    }
    ...
    return BookingOrdersPageModule;
}());
...
var BookingOrdersPage = /** @class */ (function () {
    function BookingOrdersPage(storage, sharedService, bookingService, alertController, modalController, configService) {
    ...
    BookingOrdersPage.prototype.ngOnInit = function () {
        this.taxType = this.configService.environment.taxType;
        this.currencyCode = this.configService.environment.currencyCode;
    };
    BookingOrdersPage.prototype.ionViewDidEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        _b.userRole = _c.sent();
                        return [4 /*yield*/, this.getBookingOrders()];
                    case 4:
                        _c.sent();
    ...
    BookingOrdersPage.prototype.getBookingOrders = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.bookingService.getAllBookingOrders()];
                    case 1:
                        data = _a.sent();
                        if (!(data && data.length > 0)) return [3 /*break*/, 3];
                        this.bookingOrders = data;
                        return [4 /*yield*/, this.viewBooking(0)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
    ...
    BookingOrdersPage.prototype.viewBooking = function (index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.userRole !== "vendor")) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.getVendorName()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
    ...
    BookingOrdersPage.prototype.getVendorName = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var vendorData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.selectedOrder.vendor && this.selectedOrder.vendor.id)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.bookingService.getVendorName(this.selectedOrder.vendor.id)];
                    case 1:
                        vendorData = _a.sent();
    ...
    BookingOrdersPage.prototype.getDateTimeFormat = function (date) {
        return moment__WEBPACK_IMPORTED_MODULE_2__(date).format('MMM D, YYYY hh:mm a');
    };
    BookingOrdersPage.prototype.convert24to12 = function (time) {
        return moment__WEBPACK_IMPORTED_MODULE_2__(time, ['HH:mm']).format('hh:mm A');
    };
    BookingOrdersPage.prototype.searchBookingById = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.bookingService.returnBookingDetailsWithOrderId(parseInt(this.searchOrder))];
                    case 2:
                        data = _a.sent();
    ...
    BookingOrdersPage.prototype.resetSearch = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.searchOrder = '';
                        return [4 /*yield*/, this.ionViewDidEnter()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    BookingOrdersPage.prototype.askUpdateStatus = function (status) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    BookingOrdersPage.prototype.changeBookingStatus = function (status) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var response;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.bookingService.updateBookingStatus(this.selectedOrder.id, this.selectedOrder.status)];
                    case 2:
                        response = _a.sent();
                        this.sharedService.loading.dismiss();
                        if (!response) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.sharedService.presentAlert("Booking has been " + status)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, this.sharedService.presentAlert('Something went wrong !')];
                    case 5:
                        _a.sent();
                        _a.label = 6;
    ...
    BookingOrdersPage.prototype.getTotalAmount = function () {
        return {
    ...
    BookingOrdersPage.prototype.showInvoice = function (url) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (url) {
    ...
    BookingOrdersPage.prototype.imgZoom = function (img) {
    ...
    BookingOrdersPage.prototype.getBookingItemPrice = function () {
    ...
    BookingOrdersPage.prototype.changeBookingSlotModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (res) {
                            if (res && res.data && res.data.schedule) {
                                ...
                                _this.selectedOrder.schedule = res.data.schedule;
                            }
                        });
    ...
    BookingOrdersPage.prototype.askUpdatePaymentStatus = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var openPrompt;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, this.changePaymentStatus()];
                                                case 1:
                                                    _a.sent();
                                                    return [2 /*return*/];
                                            }
                    ...
                    case 1:
                        openPrompt = _a.sent();
                        return [4 /*yield*/, openPrompt.present()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    BookingOrdersPage.prototype.changePaymentStatus = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.bookingService.updatePaymentStatus(this.selectedOrder.id, paymentStatus)];
                    case 2:
                        response = _a.sent();
                        return [4 /*yield*/, this.sharedService.loading.dismiss()];
                    case 3:
                        ...
                        return [4 /*yield*/, this.sharedService.presentAlert('Payment status updated successfully.')];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 7];
    ...
    BookingOrdersPage.prototype.isPartialPayment = function () {
        return this.selectedOrder.payment.partial && this.selectedOrder.payment.partial.cod;
    };
    BookingOrdersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-booking-orders-booking-orders-module-es5.js.map