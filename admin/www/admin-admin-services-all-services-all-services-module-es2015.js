...
let AllServicesPageModule = class AllServicesPageModule {
};
...
let AllServicesPage = class AllServicesPage {
    constructor(events, router, loadingController, alertController, toastController) {
        this.events = events;
        this.router = router;
    ...
    changeStatus() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.isActive) {
                this.isActive = false;
                yield this.presentLoading('Changing Status...', 5000);
...
AllServicesPage.ctorParameters = () => [
...
//# sourceMappingURL=admin-admin-services-all-services-all-services-module-es2015.js.map