...
var CreateServicePageModule = /** @class */ (function () {
    function CreateServicePageModule() {
    }
    ...
    return CreateServicePageModule;
}());
...
var CreateServicePage = /** @class */ (function () {
    function CreateServicePage(router, events, loadingController, alertController, camera, actionSheetController, route, modalController, labelService, configService) {
        var _this = this;
        this.router = router;
        this.events = events;
        ...
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.serviceData = _this.router.getCurrentNavigation().extras.state.serviceData;
                if (_this.serviceData) {
                    _this.name = _this.serviceData.name;
                    _this.description = _this.serviceData.description;
                    _this.imageMandatory = _this.serviceData.imageMandatory;
                    _this.createdAt = _this.serviceData.createdAt;
                    _this.banner = _this.serviceData.banner.hasOwnProperty('url') ? [tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _this.serviceData.banner)] : [];
                    console.log(_this.banner);
                    _this.serviceId = _this.serviceData.id;
                    _this.schedule = _this.serviceData.hasOwnProperty('schedule') ? _this.serviceData.schedule : _this.schedule;
                    _this.regionId = _this.serviceData.hasOwnProperty('regionId') ? _this.serviceData.regionId : _this.regionId;
                    for (var index = 0; index < _this.days.length; index++) {
                        if (_this.schedule.days.indexOf(_this.days[index].day) != -1) {
                            _this.days[index].active = true;
                        }
                    }
                    if (_this.serviceData.metaData) {
                        _this.metaData = _this.serviceData.metaData;
                    }
                }
            }
        });
    }
    CreateServicePage.prototype.ngOnInit = function () {
        this.ckeConfig = {
            allowedContent: true,
            toolbar: [
    ...
    CreateServicePage.prototype.ionViewWillEnter = function () {
    ...
    CreateServicePage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    CreateServicePage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('services-feature:saveServiceSuccess', function () {
            _this.loading.dismiss();
            _this.presentAlert('Service Saved Successfully', true);
        });
        this.events.subscribe('services-feature:deleteServiceSuccess', function () {
            if (_this.loading) {
                _this.loading.dismiss();
            }
            _this.presentAlert('Service deleted successfully!', true);
        });
    ...
    CreateServicePage.prototype.imageMandatoryStatus = function () {
        this.imageMandatory = !this.imageMandatory;
    };
    CreateServicePage.prototype.saveService = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var daysData, index, scheduleData, serviceData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(!this.name || !this.description)) return [3 /*break*/, 1];
                        this.presentAlert('Please enter all service details');
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.presentLoading('Saving service details...', 10000)];
                    case 2:
                        _a.sent();
                        daysData = [];
    ...
    CreateServicePage.prototype.removeImage = function () {
        this.banner.splice(0, 1);
    };
    CreateServicePage.prototype.deleteConfirm = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CreateServicePage.prototype.deleteService = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    CreateServicePage.prototype.imageActionSheet = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.actionSheetController.create({
                            ...
                            buttons: [{
                                    ...
                                    icon: 'camera',
                                    handler: function () {
                                        _this.addCameraImage('camera');
                                    }
                                }, {
                                    text: 'Gallery',
                                    icon: 'images',
                                    handler: function () {
                                        _this.addCameraImage('gallery');
                                    }
                                }, {
                                    text: 'Cancel',
                                    icon: 'close',
    ...
    CreateServicePage.prototype.addCameraImage = function (ctype) {
        var _this = this;
    ...
    CreateServicePage.prototype.uploadImage = function (files) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CreateServicePage.prototype.imgZoom = function (img) {
    ...
    CreateServicePage.prototype.presentAlert = function (msg, action) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alertController.create({
                            ...
                            buttons: [{
                                    ...
                                    handler: function () {
                                        if (action) {
                                            _this.router.navigate(['all-services']);
                                        }
                                    }
                                }]
                        })];
    ...
    CreateServicePage.prototype.presentLoading = function (msg, drn) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    CreateServicePage.prototype.serviceScheduleToggle = function () {
        this.schedule.active = !this.schedule.active;
    };
    CreateServicePage.prototype.serviceScheduleMandatoryToggle = function () {
        this.schedule.mandatory = !this.schedule.mandatory;
    };
    CreateServicePage.prototype.daySelectToggle = function (i) {
        this.days[i].active = !this.days[i].active;
    };
    CreateServicePage.prototype.addTimeSchedule = function () {
    ...
    CreateServicePage.prototype.disableAddTimeSchedule = function () {
    ...
    CreateServicePage.prototype.removeTimeSchedule = function (index) {
        this.schedule.timeSchedules.splice(index, 1);
    };
    CreateServicePage.prototype.addRegion = function (e) {
        console.log('regionId', e.target.value);
        this.regionId = e.target.value;
    };
    CreateServicePage.prototype.removeSubscriptions = function () {
    ...
    CreateServicePage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-admin-services-create-service-create-service-module-es5.js.map