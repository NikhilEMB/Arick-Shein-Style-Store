...
var MultiVendorAllPageModule = /** @class */ (function () {
    function MultiVendorAllPageModule() {
    }
    ...
    return MultiVendorAllPageModule;
}());
...
var MultiVendorAllPage = /** @class */ (function () {
    function MultiVendorAllPage(events, labelService, router, sharedService, alertController, configService, vendorService, modalController) {
        this.events = events;
    ...
    MultiVendorAllPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var multiRegionEnv, multiRegionActive, alert_1, _a;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.multiVendor = this.configService.environment.multiVendor;
                        multiRegionEnv = this.configService.environment.multiRegion;
                        this.vendorsLimit = this.configService.environment.vendorsLimit;
                        return [4 /*yield*/, this.vendorService.getMultiRegion()];
                    case 1:
                        multiRegionActive = _b.sent();
                        if (!(this.multiVendor == false)) return [3 /*break*/, 4];
    ...
    MultiVendorAllPage.prototype.ngOnInit = function () {
    ...
    MultiVendorAllPage.prototype.ngOnDestroy = function () {
    };
    MultiVendorAllPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    MultiVendorAllPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        ...
        //   }
        // });
        this.events.subscribe('vendor:vendorDeleted', function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    MultiVendorAllPage.prototype.saveSettings = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    MultiVendorAllPage.prototype.editVendor = function (vendorDetails) {
    ...
    MultiVendorAllPage.prototype.deleteVendor = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    MultiVendorAllPage.prototype.gotoMultiVendorAdd = function () {
        this.router.navigate(['multi-vendor-add']);
    };
    MultiVendorAllPage.prototype.removeSubscriptions = function () {
    ...
    MultiVendorAllPage.prototype.addVendor = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var multiVendor, modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(multiVendor.count < this.vendorsLimit)) return [3 /*break*/, 4];
    ...
    MultiVendorAllPage.prototype.pageVendor = function (id, name) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    MultiVendorAllPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-multi-vendor-multi-vendor-all-multi-vendor-all-module-es5.js.map