...
var ProductAddonsPageModule = /** @class */ (function () {
    function ProductAddonsPageModule() {
    }
    ...
    return ProductAddonsPageModule;
}());
...
var ProductAddonsPage = /** @class */ (function () {
    function ProductAddonsPage(addOnsService, sharedService, alertController) {
    ...
    ProductAddonsPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.addOnsService.getAddOns()];
                    case 2:
                        res = _a.sent();
    ...
    ProductAddonsPage.prototype.ngOnInit = function () {
    };
    ProductAddonsPage.prototype.defaultObj = function () {
        var section = {
            name: '',
            active: false,
            multiple: false,
    ...
    ProductAddonsPage.prototype.changeAddOn = function (i) {
        this.activeTile = i;
        this.selectedAddOn = this.addOnsData[i];
        // console.log(this.selectedAddOn);
    };
    ProductAddonsPage.prototype.addTemplate = function () {
        this.activeTile = 0;
        this.selectedAddOn = {
            name: '',
            type: 'product-addOn',
    ...
    ProductAddonsPage.prototype.askConfirmDelete = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ProductAddonsPage.prototype.deleteTemplate = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var res;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.addOnsService.deleteAddOn(this.selectedAddOn.id)];
                    case 2:
                        res = _a.sent();
                        return [4 /*yield*/, this.sharedService.loading.dismiss()];
                    case 3:
    ...
    ProductAddonsPage.prototype.addSection = function () {
        this.selectedAddOn.sections.push(this.defaultObj());
    };
    ProductAddonsPage.prototype.addOption = function (i, name, price) {
    ...
    ProductAddonsPage.prototype.removeOption = function (i, j) {
        // console.log(i, j);
        this.selectedAddOn.sections[i].options.splice(j, 1);
    };
    ProductAddonsPage.prototype.removeSection = function (i) {
        this.selectedAddOn.sections.splice(i, 1);
    };
    ProductAddonsPage.prototype.toggleCheckBox = function (i, status) {
        if (status == 'active') {
    ...
    ProductAddonsPage.prototype.saveAddOns = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var addObj, _i, _a, section, res;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        for (_i = 0, _a = this.selectedAddOn.sections; _i < _a.length; _i++) {
                            section = _a[_i];
                            // console.log(section);
                        ...
                        if (!(this.selectedAddOn.name == '' || !this.addOnValid)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.sharedService.loading.dismiss()];
                    case 2:
                        _b.sent();
                        this.sharedService.presentAlert('Please fill all details for addOns !');
                        return [3 /*break*/, 6];
                    case 3: return [4 /*yield*/, this.addOnsService.setAddons(this.selectedAddOn.id, addObj)];
                    case 4:
                        res = _b.sent();
                        return [4 /*yield*/, this.sharedService.loading.dismiss()];
                    case 5:
    ...
    ProductAddonsPage.ctorParameters = function () { return [
...
var ProductAddonsService = /** @class */ (function () {
    function ProductAddonsService(afs) {
        this.afs = afs;
    }
    ProductAddonsService.prototype.setAddons = function (id, addOns) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        ...
                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.afs.collection('templates').doc(id).update(addOns)];
                                case 1:
                                    _a.sent();
                                    return [3 /*break*/, 4];
                                case 2: return [4 /*yield*/, this.afs.collection('templates').add(addOns)];
                                case 3:
                                    _a.sent();
                                    _a.label = 4;
                                case 4:
    ...
    ProductAddonsService.prototype.getAddOns = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var addOnsArray_1, docRef;
                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            try {
                                addOnsArray_1 = [];
                                docRef = this.afs.collection('templates', function (ref) { return ref.where('type', '==', 'product-addOn'); });
                                docRef.get().subscribe(function (snapShot) {
                                    snapShot.forEach(function (doc) {
                                        addOnsArray_1.push(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: doc.id }, doc.data()));
                                    });
                                    resolve(addOnsArray_1);
                                });
                            }
                            catch (err) {
                                console.log('err:', err);
    ...
    ProductAddonsService.prototype.deleteAddOn = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        ...
                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 3, , 4]);
                                    if (!id) return [3 /*break*/, 2];
                                    return [4 /*yield*/, this.afs.collection('templates').doc(id).delete()];
                                case 1:
                                    _a.sent();
                                    resolve(true);
                                    _a.label = 2;
    ...
    ProductAddonsService.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-product-addons-product-addons-module-es5.js.map