...
var AdminProductsOptionsPageModule = /** @class */ (function () {
    function AdminProductsOptionsPageModule() {
    }
    ...
    return AdminProductsOptionsPageModule;
}());
...
var AdminProductsOptionsPage = /** @class */ (function () {
    function AdminProductsOptionsPage(events, router, route, loadingController) {
        var _this = this;
        this.events = events;
        this.router = router;
        this.route = route;
        ...
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.productId = _this.router.getCurrentNavigation().extras.state.pid;
            }
        });
    }
    AdminProductsOptionsPage.prototype.ngOnInit = function () {
    };
    AdminProductsOptionsPage.prototype.ionViewWillEnter = function () {
        this.initializeSubscriptions();
        this.events.publish('product-options:getAllProductOptions', this.productId);
    };
    AdminProductsOptionsPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    AdminProductsOptionsPage.prototype.removeSubscriptions = function () {
    ...
    AdminProductsOptionsPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('product-options:publishAllProductOptions', function (options) {
    ...
    AdminProductsOptionsPage.prototype.editProductOption = function (item) {
    ...
    AdminProductsOptionsPage.prototype.checkPdtOutOfDelivery = function (pdt) {
        ...
        if (!pdt.isPriceList) {
            ...
            for (var _i = 0, _a = pdt.priceList; _i < _a.length; _i++) {
                var pl = _a[_i];
    ...
    AdminProductsOptionsPage.prototype.deleteProductOption = function (optionId) {
    ...
    AdminProductsOptionsPage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    AdminProductsOptionsPage.ctorParameters = function () { return [
    ...
    return AdminProductsOptionsPage;
}());
...
//# sourceMappingURL=admin-admin-products-options-admin-products-options-module-es5.js.map