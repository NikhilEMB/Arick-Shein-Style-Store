...
var ManageShipmentPageModule = /** @class */ (function () {
    function ManageShipmentPageModule() {
    }
    ...
    return ManageShipmentPageModule;
}());
...
var ManageShipmentPage = /** @class */ (function () {
    function ManageShipmentPage(events, router, loadingController, alertController, sharedService, inAppBrowser, manageShipmentService, activatedRoute, vendorService, afs) {
        this.events = events;
        this.router = router;
        ...
        var vendorId = this.activatedRoute.snapshot.paramMap.get("vendor_id");
        if (vendorId) {
    ...
    ManageShipmentPage.prototype.ngOnInit = function () { };
    ManageShipmentPage.prototype.ionViewWillEnter = function () {
    ...
    ManageShipmentPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    ManageShipmentPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe("manage-shipment:getCustomOrderSuccess", function (integrationOrder) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var projectId;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                if (integrationOrder) {
                    ...
                    projectId = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].firebase.projectId || null;
        ...
        this.events.subscribe("manage-shipment:getOrderDetailsSuccess", function (orderDetails, storeDoc, userDetails) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var vendorData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!('vendors' in this.orderDetails && this.orderDetails.vendors.length)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.vendorService.getVendorDataWithId(this.orderDetails.vendors[0].id)];
                    case 1:
                        vendorData = _a.sent();
        ...
        this.events.subscribe("manage-shipment:getAllPickupLocationsSuccess", function (locations) {
            console.log('this.pickupLocations', _this.pickupLocations);
            _this.pickupLocations = locations;
        });
        this.events.subscribe("manage-shipment:createCustomOrderSuccess", function (data) {
            console.log("custom order created");
            _this.shipmentDetails = data.shipmentDetails;
            _this.customOrder = data.customOrder;
            var projectId = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].firebase.projectId || null;
            if (projectId && (projectId === 'bwi-bistarwale') && typeof data.customOrder === 'string') {
                _this.customOrder = JSON.parse(data.customOrder.replace('format=json&data=', ''));
            }
            _this.statusIndex = 2;
            _this.sharedService.presentAlert("Custom order has been created successfully in " + _this.manageShipmentService.integrationCode + ". Now please select courier.");
            _this.events.publish("manage-shipment:checkCourierServiceability", {
                shipmentDetails: _this.shipmentDetails,
                customOrder: _this.customOrder,
            }, _this.orderId);
        });
        this.events.subscribe("manage-shipment:checkCourierServiceabilitySuccess", function (data) {
            _this.loading.dismiss();
            _this.couriers = data.couriers;
            _this.recommendedCourierId = data.recommendedCourierId;
        ...
        this.events.subscribe("manage-shipment:selectCourierSuccess", function (data) {
            _this.awbData = data.awb;
            _this.shipmentDetails = data.shipmentDetails;
            _this.statusIndex = 3;
            _this.events.publish("manage-shipment:requestForShipmentPickup", _this.shipmentDetails, _this.orderId);
        });
        this.events.subscribe("manage-shipment:requestForShipmentPickupSuccess", function (pickupDetails) {
            _this.pickupDetails = pickupDetails;
            _this.events.publish("manage-shipment:generateReceipts", _this.shipmentDetails, _this.orderId);
        });
        this.events.subscribe("manage-shipment:generateReceiptsSuccess", function (urls) {
            _this.receiptsUrls = urls;
            _this.statusIndex = 4;
            _this.loading.dismiss();
        });
        this.events.subscribe("manage-shipment:getTrackingDetailsSuccess", function (trackingDetails) {
            _this.trackingDetails["trackUrl"] = trackingDetails.trackUrl || "";
            console.log("trackingDetails.trackEvents", trackingDetails.trackEvents);
            _this.trackingDetails["trackEvents"] =
                trackingDetails.trackEvents || null;
            if (_this.trackDetailsType === "url" && !trackingDetails.trackUrl) {
                _this.sharedService.presentAlert("No tracking url available.");
            }
            if (_this.trackDetailsType === "events" &&
                !trackingDetails.trackEvents) {
                _this.sharedService.presentAlert("No tracking real time events available.");
            }
            _this.loading.dismiss();
        });
        this.events.subscribe("manage-shipment:getTrackingDetailsFailure", function (msg) {
            _this.sharedService.presentAlert(msg);
            _this.loading.dismiss();
        });
        this.events.subscribe("manage-shipment:sendTrackLinkToUserSuccess", function () {
            _this.sharedService.presentAlert("Tracking Link has been send succefully to user in chat as well as in order dispatch message");
            _this.loading.dismiss();
        });
        this.events.subscribe("manage-shipment:cancelAndStartNewShipmentSuccess", function () {
            _this.sharedService.presentAlert("Order cancelled successfully!");
            _this.events.publish("manage-shipment:getCustomOrder", _this.orderId);
        });
        this.events.subscribe("manage-shipment:apiFailure", function (msg) {
            msg =
                msg === "Token has expired"
                    ? "Login Session has been expired, Please Login from " + _this.manageShipmentService.integrationCode + " Settings again to continue"
                    : msg;
            _this.sharedService.presentAlert(msg);
            if (_this.loading) {
                _this.loading.dismiss();
    ...
    ManageShipmentPage.prototype.checkCourierServiceability = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ManageShipmentPage.prototype.getAvailableIntegrations = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.manageShipmentService.getAvailableIntegrations()];
                    case 1:
                        _a.integrations =
                            _b.sent();
                        return [2 /*return*/];
    ...
    ManageShipmentPage.prototype.onChangeIntegration = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ManageShipmentPage.prototype.getCustomOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        _a = this;
                        return [4 /*yield*/, this.manageShipmentService.getAllPickupLocations()];
                    case 2:
                        _a.pickupLocations =
                            _b.sent();
    ...
    ManageShipmentPage.prototype.isIntegrationCodeSaved = function () {
    ...
    ManageShipmentPage.prototype.disableCreateOrderBtn = function () {
        if (!this.manageShipmentService.integrationCode) {
            return true;
        }
        else {
    ...
    ManageShipmentPage.prototype.getMerchantId = function () {
        var fastBeetleRef = this.afs.collection('integrations').doc('delivery').collection('list').doc('fastbeetle').get();
        fastBeetleRef.forEach(function (doc) {
            console.log('fastbeetle : ', doc.data().credentials);
            return doc.data().credentials.merchantId;
        });
    };
    ManageShipmentPage.prototype.createOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var orderData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.presentLoading("Creating order in " + this.manageShipmentService.integrationCode + "...")];
                    case 1:
                        _a.sent();
    ...
    ManageShipmentPage.prototype.selectCourier = function (courierId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading("Creating Shipment...")];
                    case 1:
                        _a.sent();
    ...
    ManageShipmentPage.prototype.onChangePickupLocation = function (e) {
        var locationId = e.target.value;
        console.log("locationId", locationId);
        console.log('pickupLocation', this.pickupLocations);
        if (this.manageShipmentService.integrationCode === 'shiprocket') {
            var index = this.pickupLocations.findIndex(function (l) { return l.id === locationId; });
        ...
        if (this.manageShipmentService.integrationCode === 'fastbeetle') {
            var index = this.pickupLocations.findIndex(function (l) { return l.profileName === locationId; });
    ...
    ManageShipmentPage.prototype.downloadUrl = function (type) {
        var url = "";
    ...
    ManageShipmentPage.prototype.showToast = function () {
        this.sharedService.presentAlert("Tracking Link Copied!");
    };
    ManageShipmentPage.prototype.presentLoading = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    ManageShipmentPage.prototype.presentAlert = function (msg, btnTxt, page) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ManageShipmentPage.prototype.getTrackingDetails = function (type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.trackDetailsType = type;
                        return [4 /*yield*/, this.presentLoading("Please Wait...")];
                    case 1:
                        _a.sent();
    ...
    ManageShipmentPage.prototype.generateUrl = function (type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var manifest, label, invoice;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading("Generating " + type + "...")];
                    case 1:
                        _a.sent();
                        if (!(type === "manifest")) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.manageShipmentService.generateManifest(this.shipmentDetails, this.orderId)];
                    case 2:
                        manifest = _a.sent();
                        this.loading.dismiss();
                        if (manifest) {
                        ...
                        _a.label = 3;
                    case 3:
                        if (!(type === "label")) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.manageShipmentService.generateLabel(this.shipmentDetails, this.orderId)];
                    case 4:
                        label = _a.sent();
                        this.loading.dismiss();
                        if (label) {
                        ...
                        _a.label = 5;
                    case 5:
                        if (!(type === "invoice")) return [3 /*break*/, 7];
                        return [4 /*yield*/, this.manageShipmentService.generateInvoice(this.shipmentDetails, this.orderId)];
                    case 6:
                        invoice = _a.sent();
                        this.loading.dismiss();
                        if (invoice) {
    ...
    ManageShipmentPage.prototype.cancleOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading("Cancelling order in " + this.manageShipmentService.integrationCode + "...")];
                    case 1:
                        _a.sent();
    ...
    ManageShipmentPage.prototype.presentAlertConfirm = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ManageShipmentPage.prototype.sendTrackingLink = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading("Sending tracking link to user...")];
                    case 1:
                        _a.sent();
    ...
    ManageShipmentPage.prototype.getSelectedLocation = function () {
        var _this = this;
        if (this.pickupLocations.length && this.customOrder["pickup_location"]) {
            console.log('this.pickupLocations', this.pickupLocations);
            var index = this.pickupLocations.findIndex(function (l) { return l.pickup_location === _this.customOrder["pickup_location"]; });
            if (index !== -1) {
    ...
    ManageShipmentPage.prototype.getCourierName = function () {
        var _this = this;
        console.log("this.couriers", this.couriers);
        var courier = this.couriers.find(function (c) { return c.courier_company_id === _this.orderDetails.deliveryGstObj.courierId; });
    ...
    ManageShipmentPage.prototype.getProductPrice = function (product) {
    ...
    ManageShipmentPage.prototype.getPickupPostcode = function (pickupLocation) {
        var index = this.pickupLocations.findIndex(function (l) { return l.pickup_location === pickupLocation; });
    ...
    //   }
    // }
    ManageShipmentPage.prototype.onChangeVendor = function (event) {
        this.setOrderIdForVendor(event.target.value);
    };
    ManageShipmentPage.prototype.setVendorPickupIdAndAddress = function (vendorData, vendorId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var pickupId;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                console.log('vendorData pass-on : ', vendorData);
                pickupId = 'deliveryIntegration' in vendorData ? vendorData.deliveryIntegration.pickupId : '';
    ...
    ManageShipmentPage.prototype.setOrderIdForVendor = function (vendorId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.currentVendorId = vendorId;
                        if (!!(vendorId in this.pickupIdsForVendors)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.vendorService.getVendorDataWithId(vendorId)];
                    case 1:
                        vendorData = _a.sent();
                        if (vendorData) {
                        ...
                        _a.label = 2;
                    case 2:
                        vendorProducts = this.orderDetails.vendors.find(function (v) { return v.id === vendorId; }).products;
    ...
    ManageShipmentPage.prototype.setVendorProducts = function (vendorProducts) {
        var products = [];
        var _loop_1 = function (vendorProduct) {
            this_1.orderDetails.products.map(function (product, index) {
                if (product.productId === vendorProduct.id) {
                    if ('pack' in product) {
                        if (product.pack.weight === vendorProduct.pack.weight) {
                            products.push(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ index: index }, product));
                        }
                    }
                    else {
                        products.push(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ index: index }, product));
        ...
        var this_1 = this;
        for (var _i = 0, vendorProducts_1 = vendorProducts; _i < vendorProducts_1.length; _i++) {
            var vendorProduct = vendorProducts_1[_i];
            _loop_1(vendorProduct);
        }
        this.orderDetails.products = products.slice();
    };
    ManageShipmentPage.prototype.isVendorsAvailable = function () {
        return 'vendors' in this.orderDetails && this.orderDetails.vendors.length;
    };
    ManageShipmentPage.prototype.removeSubscriptions = function () {
    ...
    ManageShipmentPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-manage-shipment-manage-shipment-module-es5.js.map