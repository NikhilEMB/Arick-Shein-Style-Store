...
let AdminPaymentSettingsPageModule = class AdminPaymentSettingsPageModule {
};
...
let AdminPaymentSettingsPage = class AdminPaymentSettingsPage {
    constructor(events, router, loadingController, alertController, labelService, configService, actionSheetController, camera, logglyService, modalController) {
        this.events = events;
        this.router = router;
    ...
    openGatewaySettings(gatewayChoice) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    extraChargesTypeRazorpay(event) {
...
AdminPaymentSettingsPage.ctorParameters = () => [
...
//# sourceMappingURL=admin-admin-payment-settings-admin-payment-settings-module-es2015.js.map