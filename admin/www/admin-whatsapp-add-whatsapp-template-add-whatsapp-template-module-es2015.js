...
let AddWhatsappTemplatePageModule = class AddWhatsappTemplatePageModule {
};
...
let AddWhatsappTemplatePage = class AddWhatsappTemplatePage {
    constructor(sharedService, whatsappService, router, configService) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.templateType == 'basic') {
                ...
                if (this.isTemplateAlreadyExists(templateExists))
                    return;
                success = yield this.whatsappService.addTemplate(this.templateType, docId, this.templateDetails);
            }
                ...
                success = yield this.whatsappService.addTemplate(this.templateType, docId, this.advanceTemplateDetails);
            }
...
AddWhatsappTemplatePage.ctorParameters = () => [
...
//# sourceMappingURL=admin-whatsapp-add-whatsapp-template-add-whatsapp-template-module-es2015.js.map