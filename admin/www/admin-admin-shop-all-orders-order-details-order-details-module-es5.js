...
var OrderDetailsPage = /** @class */ (function () {
    // pageType: any = '';
    function OrderDetailsPage(events, router, alertController, loadingController, navCtrl, route, inAppBrowser, 
    ...
    OrderDetailsPage.prototype.getStarColor = function (rating) {
        return this.sharedService.getStarColor(rating);
    };
    OrderDetailsPage.prototype.getDateTimeFormat = function (date) {
    ...
    OrderDetailsPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    OrderDetailsPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('user:publishOrderDetailsWithOrderId', function (orderData) {
            ...
            if (orderData[0].scheduledDate) {
                _this.dateSchedule = orderData[0].scheduledDate.toDate();
            }
            if (orderData[0].vendorId) {
                _this.events.publish('vendor:getVendorName', orderData[0].vendorId);
            }
            if (orderData[0].deliveryAgentId) {
                _this.events.publish('delivery:getDeliveryAgentName', orderData[0].deliveryAgentId);
            }
        });
        ...
        this.events.subscribe('order:sendPaymentRequestSuccess', function () {
            _this.loading.dismiss();
            _this.presentAlert('Payment request has been send successfully');
        });
        this.events.subscribe('order:updatePaymentCompleteSuccess', function () {
            _this.loading.dismiss();
            _this.ionViewWillEnter();
            _this.sharedService.presentAlert('Payment status changed to completed successfully');
        });
        ...
        this.events.subscribe('user:assignDeliveryAgentSuccess', function () {
            _this.loading.dismiss();
            _this.presentAlert('Delivery Agent has been assigned successfully!');
        });
    ...
    OrderDetailsPage.prototype.getTotalItems = function () {
        return this.orderData[0].products.length;
    };
    OrderDetailsPage.prototype.onClickConfirmOrder = function () {
    ...
    OrderDetailsPage.prototype.confirmOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    OrderDetailsPage.prototype.onClickDispatchOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    OrderDetailsPage.prototype.dispatchOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading()];
    ...
    OrderDetailsPage.prototype.onClickDeliverOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    OrderDetailsPage.prototype.deliverOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading()];
    ...
    OrderDetailsPage.prototype.onClickReturnOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    OrderDetailsPage.prototype.returnOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading()];
    ...
    OrderDetailsPage.prototype.removeProduct = function (i) {
        this.orderData[0].products.splice(i, 1);
    };
    OrderDetailsPage.prototype.covertTextToUrl = function (text) {
    ...
    OrderDetailsPage.prototype.onClickRejectOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    OrderDetailsPage.prototype.rejectOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading()];
    ...
    OrderDetailsPage.prototype.onClickCancelOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    OrderDetailsPage.prototype.cancelOrder = function (cancelReason) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading()];
    ...
    OrderDetailsPage.prototype.getCancelReason = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    OrderDetailsPage.prototype.isCancelReasonAvailable = function () {
        return 'cancelData' in this.orderData[0] && this.orderData[0].cancelData.reason;
    };
    OrderDetailsPage.prototype.removeProductAlert = function (i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    OrderDetailsPage.prototype.presentAlert = function (msg, action) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    OrderDetailsPage.prototype.presentLoading = function (drn, msg) {
        if (drn === void 0) { drn = 5000; }
    ...
    OrderDetailsPage.prototype.onChangeDeliveryAgent = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    OrderDetailsPage.prototype.sendPaymentRequest = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading()];
    ...
    OrderDetailsPage.prototype.onClickUpdatePaymentComplete = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading()];
    ...
    OrderDetailsPage.prototype.onSetupDeliveryAgent = function () {
        this.router.navigate(['admin-allusers']);
    };
    OrderDetailsPage.prototype.getTime = function (time) {
        return moment__WEBPACK_IMPORTED_MODULE_4__(time).format('hh:mm A');
    };
    OrderDetailsPage.prototype.openOrderInvoice = function (url) {
        var browser = this.inAppBrowser.create(url, '_system');
    };
    OrderDetailsPage.prototype.callUser = function () {
        /* this.callNumber.callNumber(this.orderData[0].address.phoneNo, true)
         .then(res => console.log('Launched dialer!', res))
         .catch(err => console.log('Error launching dialer', err));*/
    };
    OrderDetailsPage.prototype.totalPieces = function (product, i) {
        var pieces = product.quantity * parseInt(product.pack.weight);
        this.orderData[0].products[i]['totalPieces'] = pieces;
        return pieces;
    };
    OrderDetailsPage.prototype.decrementPieces = function (i) {
    ...
    OrderDetailsPage.prototype.incrementPieces = function (i) {
        this.orderData[0].products[i].totalPieces = this.orderData[0].products[i].totalPieces + 1;
        this.orderData[0].products[i].price = this.orderData[0].products[i].totalPieces * this.orderData[0].products[i].pack.perPcPrice;
        var prodPrice = 0;
        this.orderData[0].products.forEach(function (element) {
    ...
    OrderDetailsPage.prototype.getSinglePiecePrice = function (totalPieces, totalAmount) {
        return Math.ceil(totalAmount / totalPieces);
    };
    OrderDetailsPage.prototype.goToPrdouctDetails = function (product) {
        var stateObj = {};
    ...
    OrderDetailsPage.prototype.reviewDate = function () {
    ...
    OrderDetailsPage.prototype.showGenInvoiceBtn = function () {
    ...
    OrderDetailsPage.prototype.generateInvoice = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var invoiceRes;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading(100000, "Generating invoice, please wait...")];
                    case 1:
                        _a.sent();
    ...
    OrderDetailsPage.prototype.openImg = function (url) {
        window.open(url, "_blank");
    };
    OrderDetailsPage.prototype.getFinalAmount = function () {
    ...
    OrderDetailsPage.prototype.isPartialOrder = function () {
    ...
    OrderDetailsPage.prototype.editOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (res) {
                            if (res && res.data) {
                                ...
                                _this.orderData[0]['unavailable'] = res.data.unavailable;
                                _this.orderData[0]['unavailablePrice'] = res.data.unavailablePrice;
                            }
                        });
                        return [4 /*yield*/, modal.present()];
                    case 2:
    ...
    OrderDetailsPage.prototype.showEditOrderBtn = function () {
    ...
    OrderDetailsPage.prototype.getUnavailableProductPrice = function (index) {
    ...
    OrderDetailsPage.prototype.showUnavailablePrice = function () {
    ...
    OrderDetailsPage.prototype.removeSubscriptions = function () {
...
//# sourceMappingURL=admin-admin-shop-all-orders-order-details-order-details-module-es5.js.map