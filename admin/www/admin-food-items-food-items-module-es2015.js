...
let FoodItemsPageModule = class FoodItemsPageModule {
};
...
let FoodItemsPage = class FoodItemsPage {
    constructor(modalController, events, router, loadingController, alertController, filtersService, foodItemService, platform, storage, toastController, brandService, vendorService) {
    ...
    initializeSubscriptions() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.events.subscribe('food-item:publishProductsForAdminProducts', (products) => {
            ...
            this.events.subscribe('food-item:publishAllProductsForAdminProducts', (products) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                this.allProductsData = products;
                this.showNoProducts = false;
                this.showSearchLoader = false;
                if (!this.categories) {
                    this.categories = yield this.foodItemService.getAllCategoriesForSideMenu();
                }
                if (!this.brands) {
                    this.brands = yield this.brandService.getAllBrandsForSideMenu();
                }
                if (!this.allSubcategories) {
                    this.allSubcategories = yield this.foodItemService.getAllSubcategoriesForSideMenu();
                }
                this.exportProducts();
            }));
            this.events.subscribe('food-item:noProductsAvailable', () => {
                if (this.loading) {
                    this.loading.dismiss();
                }
            ...
            this.events.subscribe('food-item:productsForAdminProductsLimitReached', () => {
                if (this.loading) {
                    this.loading.dismiss();
                }
            ...
            this.events.subscribe('food-item:previousProductsForAdminProductsLimitReached', () => {
                if (this.loading) {
                    this.loading.dismiss();
                }
                this.noPreviousProducts = true;
            ...
            // });
            this.events.subscribe('food-item:makeProductCopiesSuccess', () => {
                if (this.loading) {
                    this.loading.dismiss();
                }
                this.presentAlert('', 'Options of the product has been added successfully.');
            });
            this.events.subscribe('food-item:makeProductCopiesFailure', () => {
                if (this.loading) {
                    this.loading.dismiss();
                }
            ...
            this.events.subscribe('food-item:publishSubcategories', (data) => {
                if (this.loading) {
                    this.loading.dismiss();
                }
    ...
    loadMoreCategoryProducts() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.presentLoading();
            const products = yield this.foodItemService.loadMoreCategoryProducts(this.selectedSubcatId);
    ...
    checkForProdLimit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const allProds = yield this.foodItemService.getAllProductsForVendor();
    ...
    selectListItem(i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.dataType == 'categories') {
                ...
                this.noMoreCategoryProducts = false;
                let data = yield this.foodItemService.getCategoryProducts(this.dataList[i].id);
                if (data) {
            ...
            if (this.dataType == 'brands') {
                let data = yield this.foodItemService.getBrandProducts(this.dataList[i].id);
                if (data) {
                    this.productsData = data;
                }
    ...
    selectSubCat(i, j) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.noMoreCategoryProducts = false;
            let data = yield this.foodItemService.getCategoryProducts(this.dataList[i].sublist[j].id);
            if (data) {
                this.productsData = data;
            }
        });
    ...
    selectSubOfSubCat(i, j, k) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.noMoreCategoryProducts = false;
            let data = yield this.foodItemService.getCategoryProducts(this.dataList[i].sublist[j].subOfSubCatList[k].id);
            if (data) {
                this.productsData = data;
            }
        });
...
//# sourceMappingURL=admin-food-items-food-items-module-es2015.js.map