...
var ProductDetailsPage = /** @class */ (function () {
    function ProductDetailsPage(route, router, events, userService, loadingController, platform, modalController, alertController, storage) {
        var _this = this;
        this.route = route;
        this.router = router;
        this.events = events;
        ...
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.productId = _this.router.getCurrentNavigation().extras.state.productId;
    ...
    ProductDetailsPage.prototype.ionViewWillEnter = function () {
        ...
        this.storage.get('listOfProductIdsInCart').then(function (val) {
            ...
            if (val.indexOf(_this.productId) !== -1) {
                _this.showGoToCart = true;
            }
        });
    ...
    ProductDetailsPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('product:publishgetProductWithId', function (productData) {
        ...
        this.events.subscribe('user:orderSuccessfullyPlaced', function () {
            _this.presentAlert('Order Placed! Do you wish to continue Shopping ?');
    ...
    ProductDetailsPage.prototype.decrementQuantity = function () {
        if (this.currentQuantity > 1) {
            this.currentQuantity--;
        }
    };
    ProductDetailsPage.prototype.incrementQuantity = function () {
        this.currentQuantity++;
    };
    ...
    ProductDetailsPage.prototype.buyNowOrder = function () {
        var _this = this;
        ...
        if (userId === '') {
            ...
            this.storage.get('userRole').then(function (role) {
                if (role === 'admin') {
                    _this.adminOrDeliveryOrderAlert("Admin can not place any order!");
                }
                else if (role === 'deliveryAgent') {
                    _this.adminOrDeliveryOrderAlert('Delivery agent can not place any order!');
                }
                else {
                    _this.cartObj.name = _this.data.prodName;
                    _this.cartObj.quantity = _this.currentQuantity;
                    _this.cartObj.img = _this.data.coverPic;
                    _this.cartObj.description = _this.data.prodDesc;
                    _this.cartObj.productId = _this.productId;
                    if (_this.data.discount && _this.data.discount !== '' && _this.data.discount !== '0') {
                        _this.cartObj['price'] = Math.ceil(_this.data.prodPrice - (_this.data.prodPrice * ((_this.data.discount * 1) / 100)));
                    }
                    else {
                        _this.cartObj['price'] = _this.data.prodPrice;
                    }
                    var buyNowOrderProduct = [];
                    buyNowOrderProduct.push(_this.cartObj);
                    _this.storage.set('productsInCart', buyNowOrderProduct);
                    _this.storage.set('buyNowOrder', true);
                    _this.storage.get('userDefaultAddress').then(function (address) {
                        //console.log(address);
                        if (!address) {
    ...
    ProductDetailsPage.prototype.goToCart = function () {
        ...
        if (userId === '') {
            ...
            this.storage.get('userRole').then(function (role) {
                if (role === 'admin') {
                    _this.adminOrDeliveryOrderAlert('Cart is available only for user not for admin.');
                }
                else if (role === 'deliveryAgent') {
                    _this.adminOrDeliveryOrderAlert('Cart is available only for user not for delivery agent.');
                }
                else {
                    var navigationExtras = {
                        state: {
    ...
    ProductDetailsPage.prototype.imageZoom = function (images, index) {
    ...
    ProductDetailsPage.prototype.presentAlert = function (desc) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alertController.create({
                            ...
                            buttons: [{
                                    ...
                                    text: 'Check My Order',
                                    handler: function () {
                                        _this.router.navigate(['chat-bot']);
                                    }
                                }]
                        })];
                    case 1:
    ...
    ProductDetailsPage.prototype.cartAlert = function (desc) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ProductDetailsPage.prototype.adminOrDeliveryOrderAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ProductDetailsPage.prototype.priceListAddToCart = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var userId;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                if (userId === '') {
                    ...
                    this.storage.get('userRole').then(function (role) {
                        if (role === 'admin') {
                            ...
                            var listOfWeights = [];
                            for (var i = 0; i < _this.data.priceList.length; i++) {
                                listOfWeights.push(_this.data.priceList[i].weight);
                            }
                            _this.data.priceList.map(function (entry) {
                                entry.quantity = 0;
                            });
    ...
    ProductDetailsPage.prototype.openBuyNowPriceListModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var userId;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ProductDetailsPage.prototype.getDiscountedProduct = function (price, discount) {
        var discountedPrice = Math.ceil(price - (price * ((discount * 1) / 100)));
        return discountedPrice;
    };
    ProductDetailsPage.prototype.removeSubscriptions = function () {
