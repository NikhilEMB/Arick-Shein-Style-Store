...
let BroadcastMsgPageModule = class BroadcastMsgPageModule {
};
...
let BroadcastMsgPage = class BroadcastMsgPage {
    constructor(router, events, actionSheetController, camera, imagePicker, loadingController, alertController, modalController, toastController, labelService, configService, userGroupsService, managerService, storage) {
        this.router = router;
        this.events = events;
...
BroadcastMsgPage.ctorParameters = () => [
...
//# sourceMappingURL=admin-admin-home-broadcast-msg-broadcast-msg-module-es2015.js.map