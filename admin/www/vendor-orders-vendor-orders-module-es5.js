...
var VendorOrdersPageModule = /** @class */ (function () {
    function VendorOrdersPageModule() {
    }
...
var VendorOrdersPage = /** @class */ (function () {
    function VendorOrdersPage(router, configService, navController, vendorService, modalController, storage, sharedService, alertController) {
        this.router = router;
    ...
    VendorOrdersPage.prototype.ngOnInit = function () {
    ...
    VendorOrdersPage.prototype.loadOrders = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.showLoader = true;
                        _a = this;
                        return [4 /*yield*/, this.vendorService.getOrders()];
                    case 1:
                        _a.orders = _b.sent();
    ...
    VendorOrdersPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, multiVendorSettings;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.checkVendorAccess()];
                    case 1:
                        _b.sent();
                        this.showLoader = true;
                        _a = this;
                    ...
                    case 2:
                        _a.orders = _b.sent();
                        this.ordersSub = this.vendorService.getVendorOrdersListener().subscribe(function (orders) {
                            _this.orders = orders;
                        });
                        this.showLoader = false;
                        return [4 /*yield*/, this.vendorService.getActiveStatus('service')];
                    case 3:
                        multiVendorSettings = _b.sent();
    ...
    VendorOrdersPage.prototype.checkVendorAccess = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, vendor;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.sharedService.presentAlert("vendor not found!")];
                    case 3:
                        _b.sent();
    ...
    VendorOrdersPage.prototype.checkVendorMembershipAccess = function (vendor) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var response;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.vendorService.getVendorMembership()];
                    case 1:
                        response = _a.sent();
                        console.log("vendor", vendor);
                        if (!response.active) {
    ...
    VendorOrdersPage.prototype.ionViewWillLeave = function () {
        this.vendorService.unsubscribeVendorOrderSub();
        this.ordersSub.unsubscribe();
    };
    VendorOrdersPage.prototype.getImgUrl = function (img) {
        if (img.mob) {
            return 'mob';
        }
        if (!img.mob && img.url) {
    ...
    VendorOrdersPage.prototype.onClickViewDetails = function (order) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                    ...
                                    if (res.data.isUpdated) {
                                        if (this.orders.length) {
                                            for (_i = 0, _a = this.orders; _i < _a.length; _i++) {
                                                order_1 = _a[_i];
                                                if (order_1.id === res.data.id) {
                                                    console.log("order.id", order_1.id);
                                                    console.log("res.data.id", res.data.id);
                                                    order_1.originalProducts = res.data.products;
                                                    order_1.products = res.data.products;
                                                    order_1.vendors = res.data.vendors;
                                                    break;
                                                }
                                            }
                                        }
    ...
    VendorOrdersPage.prototype.loadMoreOrders = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var orders;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.vendorService.loadMoreOrders()];
                    case 1:
                        orders = _a.sent();
                        setTimeout(function () {
    ...
    VendorOrdersPage.prototype.checkProductToDeliver = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var uid, navigationExtras;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    VendorOrdersPage.prototype.downloadInvoice = function (order) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _i, _a, vendor;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                console.log('order:', order);
                for (_i = 0, _a = order.vendors; _i < _a.length; _i++) {
                    vendor = _a[_i];
    ...
    VendorOrdersPage.prototype.isSubOrMembershipOrder = function (order) {
    ...
    VendorOrdersPage.prototype.goToManageShipment = function (id, order) {
    ...
    VendorOrdersPage.prototype.createOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    VendorOrdersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=vendor-orders-vendor-orders-module-es5.js.map