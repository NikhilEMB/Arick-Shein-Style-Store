...
var WhatsappSettingsPageModule = /** @class */ (function () {
    function WhatsappSettingsPageModule() {
    }
    ...
    return WhatsappSettingsPageModule;
}());
...
var WhatsappSettingsPage = /** @class */ (function () {
    function WhatsappSettingsPage(WhatsappDashboardService, sharedService) {
    ...
    WhatsappSettingsPage.prototype.ngOnInit = function () { };
    WhatsappSettingsPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.WhatsappDashboardService.getWhatsappCredentials()];
                    case 1:
                        _a.whatsappDashboardData = _b.sent();
    ...
    WhatsappSettingsPage.prototype.isValidCredentials = function () {
    ...
    WhatsappSettingsPage.prototype.saveWhatsappCredentials = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var validCredentials, success;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        validCredentials = this.isValidCredentials();
                        if (!validCredentials) {
                            this.sharedService.presentAlert('Please fill all credentials');
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, this.WhatsappDashboardService.saveWhatsappCredentials(this.credentials)];
                    case 1:
                        success = _a.sent();
                        if (success) {
    ...
    WhatsappSettingsPage.prototype.changeComponent = function (index) {
        this.selectedId = index.toString();
    };
    WhatsappSettingsPage.prototype.syncProducts = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.WhatsappDashboardService.syncProducts()];
                    case 1:
                        _a.sent();
    ...
    WhatsappSettingsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-whatsapp-whatsapp-settings-whatsapp-settings-module-es5.js.map