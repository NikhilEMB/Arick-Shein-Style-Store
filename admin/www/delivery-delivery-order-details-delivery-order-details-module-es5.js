...
var DeliveryOrderDetailsPageModule = /** @class */ (function () {
    function DeliveryOrderDetailsPageModule() {
    }
    ...
    return DeliveryOrderDetailsPageModule;
}());
...
var DeliveryOrderDetailsPage = /** @class */ (function () {
    function DeliveryOrderDetailsPage(events, router, alertController, loadingController, navCtrl, route, storage) {
        var _this = this;
        this.events = events;
        this.router = router;
    ...
    DeliveryOrderDetailsPage.prototype.ngOnInit = function () {
    };
    DeliveryOrderDetailsPage.prototype.ionViewWillEnter = function () {
        this.events.publish('user:getOrderDetailsWithOrderId', this.orderId);
        this.initializeSubscriptions();
    };
    DeliveryOrderDetailsPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    DeliveryOrderDetailsPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        ...
        this.events.subscribe('user:cancelledOrderByUserSuccessfully', function (orderData) {
            _this.loading.dismiss();
            _this.presentAlert('Order has been cancelled successfully');
        });
    ...
    DeliveryOrderDetailsPage.prototype.cancelOrder = function () {
    ...
    DeliveryOrderDetailsPage.prototype.getTotalItems = function () {
        return this.orderData[0].products.length;
    };
    DeliveryOrderDetailsPage.prototype.scrollToBottom = function () {
        this.content.scrollToBottom(500);
    };
    DeliveryOrderDetailsPage.prototype.goToPrdouctDetails = function (id) {
    ...
    DeliveryOrderDetailsPage.prototype.onClickCancelOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
    ...
    DeliveryOrderDetailsPage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DeliveryOrderDetailsPage.prototype.onClickStartNavigation = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    DeliveryOrderDetailsPage.prototype.onClickContinueNavigation = function () {
        var navigationextras = {
            state: {
    ...
    DeliveryOrderDetailsPage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    DeliveryOrderDetailsPage.prototype.callUser = function () {
        /* this.callNumber.callNumber(this.orderData[0].address.phoneNo, true)
         .then(res => console.log('Launched dialer!', res))
         .catch(err => console.log('Error launching dialer', err));*/
    };
    DeliveryOrderDetailsPage.prototype.removeSubscriptions = function () {
    ...
    DeliveryOrderDetailsPage.ctorParameters = function () { return [
    ...
    return DeliveryOrderDetailsPage;
}());
...
//# sourceMappingURL=delivery-delivery-order-details-delivery-order-details-module-es5.js.map