...
var ShopCategoriesPageModule = /** @class */ (function () {
    function ShopCategoriesPageModule() {
    }
    ...
    return ShopCategoriesPageModule;
}());
...
var ShopCategoriesPage = /** @class */ (function () {
    function ShopCategoriesPage(events, router, loadingController, toastController, platform, storage, userService, modalController, alertController, chatService) {
        this.events = events;
        this.router = router;
    ...
    ShopCategoriesPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        ...
        this.storage.get('storeInfo').then(function (data) {
            _this.storeInfo = data.storeInfo;
            _this.allowStoreInfo = data.allowStoreInfo;
        });
        this.events.publish('banners:getBannersActiveStatus');
        this.events.publish('best-sellers:getBestSellersActiveStatus');
    };
    ShopCategoriesPage.prototype.willEnterSubscriptions = function () {
        var _this = this;
        this.events.subscribe('makeUnreadAdminMsgsZero', function () {
            _this.unreadAdminMsgs = 0;
        });
        this.backButtonSubscription = this.platform.backButton.subscribeWithPriority(0, function () {
        ...
        this.events.subscribe('user:publishUserCartProducts', function (cartProducts) {
            ...
            _this.cartLength = cartProducts.length;
            //console.log('cartProducts', this.cartProducts);
            var price = 0;
            for (var index = 0; index < cartProducts.length; index++) {
                price += cartProducts[index].price * cartProducts[index].quantity;
            }
            _this.cartTotalPrice = price;
        });
        this.events.subscribe('user:noProductsInCart', function () {
            _this.cartTotalPrice = 0;
            _this.cartLength = 0;
            _this.events.publish('best-sellers:getBestSellersForShopCategory');
        });
        this.events.subscribe('banners:publishBannersActiveStatus', function (status) {
            //console.log('status from db', status);
            if (!_this.isEmptyObj(status)) {
                _this.bannersActiveStatus = status.isActive;
            }
            else {
                _this.bannersActiveStatus = true;
            }
    ...
    ShopCategoriesPage.prototype.ionViewWillLeave = function () {
    ...
    ShopCategoriesPage.prototype.ngOnInit = function () {
        var _this = this;
        this.initializeSubscriptions();
        //console.log('in ngOnInit of shop category');
        this.events.publish('banners:getSubscribedBanners');
        setTimeout(function () {
            _this.events.publish('product:getAllSubscribedCategories');
        }, 500);
        this.storage.get('listOfProductIdsInCart').then(function (val) {
            _this.listOfProductIdsInCart = val;
            _this.events.publish('best-sellers:getBestSellersForShopCategory');
        });
    };
    ShopCategoriesPage.prototype.ngOnDestroy = function () {
        //console.log('ng destroy of category');
        this.removeSubscriptions();
    };
    ShopCategoriesPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('product:publishAllSubscribedCategories', function (categories) {
        ...
        this.events.subscribe('auth:logoutSuccess', function () {
            _this.logoutAlert('Logged out successfully');
        });
        this.events.subscribe('banners:publishSubscribedBanners', function (banners) {
            if (banners && banners.length) {
                var banners_sort_asc = function (a, b) {
                    var i1 = parseInt(a.id.slice(5));
                    var i2 = parseInt(b.id.slice(5));
                    if (i1 > i2) {
                        return 1;
                    }
                    ;
        ...
        this.events.subscribe('best-sellers:publishBestSellersForShopCategory', function (bestSellers) {
            bestSellers.forEach(function (element) {
    ...
    ShopCategoriesPage.prototype.isEmptyObj = function (object) {
    ...
    ShopCategoriesPage.prototype.onClickCategory = function (category) {
    ...
    ShopCategoriesPage.prototype.presentLoading = function () {
    ...
    ShopCategoriesPage.prototype.goToChat = function (fromfab) {
        var _this = this;
    ...
    ShopCategoriesPage.prototype.onClickCart = function () {
        var _this = this;
        var userId = this.userService.getUserId();
        //console.log('uid in sc', userId);
        if (userId === '') {
    ...
    ShopCategoriesPage.prototype.fireSearchQuery = function () {
        //console.log('in fireSearchQuery...');
        this.events.publish('search-engine:searchCategory', this.searchCategory);
    };
    ShopCategoriesPage.prototype.presentToast = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ShopCategoriesPage.prototype.logoutAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alertController.create({
                            ...
                            buttons: [{
                                    ...
                                    handler: function () {
                                        _this.cartLength = 0;
                                        for (var index = 0; index < _this.bsProducts.length; index++) {
                                            _this.bsProducts[index].inCart = false;
                                        }
                                    }
                                }
                            ]
    ...
    ShopCategoriesPage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ShopCategoriesPage.prototype.onImageLoad = function () {
        //console.log('image ready');
    };
    ShopCategoriesPage.prototype.bsProdcutQuantityInCart = function (id) {
    ...
    ShopCategoriesPage.prototype.bsProdcutDataInCart = function (id) {
        if (this.cartProducts.length) {
            for (var index = 0; index < this.cartProducts.length; index++) {
                if (this.cartProducts[index].productId === id) {
    ...
    ShopCategoriesPage.prototype.decrementQuantity = function (id, index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = this.bsProdcutDataInCart(id);
    ...
    ShopCategoriesPage.prototype.incrementQuantity = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ShopCategoriesPage.prototype.removeProduct = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ShopCategoriesPage.prototype.addToCart = function (product, index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var userId;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ShopCategoriesPage.prototype.onClickProduct = function (id) {
        var navigationExtras = {
            state: {
                productId: id
            }
    ...
    ShopCategoriesPage.prototype.priceListAddToCart = function (product) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var userId;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ShopCategoriesPage.prototype.getDiscountedProduct = function (price, discount) {
        var discountedPrice = Math.ceil(price - (price * ((discount * 1) / 100)));
        return discountedPrice;
    };
    ShopCategoriesPage.prototype.removeSubscriptions = function () {
    ...
    ShopCategoriesPage.ctorParameters = function () { return [
...
//# sourceMappingURL=shop-shop-categories-shop-categories-module-es5.js.map