...
let VouchersPageModule = class VouchersPageModule {
};
...
let VouchersPage = class VouchersPage {
    constructor(modalController, events, router, loadingController, alertController, filtersService, voucherService, platform, storage, toastController, brandService, vendorService) {
    ...
    initializeSubscriptions() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.events.subscribe('voucher:publishProductsForAdminProducts', (products) => {
            ...
            this.events.subscribe('voucher:publishAllProductsForAdminProducts', (products) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                this.allProductsData = products;
                this.showNoProducts = false;
                this.showSearchLoader = false;
                if (!this.categories) {
                    this.categories = yield this.voucherService.getAllCategoriesForSideMenu();
                }
                if (!this.brands) {
                    this.brands = yield this.brandService.getAllBrandsForSideMenu();
                }
                if (!this.allSubcategories) {
                    this.allSubcategories = yield this.voucherService.getAllSubcategoriesForSideMenu();
                }
                this.exportProducts();
            }));
            this.events.subscribe('voucher:noProductsAvailable', () => {
                if (this.loading) {
                    this.loading.dismiss();
                }
            ...
            this.events.subscribe('voucher:productsForAdminProductsLimitReached', () => {
                if (this.loading) {
                    this.loading.dismiss();
                }
            ...
            this.events.subscribe('voucher:previousProductsForAdminProductsLimitReached', () => {
                if (this.loading) {
                    this.loading.dismiss();
                }
                this.noPreviousProducts = true;
            ...
            // });
            this.events.subscribe('voucher:makeProductCopiesSuccess', () => {
                if (this.loading) {
                    this.loading.dismiss();
                }
                this.presentAlert('', 'Options of the product has been added successfully.');
            });
            this.events.subscribe('voucher:makeProductCopiesFailure', () => {
                if (this.loading) {
                    this.loading.dismiss();
                }
            ...
            this.events.subscribe('voucher:publishSubcategories', (data) => {
                if (this.loading) {
                    this.loading.dismiss();
                }
    ...
    loadMoreCategoryProducts() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.presentLoading();
            const products = yield this.voucherService.loadMoreCategoryProducts(this.selectedSubcatId);
    ...
    checkForProdLimit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const allProds = yield this.voucherService.getAllProductsForVendor();
    ...
    selectListItem(i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.dataType == 'categories') {
                ...
                this.noMoreCategoryProducts = false;
                let data = yield this.voucherService.getCategoryProducts(this.dataList[i].id);
                if (data) {
            ...
            if (this.dataType == 'brands') {
                let data = yield this.voucherService.getBrandProducts(this.dataList[i].id);
                if (data) {
                    this.productsData = data;
                }
    ...
    selectSubCat(i, j) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.noMoreCategoryProducts = false;
            let data = yield this.voucherService.getCategoryProducts(this.dataList[i].sublist[j].id);
            if (data) {
                this.productsData = data;
            }
        });
    ...
    selectSubOfSubCat(i, j, k) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.noMoreCategoryProducts = false;
            let data = yield this.voucherService.getCategoryProducts(this.dataList[i].sublist[j].subOfSubCatList[k].id);
            if (data) {
                this.productsData = data;
            }
        });
...
//# sourceMappingURL=admin-vouchers-vouchers-module-es2015.js.map