...
let CouponCodesPageModule = class CouponCodesPageModule {
};
...
let CouponCodesPage = class CouponCodesPage {
    constructor(events, router, loadingController, sharedService, alertController, couponCodesService) {
        this.events = events;
        this.router = router;
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const couponDetails = yield this.couponCodesService.getCouponDetails();
            if (couponDetails) {
...
CouponCodesPage.ctorParameters = () => [
...
//# sourceMappingURL=admin-coupon-codes-coupon-codes-module-es2015.js.map