...
var DeliveryAgentDetailsPageModule = /** @class */ (function () {
    function DeliveryAgentDetailsPageModule() {
    }
    ...
    return DeliveryAgentDetailsPageModule;
}());
...
var DeliveryAgentDetailsPage = /** @class */ (function () {
    function DeliveryAgentDetailsPage(router, route, userService, configService, modalController, sharedService) {
        var _this = this;
        this.router = router;
        this.route = route;
        ...
        this.route.queryParams.subscribe(function () {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.userId = _this.router.getCurrentNavigation().extras.state.uid;
                _this.userData = _this.router.getCurrentNavigation().extras.state.udata;
            }
        });
    }
    DeliveryAgentDetailsPage.prototype.ngOnInit = function () {
        this.sideMenu.push('Pending', 'Delivered');
        this.currencyCode = this.configService.environment.currencyCode;
    };
    DeliveryAgentDetailsPage.prototype.ionViewDidEnter = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.getUnAssignOrders()];
                    case 2:
                        // this.ordersData = await this.userService.getDeliveryAgentOrders(this.userId);
                        _a.sent();
    ...
    DeliveryAgentDetailsPage.prototype.initSubscription = function () {
        var _this = this;
        this.unAssignOrdersSub = this.userService.getUnassignOrdersListener().subscribe(function (data) {
            console.log("unAssignOrdersSub", data);
            if (data && data.length > 0) {
                _this.unAssignOrders = data;
            }
        });
        this.assignOrdersSub = this.userService.getAssignedOrdersListener().subscribe(function (data) {
            // this.assignOrders = data;
            _this.ordersData = data;
            console.log("assignOrdersSub", data);
            if (data && data.length > 0) {
                _this.changeComponent(0);
            }
        });
    };
    DeliveryAgentDetailsPage.prototype.ionViewDidLeave = function () {
    ...
    DeliveryAgentDetailsPage.prototype.getAssignedOrders = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _b.sent();
                        _a = this;
                        return [4 /*yield*/, this.userService.getDeliveryAgentOrders(this.userId)];
                    case 2:
                        _a.ordersData = _b.sent();
    ...
    DeliveryAgentDetailsPage.prototype.changeComponent = function (index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.activeTile = index;
                        return [4 /*yield*/, this.filterOrder()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    DeliveryAgentDetailsPage.prototype.filterOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var result, result;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        if (!this.ordersData) return [3 /*break*/, 6];
                        this.orders = [];
                        if (!(this.activeTile == 0)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.ordersData.filter(function (order) { return ['Confirmed', 'Dispatched'].includes(order.status); })];
                    case 2:
                        result = _a.sent();
                        this.orders = result;
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.ordersData.filter(function (order) { return order.status == 'Delivered'; })];
                    case 4:
                        result = _a.sent();
                        this.orders = result;
                        _a.label = 5;
    ...
    DeliveryAgentDetailsPage.prototype.onClickViewDetails = function (id, index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (res) {
                            ...
                            if (res && res.data && res.data.status) {
                                _this.orders[index].status = res.data.status;
                            }
                        });
    ...
    DeliveryAgentDetailsPage.prototype.onClickTrackOrder = function (agentId, deliveryLatLng) {
    ...
    DeliveryAgentDetailsPage.prototype.getPendingOrdersPdf = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var getPdf, _i, _a, order, res;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        getPdf = false;
                        for (_i = 0, _a = this.orders; _i < _a.length; _i++) {
                            order = _a[_i];
    ...
    DeliveryAgentDetailsPage.prototype.showOrder = function (order) {
    ...
    DeliveryAgentDetailsPage.prototype.getUnAssignOrders = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var responseUnAssignOrders;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.getAllOrders(this.userId)];
                    case 1:
                        responseUnAssignOrders = _a.sent();
    ...
    DeliveryAgentDetailsPage.prototype.saveAssignOrders = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var response;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        if (!(this.selectedOrders.length > 0)) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.userService.assignDeliveryAgentToOrders(this.userId, this.selectedOrders)];
                    case 2:
                        response = _a.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.sharedService.presentAlert("Delivery Agent assigned successfully")];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.sharedService.presentAlert("Delivery Agent not assigned")];
                    case 6:
                        _a.sent();
                        _a.label = 7;
                    case 7: return [3 /*break*/, 11];
                    case 8: return [4 /*yield*/, this.sharedService.loading.dismiss()];
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, this.sharedService.presentAlert("Please select a order")];
                    case 10:
                        _a.sent();
                        _a.label = 11;
    ...
    //   }
    // }
    DeliveryAgentDetailsPage.prototype.searchOrderById = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        if (!!isNaN(parseInt(this.searchOrder))) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.userService.returnOrderWithOrderId(parseInt(this.searchOrder), this.userId)];
                    case 2:
                        data = _a.sent();
    ...
    DeliveryAgentDetailsPage.prototype.resetSearch = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sharedService.presentLoading()];
    ...
    DeliveryAgentDetailsPage.prototype.selectAllOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _i, _a, item;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (this.isAllOrderSelect) {
                            this.selectedOrders = [];
                            for (_i = 0, _a = this.unAssignOrders; _i < _a.length; _i++) {
                                item = _a[_i];
    ...
    DeliveryAgentDetailsPage.prototype.onClickCheckBox = function (id) {
        if (this.selectedOrders.indexOf(id) === -1) {
            this.selectedOrders.push(id);
        }
        else {
            var index = this.selectedOrders.indexOf(id);
            this.selectedOrders.splice(index, 1);
        }
        console.log("order selected: ", this.selectedOrders);
    };
    DeliveryAgentDetailsPage.prototype.editCheckBoxValue = function (id) {
        if (this.selectedOrders.indexOf(id) !== -1) {
            return true;
        }
        else {
    ...
    DeliveryAgentDetailsPage.ctorParameters = function () { return [
    ...
    return DeliveryAgentDetailsPage;
}());
...
//# sourceMappingURL=admin-delivery-agent-details-delivery-agent-details-module-es5.js.map