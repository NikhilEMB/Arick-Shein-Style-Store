...
let CustomLanguagePageModule = class CustomLanguagePageModule {
};
...
let CustomLanguagePage = class CustomLanguagePage {
    constructor(fb, customLanguageService, alertController, loadingController) {
        this.fb = fb;
    ...
    onGet() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.languageResult = yield this.customLanguageService.getCustomLanguage(this.getLanguageData.value);
            if (this.loading) {
...
CustomLanguagePage.ctorParameters = () => [
...
let CustomLanguageService = class CustomLanguageService {
    constructor(afs) {
        this.afs = afs;
    }
    setCustomLanguage(formData) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                ...
                const docRef = yield this.afs.collection('advanced').doc(platform).collection(languageCode).doc(parentKeyName);
    ...
    getCustomLanguage(data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                ...
                data = yield getDocRef.valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["first"])()).toPromise();
                // if(data){
                //   console.log("no Data");
                // }
                resolve(data);
    ...
    updateCustomLanguage(formData, result) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
...
CustomLanguageService.ctorParameters = () => [
...
//# sourceMappingURL=admin-custom-language-custom-language-module-es2015.js.map