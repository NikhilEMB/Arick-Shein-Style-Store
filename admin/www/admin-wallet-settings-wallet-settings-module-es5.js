...
var WalletSettingsPageModule = /** @class */ (function () {
    function WalletSettingsPageModule() {
    }
    ...
    return WalletSettingsPageModule;
}());
...
var WalletSettingsPage = /** @class */ (function () {
    function WalletSettingsPage(events, loadingController, alertController, toastController, router) {
        this.events = events;
    ...
    WalletSettingsPage.prototype.ngOnInit = function () {
        this.initializeSubscriptions();
        this.events.publish('wallet:getWalletSettings');
        this.events.publish('wallet:getCashbackList');
    };
    WalletSettingsPage.prototype.ngOnDestroy = function () {
        this.removeSubscriptions();
    };
    WalletSettingsPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('wallet:publishWalletSettings', function (data) {
            if (!_this.isEmptyObj(data)) {
                _this.active = typeof data.active !== 'undefined' ? data.active : true;
                _this.maxUserWalletAmnt = data.maxUserWalletAmnt ? data.maxUserWalletAmnt : 10000;
                _this.minOrderAmnt = data.minOrderAmnt ? data.minOrderAmnt : 0;
                _this.maxWalletAmntPerOrder = data.maxWalletAmntPerOrder ? data.maxWalletAmntPerOrder : 1000;
                _this.newUserWalletAmnt = data.newUserWalletAmnt ? data.newUserWalletAmnt : 0;
            }
            _this.showLoader = false;
        });
        this.events.subscribe('wallet:saveWalletSettingsSuccess', function () {
            _this.loading.dismiss();
            _this.presentAlert('Wallet settings saved successfully!');
        });
        this.events.subscribe('wallet:publishCashbackList', function (data) {
            _this.cashbacks = data;
            _this.showCashbackLoader = false;
        });
        this.events.subscribe('wallet:addNewCashbackSuccess', function () {
            _this.loading.dismiss();
            _this.presentAlert('Cashback added successfully!');
        });
        this.events.subscribe('wallet:deleteCashbackSuccess', function () {
            _this.loading.dismiss();
            _this.presentAlert('Cashback deleted successfully!');
        });
        this.events.subscribe('wallet:addAmountToUsersByAdminSuccess', function (msg) {
            _this.loading.dismiss();
            _this.presentAlert(msg);
        });
    };
    WalletSettingsPage.prototype.isEmptyObj = function (object) {
    ...
    WalletSettingsPage.prototype.saveWalletSettings = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var wallet;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.maxUserWalletAmnt > 10000)) return [3 /*break*/, 1];
                        this.presentAlert('Maximum amount in user wallet should be less than or equal to Rs.10000');
                        return [3 /*break*/, 4];
                    case 1:
                        if (!!this.maxUserWalletAmnt) return [3 /*break*/, 2];
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.presentLoading('Please wait...', 5000)];
                    case 3:
                        _a.sent();
    ...
    WalletSettingsPage.prototype.walletActiveToggle = function () {
        this.active = !this.active;
    };
    WalletSettingsPage.prototype.addNewCashback = function (cashbackData) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading('Adding new cashback', 5000)];
                    case 1:
                        _a.sent();
    ...
    WalletSettingsPage.prototype.addCashbackAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                                ...
                                buttons: [
                                    {
                                        ...
                                        text: 'Add',
                                        handler: function (cashbackData) {
                                            if (!parseInt(cashbackData.orderAmnt) || !parseInt(cashbackData.cashback) || !parseInt(cashbackData.perUser)) {
                                                _this.presentToast('Please enter valid data');
                                            }
                                            else {
                                                _this.addNewCashback(cashbackData);
                                            }
                                        }
                                    }
                                ]
                    ...
                    case 1:
                        _a.cashbackAlert = _b.sent();
                        return [4 /*yield*/, this.cashbackAlert.present()];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    WalletSettingsPage.prototype.deleteCashbackConfirm = function (cid) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    WalletSettingsPage.prototype.deleteCashback = function (cid) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading('Please wait...', 5000)];
                    case 1:
                        _a.sent();
    ...
    WalletSettingsPage.prototype.showEditToast = function () {
        this.presentToast('Cashback data can not be edit. Delete and add desired cashback.');
    };
    WalletSettingsPage.prototype.addAmountToUsersByAdmin = function (amount) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.presentLoading('Adding money...', 20000)];
                    case 1:
                        _a.sent();
    ...
    WalletSettingsPage.prototype.addWalletAmountAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (amnt) {
                                        if (!amnt.amount) {
                                            ...
                                            _this.addAmountToUsersByAdmin(parseInt(amnt.amount));
                                        }
                                    }
                                }
                            ]
    ...
    WalletSettingsPage.prototype.presentAlert = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    WalletSettingsPage.prototype.presentLoading = function (msg, duration) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    WalletSettingsPage.prototype.presentToast = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    WalletSettingsPage.prototype.removeSubscriptions = function () {
    ...
    WalletSettingsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-wallet-settings-wallet-settings-module-es5.js.map