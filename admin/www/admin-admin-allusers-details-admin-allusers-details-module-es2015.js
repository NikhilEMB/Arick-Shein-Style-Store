...
let AdminAllusersDetailsPageModule = class AdminAllusersDetailsPageModule {
};
...
let AdminAllusersDetailsPage = class AdminAllusersDetailsPage {
    constructor(events, loadingController, alertController, toastController, router, route, labelService, configService, userService, userDetailService, userGroupsService, modalController, walletService
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.uid) {
                ...
                this.pointTransactions = yield this.walletService.getPointTransactions(this.uid);
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.cartItems = yield this.userDetailService.getCartItems(this.uid);
            if (this.configService.environment.userAnalyticsLimit) {
                this.showLimit = yield this.configService.environment.userAnalyticsLimit;
            }
    ...
    onChangeDeliveryAgent(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.presentLoading(this.SHARED_LABELS['please_wait']);
    ...
    addMoneyToSingleUserWallet(data, type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.presentLoading('Adding money...');
            this.events.publish('wallet:addMoneyToSingleUserWallet', data, this.uid, type);
        });
    }
    chargeUserAlert(moneyType) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (moneyType == "wallet") {
                if (!this.balance) {
    ...
    chargeUser(charge, moneyType) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.presentLoading('Charging user...');
    ...
    saveAdditonalInfo() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.presentLoading("Please wait, saving information");
    ...
    removeAgent() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let removeResult = yield this.userService.removeDefaultAgent(this.uid);
            if (removeResult) {
    ...
    getCartItems() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.showWarning = false;
            this.searchItems = yield this.userDetailService.getCartItems(this.uid);
            this.currentTab = 'cart';
            if (this.cartItems.length > this.showLimit) {
                this.cartItems = this.cartItems.slice(0, this.showLimit);
                this.showWarning = true;
    ...
    getSearches() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.showWarning = false;
            this.searchItems = yield this.userDetailService.getSearchItems(this.uid);
    ...
    saveUserData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!this.udata.name) {
                ...
                let updateResult = yield this.userDetailService.saveUserDetails(this.uid, this.udata, this.addresses);
                if (updateResult) {
...
AdminAllusersDetailsPage.ctorParameters = () => [
...
//# sourceMappingURL=admin-admin-allusers-details-admin-allusers-details-module-es2015.js.map