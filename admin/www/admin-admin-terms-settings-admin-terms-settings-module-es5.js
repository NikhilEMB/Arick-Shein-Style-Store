...
var AdminTermsSettingsPageModule = /** @class */ (function () {
    function AdminTermsSettingsPageModule() {
    }
    ...
    return AdminTermsSettingsPageModule;
}());
...
var AdminTermsSettingsPage = /** @class */ (function () {
    function AdminTermsSettingsPage(platform, events, loadingController, alertController) {
    ...
    AdminTermsSettingsPage.prototype.ngOnInit = function () {
        this.initializeSubscriptions();
        this.events.publish('admin-settings:getTermsAndPrivacyData');
        var devHeight = this.platform.height();
        var editorHeight = devHeight - 245;
        this.ckeConfig = {
            allowedContent: true,
            height: editorHeight
        };
    };
    AdminTermsSettingsPage.prototype.ngOnDestroy = function () {
        this.removeSubscriptions();
    };
    AdminTermsSettingsPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('admin-settings:saveTermsAndPrivacySuccess', function () {
        ...
        this.events.subscribe('admin-settings:publishTermsAndPrivacyData', function (data) {
            ...
            if (data) {
                ...
                _this.cancelContent = data.cancel;
                _this.refundContent = data.refund;
                _this.shippingContent = data.shipping;
                _this.termsActiveStatus = data.termsActiveStatus;
                _this.privacyActiveStatus = data.privacyActiveStatus;
                _this.cancelActiveStatus = data.cancelActiveStatus;
                _this.refundActiveStatus = data.refundActiveStatus;
                _this.shippingActiveStatus = data.shippingActiveStatus;
            }
        });
    };
    AdminTermsSettingsPage.prototype.onClickSaveTermsSettings = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var termsAndPrivacyData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.termsContent === '')) return [3 /*break*/, 1];
                        this.presentAlert('Please enter some Terms!');
                        return [3 /*break*/, 4];
                    case 1:
                        if (!(this.privacyContent === '')) return [3 /*break*/, 2];
    ...
    AdminTermsSettingsPage.prototype.presentAlert = function (desc) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    AdminTermsSettingsPage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    AdminTermsSettingsPage.prototype.removeSubscriptions = function () {
    ...
    AdminTermsSettingsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-admin-terms-settings-admin-terms-settings-module-es5.js.map