...
let PickupDropPageModule = class PickupDropPageModule {
};
...
let PickupDropPage = class PickupDropPage {
    constructor(labelService, loadingController, alertController, toastController, configService, router, pickUp, modalController) {
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let currentData = yield this.pickUp.getPickUpSettings();
            console.log("Data->>", currentData['weightSlab']['active']);
            this.allDeliveryAgents = yield this.pickUp.getAllDeliveryAgents();
    ...
    saveSettings() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let walletSettings = yield this.pickUp.getWalletSettings();
            if (walletSettings['active'] == true) {
                if (this.deliveryByWeight.baseCost == undefined || this.deliveryByWeight.baseWeight == undefined || this.deliveryByWeight.cost == undefined || this.deliveryByKm.cost == undefined) {
                    ...
                    let pickUpSettings = Object.assign({}, gstObj, activeObj, this.deliveryByWeight, this.deliveryByKm, weightSlabs, slabData);
                    console.log(pickUpSettings);
                    if (yield this.pickUp.setPickUpSettings(pickUpSettings)) {
                        this.presentAlert('Settings saved successfully');
                    }
                }
            }
            else {
                yield this.presentAlert('Please turn on your wallet from wallet settings page to enable this feature');
            }
        });
    }
    getPendingOrders() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.previousId = 'status1';
            this.ordersList = yield this.pickUp.getPendingOrders();
    ...
    getPickedOrders() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.ordersList = yield this.pickUp.getPickedOrders();
            let objDiv = document.getElementById("scroll2");
            if (objDiv) {
                objDiv.scrollTop = 0;
            }
    ...
    getDeliveredOrders() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.ordersList = yield this.pickUp.getDeliveredOrders();
            let objDiv = document.getElementById("scroll2");
            if (objDiv) {
                objDiv.scrollTop = 0;
            }
    ...
    getCancelledOrders() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.ordersList = yield this.pickUp.getCancelledOrders();
            let objDiv = document.getElementById("scroll2");
            if (objDiv) {
                objDiv.scrollTop = 0;
            }
    ...
    onClickViewDetails(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.orderData = yield this.pickUp.getOrderData(id);
            if (this.orderData[0].delivery.agentId) {
                let data = yield this.pickUp.getDeliveryAgentName(this.orderData[0].delivery.agentId);
                if (data) {
                    if (data['name']) {
            ...
            this.orderId = id;
            let userDetails = yield this.pickUp.getUserDetails(this.orderData[0].user.id);
            this.phoneNo = userDetails['phoneNo'];
            this.showLoader = false;
            this.logData = yield this.pickUp.getOrderLogs(id);
    ...
    searchOrderById() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!isNaN(parseInt(this.searchOrder))) {
                this.ordersList = yield this.pickUp.getOrderData(parseInt(this.searchOrder));
                // console.log(this.ordersList)
                if (this.ordersList && this.ordersList.length > 0) {
                    this.onClickViewDetails(this.ordersList[0].orderId);
                }
    ...
    cancelOrder(cancelReason) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let orderCancelled = yield this.pickUp.cancelOrderByAdmin(parseInt(this.orderId), cancelReason, this.orderData[0].user.name);
            if (orderCancelled) {
                yield this.presentAlert('Order Cancelled Successfully!');
            }
            this.loading.dismiss();
    ...
    pickupOrder() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.presentLoading();
            let orderPicked = yield this.pickUp.changeOrderStatus(this.orderId, 'picked');
            if (orderPicked) {
                yield this.presentAlert('Order Picked Up Successfully!');
            }
            this.loading.dismiss();
            this.onClickViewDetails(this.orderId);
        });
    ...
    deliverOrder() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.presentLoading();
            let orderPicked = yield this.pickUp.changeOrderStatus(this.orderId, 'delivered');
            if (orderPicked) {
                yield this.presentAlert('Order Delivered Successfully!');
            }
            this.loading.dismiss();
            this.onClickViewDetails(this.orderId);
        });
    ...
    onChangeDeliveryAgent(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.presentLoading();
            let result = yield this.pickUp.assignDeliveryAgent(selectedDeliveryAgentId, this.orderId);
            if (result) {
                yield this.presentAlert('Delivery agent assigned!');
            }
            this.loading.dismiss();
        });
    }
...
//# sourceMappingURL=admin-pickup-drop-pickup-drop-module-es2015.js.map