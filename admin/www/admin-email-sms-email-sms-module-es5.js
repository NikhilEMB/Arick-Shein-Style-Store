...
var EmailSmsPageModule = /** @class */ (function () {
    function EmailSmsPageModule() {
    }
...
var EmailSmsPage = /** @class */ (function () {
    function EmailSmsPage(events, router, sharedService, alertController) {
        this.events = events;
        this.router = router;
    ...
    EmailSmsPage.prototype.ngOnInit = function () {
    };
    EmailSmsPage.prototype.ionViewWillEnter = function () {
    ...
    EmailSmsPage.prototype.ionViewWillLeave = function () {
        this.removeSubscriptions();
    };
    EmailSmsPage.prototype.initializeSubscriptions = function () {
        var _this = this;
        this.events.subscribe('email-sms:saveSettingsSuccess', function (settingType) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
        ...
        this.events.subscribe('email-sms:saveSettingsFailure', function (errMessage) {
            console.log('details Failure', errMessage);
        });
        this.events.subscribe('email-sms:getSettingsSuccess', function (doc, settingType) {
            console.log('doc:', doc);
            if (settingType === 'email' && doc.active) {
                _this.emailSettings.active = doc.active;
                _this.emailSettings.email = doc.email;
                _this.emailSettings.apiKey = doc.apiKey;
            }
            else if (settingType === 'sms' && doc) {
                _this.smsSettings.active = doc.active;
                _this.smsSettings.accountSid = doc.accountSid;
                _this.smsSettings.authToken = doc.authToken;
                _this.smsSettings.twilioNumber = doc.twilioNumber;
                if (doc.msg91) {
                    _this.smsSettings.msg91 = doc.msg91;
                }
            }
        });
        this.events.subscribe('email-sms:getSettingsFailure', function (errMessage) {
            console.log('details Failure', errMessage);
        });
        this.events.publish('email-sms:getSettings', 'email');
        this.events.publish('email-sms:getSettings', 'sms');
    };
    EmailSmsPage.prototype.removeSubscriptions = function () {
    ...
    EmailSmsPage.prototype.disableEmailSave = function () {
    ...
    EmailSmsPage.prototype.disableSmsSave = function () {
    ...
    EmailSmsPage.prototype.saveEmailSettings = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    EmailSmsPage.prototype.saveSmsSettings = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.smsSettings.msg91.active && (!this.smsSettings.msg91.smsKey || !this.smsSettings.msg91.templateId.cancelled || !this.smsSettings.msg91.templateId.confirmed
                            || !this.smsSettings.msg91.templateId.dispatched || !this.smsSettings.msg91.templateId.delivered))) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.sharedService.presentAlert('Please fill all details!')];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
    ...
    EmailSmsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-email-sms-email-sms-module-es5.js.map